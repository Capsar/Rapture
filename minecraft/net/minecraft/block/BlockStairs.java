...
public class BlockStairs extends Block
{
    ...
    {
        IBlockState var3 = blockAccess.getBlockState(pos);
        ...
        {
            var7 = blockAccess.getBlockState(pos.east());
            var8 = var7.getBlock();
            ...
            if (isBlockStairs(var8) && var5 == var7.getValue(HALF))
            {
                ...
                if (var9 == EnumFacing.NORTH && !isSameStair(blockAccess, pos.south(), var3))
                {
                    return var6 ? 1 : 2;
                }

                if (var9 == EnumFacing.SOUTH && !isSameStair(blockAccess, pos.north(), var3))
                {
                    return var6 ? 2 : 1;
                }
            }
        ...
        {
            var7 = blockAccess.getBlockState(pos.west());
            var8 = var7.getBlock();
        ...
        {
            var7 = blockAccess.getBlockState(pos.south());
            var8 = var7.getBlock();
            ...
            if (isBlockStairs(var8) && var5 == var7.getValue(HALF))
            {
                ...
                if (var9 == EnumFacing.WEST && !isSameStair(blockAccess, pos.east(), var3))
                {
                    return var6 ? 2 : 1;
                }

                if (var9 == EnumFacing.EAST && !isSameStair(blockAccess, pos.west(), var3))
                {
                    return var6 ? 1 : 2;
                }
            }
        ...
        {
            var7 = blockAccess.getBlockState(pos.north());
            var8 = var7.getBlock();
    ...
    public int func_176305_g(IBlockAccess blockAccess, BlockPos pos)
    {
        ...
        if (var4 == EnumFacing.EAST)
        {
            ...
            if (isBlockStairs(var8) && var5 == var7.getValue(HALF))
            {
                ...
                if (var9 == EnumFacing.NORTH && !isSameStair(blockAccess, pos.north(), var3))
                {
                    return var6 ? 1 : 2;
                }

                if (var9 == EnumFacing.SOUTH && !isSameStair(blockAccess, pos.south(), var3))
                {
                    return var6 ? 2 : 1;
                }
            }
        ...
        else if (var4 == EnumFacing.SOUTH)
        {
            ...
            if (isBlockStairs(var8) && var5 == var7.getValue(HALF))
            {
                ...
                if (var9 == EnumFacing.WEST && !isSameStair(blockAccess, pos.west(), var3))
                {
                    return var6 ? 2 : 1;
                }

                if (var9 == EnumFacing.EAST && !isSameStair(blockAccess, pos.east(), var3))
                {
                    return var6 ? 1 : 2;
                }
            }
    ...
    public boolean func_176306_h(IBlockAccess blockAccess, BlockPos pos)
    {
        ...
        if (var4 == EnumFacing.EAST)
        {
            var9 = 0.5F;
            var12 = 1.0F;
            var14 = blockAccess.getBlockState(pos.east());
            ...
            if (isBlockStairs(var15) && var5 == var14.getValue(HALF))
            {
                ...
                if (var16 == EnumFacing.NORTH && !isSameStair(blockAccess, pos.south(), var3))
                {
                    var12 = 0.5F;
                    var13 = false;
                }
                else if (var16 == EnumFacing.SOUTH && !isSameStair(blockAccess, pos.north(), var3))
                {
                    var11 = 0.5F;
                    var13 = false;
                }
        ...
        else if (var4 == EnumFacing.WEST)
        {
            var10 = 0.5F;
            var12 = 1.0F;
            var14 = blockAccess.getBlockState(pos.west());
            var15 = var14.getBlock();
        ...
        else if (var4 == EnumFacing.SOUTH)
        {
            var11 = 0.5F;
            var12 = 1.0F;
            var14 = blockAccess.getBlockState(pos.south());
            var15 = var14.getBlock();
            ...
            if (isBlockStairs(var15) && var5 == var14.getValue(HALF))
            {
                ...
                if (var16 == EnumFacing.WEST && !isSameStair(blockAccess, pos.east(), var3))
                {
                    var10 = 0.5F;
                    var13 = false;
                }
                else if (var16 == EnumFacing.EAST && !isSameStair(blockAccess, pos.west(), var3))
                {
                    var9 = 0.5F;
                    var13 = false;
                }
        ...
        {
            var14 = blockAccess.getBlockState(pos.north());
            var15 = var14.getBlock();
    ...
    public boolean func_176304_i(IBlockAccess blockAccess, BlockPos pos)
    {
        ...
        if (var4 == EnumFacing.EAST)
        {
            ...
            if (isBlockStairs(var15) && var5 == var14.getValue(HALF))
            {
                ...
                if (var16 == EnumFacing.NORTH && !isSameStair(blockAccess, pos.north(), var3))
                {
                    var11 = 0.0F;
                    var12 = 0.5F;
                    var13 = true;
                }
                else if (var16 == EnumFacing.SOUTH && !isSameStair(blockAccess, pos.south(), var3))
                {
                    var11 = 0.5F;
                    var12 = 1.0F;
                    var13 = true;
        ...
        else if (var4 == EnumFacing.SOUTH)
        {
            ...
            if (isBlockStairs(var15) && var5 == var14.getValue(HALF))
            {
                ...
                if (var16 == EnumFacing.WEST && !isSameStair(blockAccess, pos.west(), var3))
                {
                    var13 = true;
                }
                else if (var16 == EnumFacing.EAST && !isSameStair(blockAccess, pos.east(), var3))
                {
                    var9 = 0.5F;
                    var10 = 1.0F;
                    var13 = true;
	...
	public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer)
    {
        ...
        var9 = var9.withProperty(FACING, placer.getHorizontalFacing()).withProperty(SHAPE, BlockStairs.EnumShape.STRAIGHT);
        return facing != EnumFacing.DOWN && (facing == EnumFacing.UP || hitY <= 0.5D) ? var9.withProperty(HALF, BlockStairs.EnumHalf.BOTTOM) : var9.withProperty(HALF, BlockStairs.EnumHalf.TOP);
    }
    ...
    public static enum EnumHalf implements IStringSerializable
    {
        ...
        private EnumHalf(String p_i45683_1_, int p_i45683_2_, String name)
        {
            this.name = name;
        }
    ...
    public static enum EnumShape implements IStringSerializable
    {
        ...
        private EnumShape(String p_i45682_1_, int p_i45682_2_, String name)
        {
            this.name = name;
        }
