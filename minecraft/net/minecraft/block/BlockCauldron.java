...
public class BlockCauldron extends Block
{
	...
	public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn)
    {
        ...
        {
            entityIn.extinguish();
            this.setWaterLevel(worldIn, pos, state, var5 - 1);
        }
    }
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            {
                int var10 = ((Integer)state.getValue(LEVEL)).intValue();
                ...
                else
                {
                    ...
                    if (var11 == Items.glass_bottle)
                    {
                        if (var10 > 0)
                        {
                            ...
                            this.setWaterLevel(worldIn, pos, state, var10 - 1);
                        }
	...
	public void fillWithRain(World worldIn, BlockPos pos)
    {
        if (worldIn.rand.nextInt(20) == 1)
        {
            ...
            if (((Integer)var3.getValue(LEVEL)).intValue() < 3)
            {
                worldIn.setBlockState(pos, var3.cycleProperty(LEVEL), 2);
            }
        }
    }
