...
public class BlockCommandBlock extends BlockContainer
{
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        return var9 instanceof TileEntityCommandBlock ? ((TileEntityCommandBlock)var9).getCommandBlockLogic().tryOpenEditCommandBlock(playerIn) : false;
    }
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (var6 instanceof TileEntityCommandBlock)
        {
            ...
            {
                var7.setName(stack.getDisplayName());
            }

            if (!worldIn.isRemote)
            {
                var7.setTrackOutput(worldIn.getGameRules().getGameRuleBooleanValue("sendCommandFeedback"));
            }
        }
    }
