...
public class BlockRedstoneWire extends Block
{
    ...
    private boolean func_176339_d(IBlockAccess worldIn, BlockPos pos, EnumFacing side)
    {
        ...
        return !var8 && var7 && canConnectUpwardsTo(worldIn, var4.up()) ? true : (canConnectTo(var5, side) ? true : (var6 == Blocks.powered_repeater && var5.getValue(BlockRedstoneDiode.FACING) == side ? true : !var7 && canConnectUpwardsTo(worldIn, var4.down())));
    }
    ...
    protected static boolean canConnectTo(IBlockState blockState, EnumFacing side)
    {
        ...
        {
            EnumFacing var3 = (EnumFacing)blockState.getValue(BlockRedstoneRepeater.FACING);
    ...
    {
        float var2 = (float)powerLevel / 15.0F;
