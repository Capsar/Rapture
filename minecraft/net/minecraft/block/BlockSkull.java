...
public class BlockSkull extends BlockContainer
{
    ...
    public void checkWitherSpawn(World worldIn, BlockPos pos, TileEntitySkull te)
    {
        if (te.getSkullType() == 1 && pos.getY() >= 2 && worldIn.getDifficulty() != EnumDifficulty.PEACEFUL && !worldIn.isRemote)
        {
            ...
            BlockPattern.PatternHelper var5 = var4.match(worldIn, pos);
            ...
            if (var5 != null)
            {
                ...
                for (var6 = 0; var6 < 3; ++var6)
                {
                    ...
                    worldIn.setBlockState(var7.getPos(), var7.getBlockState().withProperty(NODROP, Boolean.valueOf(true)), 2);
                }
                ...
                for (var16 = 0; var16 < var4.getPalmLength(); ++var16)
                {
                    for (int var17 = 0; var17 < var4.getThumbLength(); ++var17)
                    {
                        ...
                        worldIn.notifyNeighborsRespectDebug(var11.getPos(), Blocks.air);
                    }
                }
            }
        }
