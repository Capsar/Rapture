        ...
        while (var6 < 128)
        {
            ...
            while (true)
            {
                ...
                else if (worldIn.getBlockState(var7).getBlock().blockMaterial == Material.air)
                {
                    if (rand.nextInt(8) == 0)
                    {
                        BlockFlower.EnumFlowerType var11 = worldIn.getBiomeGenForCoords(var7).pickRandomFlower(rand, var7);
                        BlockFlower var9 = var11.getBlockType().getBlock();
                        IBlockState var10 = var9.getDefaultState().withProperty(var9.getTypeProperty(), var11);
