...
public class ItemMap extends ItemMapBase
{
    ...
    public MapData getMapData(ItemStack stack, World worldIn)
    {
        ...
        if (var4 == null && !worldIn.isRemote)
        {
            ...
            var4.scale = 3;
            var4.calculateMapCenter(worldIn.getWorldInfo().getSpawnX(), worldIn.getWorldInfo().getSpawnZ(), var4.scale);
    ...
    public void updateMapData(World worldIn, Entity viewer, MapData data)
    {
        if (worldIn.provider.getDimensionId() == data.dimension && viewer instanceof EntityPlayer)
        {
            ...
            int var5 = data.xCenter;
            int var6 = data.zCenter;
            int var7 = MathHelper.floor_double(viewer.posX - var5) / var4 + 64;
            int var8 = MathHelper.floor_double(viewer.posZ - var6) / var4 + 64;
            int var9 = 128 / var4;
            ...
            MapData.MapInfo var10 = data.getMapInfo((EntityPlayer)viewer);
            ++var10.field_82569_d;
            boolean var11 = false;
                            ...
                            if (!var22.isEmpty())
                            {
                                ...
                                else
                                {
                                    for (var28 = 0; var28 < var4; ++var28)
                                    {
                                        ...
                                        {
                                            int var30 = var22.getHeightValue(var28 + var23, var29 + var24) + 1;
                                ...
                                var25 /= var4 * var4;
                                double var34 = (var26 - var13) * 4.0D / (var4 + 4) + ((var12 + var15 & 1) - 0.5D) * 0.4D;
                                byte var35 = 1;
                                ...
                                MapColor var36 = Iterables.getFirst(Multisets.copyHighestCountFirst(var21), MapColor.airColor);

                                if (var36 == MapColor.waterColor)
                                {
                                    var34 = var25 * 0.1D + (var12 + var15 & 1) * 0.2D;
                                    var35 = 1;
                                ...
                                {
                                    byte var37 = data.colors[var12 + var15 * 128];
                                    byte var38 = (byte)(var36.colorIndex * 4 + var35);

                                    if (var37 != var38)
                                    {
                                        data.colors[var12 + var15 * 128] = var38;
                                        data.updateMapData(var12, var15);
                                        var11 = true;
                                    }
                                }
                            }
