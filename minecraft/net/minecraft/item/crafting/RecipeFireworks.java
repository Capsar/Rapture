...
public class RecipeFireworks implements IRecipe
{
	...
	public boolean matches(InventoryCrafting inv, World worldIn)
    {
        ...
        for (int var9 = 0; var9 < inv.getSizeInventory(); ++var9)
        {
            ItemStack var10 = inv.getStackInSlot(var9);
        ...
        if (var4 <= 3 && var3 <= 1)
        {
            ...
            if (var4 >= 1 && var3 == 1 && var7 == 0)
            {
                ...
                if (var6 > 0)
                {
                    ...
                    for (int var24 = 0; var24 < inv.getSizeInventory(); ++var24)
                    {
                        ItemStack var26 = inv.getStackInSlot(var24);
            ...
            else if (var4 == 1 && var3 == 0 && var6 == 0 && var5 > 0 && var8 <= 1)
            {
                ...
                for (int var13 = 0; var13 < inv.getSizeInventory(); ++var13)
                {
                    ItemStack var14 = inv.getStackInSlot(var13);
            ...
            else if (var4 == 0 && var3 == 0 && var6 == 1 && var5 > 0 && var5 == var7)
            {
                ...
                for (int var17 = 0; var17 < inv.getSizeInventory(); ++var17)
                {
                    ItemStack var11 = inv.getStackInSlot(var17);
