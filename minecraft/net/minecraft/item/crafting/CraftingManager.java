...
public class CraftingManager
{
    ...
    private CraftingManager()
    {
        ...
        this.addRecipe(new ItemStack(Items.carrot_on_a_stick, 1), new Object[] {"# ", " X", '#', Items.fishing_rod, 'X', Items.carrot}).setCopyIngredientNBT();
    ...
    public ShapedRecipes addRecipe(ItemStack stack, Object ... recipeComponents)
    {
        ...
        if (recipeComponents[var4] instanceof String[])
        {
            String[] var7 = ((String[])recipeComponents[var4++]);
        ...
        {
            while (recipeComponents[var4] instanceof String)
            {
                String var11 = (String)recipeComponents[var4++];
                ++var6;
                var5 = var11.length();
                var3 = var3 + var11;
            }
        ...
        for (var12 = Maps.newHashMap(); var4 < recipeComponents.length; var4 += 2)
        {
            Character var13 = (Character)recipeComponents[var4];
            ItemStack var15 = null;

            if (recipeComponents[var4 + 1] instanceof Item)
            {
                var15 = new ItemStack((Item)recipeComponents[var4 + 1]);
            }
            else if (recipeComponents[var4 + 1] instanceof Block)
            {
                var15 = new ItemStack((Block)recipeComponents[var4 + 1], 1, 32767);
            }
            else if (recipeComponents[var4 + 1] instanceof ItemStack)
            {
                var15 = (ItemStack)recipeComponents[var4 + 1];
            }
        ...
        ShapedRecipes var17 = new ShapedRecipes(var5, var6, var14, stack);
    ...
    public void addShapelessRecipe(ItemStack stack, Object ... recipeComponents)
    {
        ...
        Object[] var4 = recipeComponents;
        int var5 = recipeComponents.length;
        ...
        this.recipes.add(new ShapelessRecipes(stack, var3));
    }
