...
public class ItemMonsterPlacer extends Item
{
        ...
        else
        {
            ...
            else
            {
                if (var4.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
                {
                    ...
                    if (!playerIn.canPlayerEdit(var5, var4.sideHit, itemStackIn))
                    {
                        return itemStackIn;
                    }
    ...
    public static Entity spawnCreature(World worldIn, int entityID, double x, double y, double z)
    {
        ...
        else
        {
            ...
            {
                var8 = EntityList.createEntityByID(entityID, worldIn);

                if (var8 instanceof EntityLivingBase)
                {
                    EntityLiving var10 = (EntityLiving)var8;
                    var8.setLocationAndAngles(x, y, z, MathHelper.wrapAngleTo180_float(worldIn.rand.nextFloat() * 360.0F), 0.0F);
