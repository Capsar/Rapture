...
public class ItemBoat extends Item
{
	...
	public ItemStack onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn)
    {
        ...
        double var7 = playerIn.prevPosX + (playerIn.posX - playerIn.prevPosX) * var4;
        double var9 = playerIn.prevPosY + (playerIn.posY - playerIn.prevPosY) * var4 + playerIn.getEyeHeight();
        double var11 = playerIn.prevPosZ + (playerIn.posZ - playerIn.prevPosZ) * var4;
        ...
        else
        {
            ...
            else
            {
                if (var24.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
                {
                    ...
                    var34.rotationYaw = ((MathHelper.floor_double(playerIn.rotationYaw * 4.0F / 360.0F + 0.5D) & 3) - 1) * 90;
