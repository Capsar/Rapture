...
public class ItemArmorStand extends Item
{
	...
	public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            if (!playerIn.canPlayerEdit(var10, side, stack))
            {
                return false;
            }
            else
                ...
                else
                {
                    ...
                    else
                    {
                        if (!worldIn.isRemote)
                        {
                            ...
                            float var21 = MathHelper.floor_float((MathHelper.wrapAngleTo180_float(playerIn.rotationYaw - 180.0F) + 22.5F) / 45.0F) * 45.0F;
                            var20.setLocationAndAngles(var13 + 0.5D, var15, var17 + 0.5D, var21, 0.0F);
                            this.applyRandomRotations(var20, worldIn.rand);
    ...
    {
        Rotations var3 = armorStand.getHeadRotation();
        float var5 = rand.nextFloat() * 5.0F;
        float var6 = rand.nextFloat() * 20.0F - 10.0F;
        Rotations var4 = new Rotations(var3.getX() + var5, var3.getY() + var6, var3.getZ());
        armorStand.setHeadRotation(var4);
        var3 = armorStand.getBodyRotation();
        var5 = rand.nextFloat() * 10.0F - 5.0F;
        var4 = new Rotations(var3.getX(), var3.getY() + var5, var3.getZ());
        armorStand.setBodyRotation(var4);
    }
}
