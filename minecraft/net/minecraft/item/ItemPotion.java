...
public class ItemPotion extends Item
{
    ...
    public List getEffects(ItemStack stack)
    {
        if (stack.hasTagCompound() && stack.getTagCompound().hasKey("CustomPotionEffects", 9))
        {
            ...
            NBTTagList var3 = stack.getTagCompound().getTagList("CustomPotionEffects", 10);
        ...
        {
            List var2 = (List)this.effectCache.get(Integer.valueOf(stack.getMetadata()));

            if (var2 == null)
            {
                var2 = PotionHelper.getPotionEffects(stack.getMetadata(), false);
                this.effectCache.put(Integer.valueOf(stack.getMetadata()), var2);
            }
    ...
    {
        List var2 = (List)this.effectCache.get(Integer.valueOf(meta));

        if (var2 == null)
        {
            var2 = PotionHelper.getPotionEffects(meta, false);
            this.effectCache.put(Integer.valueOf(meta), var2);
        }
    ...
    {
        List var2 = this.getEffects(meta);
	...
	public String getItemStackDisplayName(ItemStack stack)
    {
        ...
        else
        {
            ...
            {
                var4 = PotionHelper.getPotionPrefix(stack.getMetadata());
