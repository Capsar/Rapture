...
public class PathEntity
{
    ...
    {
        double var3 = (double)this.points[index].xCoord + (double)((int)(entityIn.width + 1.0F)) * 0.5D;
        double var5 = (double)this.points[index].yCoord;
        double var7 = (double)this.points[index].zCoord + (double)((int)(entityIn.width + 1.0F)) * 0.5D;
