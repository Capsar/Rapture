...
public enum EnumFacing implements IStringSerializable
{
    ...
    public static enum Axis implements Predicate, IStringSerializable {
        ...
        private Axis(String p_i46402_1_, int p_i46402_2_, String p_i46015_1_, int p_i46015_2_, String name, EnumFacing.Plane plane)
        {
            this.name = name;
            this.plane = plane;
        }
    ...
    public static enum AxisDirection {
        ...
        private AxisDirection(String p_i46403_1_, int p_i46403_2_, String p_i46014_1_, int p_i46014_2_, int offset, String description)
        {
            this.offset = offset;
    ...
    public static enum Plane implements Predicate, Iterable {
        ...
        private Plane(String p_i46404_1_, int p_i46404_2_, String p_i46013_1_, int p_i46013_2_) {}
