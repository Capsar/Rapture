...
public class EnchantmentProtection extends Enchantment
{
	...
	public int calcModifierDamage(int level, DamageSource source)
    {
        ...
        {
            float var3 = (6 + level * level) / 3.0F;
            return this.protectionType == 0 ? MathHelper.floor_float(var3 * 0.75F) : (this.protectionType == 1 && source.isFireDamage() ? MathHelper.floor_float(var3 * 1.25F) : (this.protectionType == 2 && source == DamageSource.fall ? MathHelper.floor_float(var3 * 2.5F) : (this.protectionType == 3 && source.isExplosion() ? MathHelper.floor_float(var3 * 1.5F) : (this.protectionType == 4 && source.isProjectile() ? MathHelper.floor_float(var3 * 1.5F) : 0))));
        }
    }
	...
	public boolean canApplyTogether(Enchantment ench)
    {
        ...
        {
            EnchantmentProtection var2 = (EnchantmentProtection)ench;
