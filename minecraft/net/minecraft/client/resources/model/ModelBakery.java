...
public class ModelBakery
{
        ...
        if (var3 == null)
        {
            ...
            try
            {
                ...
                while (var5.hasNext())
                {
                    ...
                    {
                        throw new RuntimeException("Encountered an exception when loading model definition of \'" + p_177586_1_ + "\' from: \'" + var6.getResourceLocation() + "\' in resourcepack: \'" + var6.getResourcePackName() + "\'", var13);
                    }
                    finally
                    {
    ...
    private ModelBlock loadModel(ResourceLocation p_177594_1_) throws IOException
    {
        ...
        else
        {
            ...
            try
            {
                ...
                var10.name = p_177594_1_.toString();
                var11 = var10;
            }
            finally
            {
    ...
    {
        TextureAtlasSprite var4 = (TextureAtlasSprite)this.sprites.get(new ResourceLocation(modelBlockIn.resolveTextureName("particle")));
        SimpleBakedModel.Builder var5 = (new SimpleBakedModel.Builder(modelBlockIn)).setTexture(var4);
        Iterator var6 = modelBlockIn.getElements().iterator();

        while (var6.hasNext())
        {
            BlockPart var7 = (BlockPart)var6.next();
            Iterator var8 = var7.mapFaces.keySet().iterator();

            while (var8.hasNext())
            {
                EnumFacing var9 = (EnumFacing)var8.next();
                BlockPartFace var10 = (BlockPartFace)var7.mapFaces.get(var9);
                TextureAtlasSprite var11 = (TextureAtlasSprite)this.sprites.get(new ResourceLocation(modelBlockIn.resolveTextureName(var10.texture)));

                if (var10.cullFace == null)
                {
                    var5.addGeneralQuad(this.makeBakedQuad(var7, var10, var11, var9, modelRotationIn, uvLocked));
                }
                else
                {
                    var5.addFaceQuad(modelRotationIn.rotateFace(var10.cullFace), this.makeBakedQuad(var7, var10, var11, var9, modelRotationIn, uvLocked));
                }
            }
        }
    ...
    private Set getTextureLocations(ModelBlock p_177585_1_)
    {
        ...
        while (var3.hasNext())
        {
            ...
            Iterator var5 = var4.mapFaces.values().iterator();

            while (var5.hasNext())
            {
                BlockPartFace var6 = (BlockPartFace)var5.next();
                ResourceLocation var7 = new ResourceLocation(p_177585_1_.resolveTextureName(var6.texture));
                var2.add(var7);
            }
        }
        ...
        IIconCreator var2 = new IIconCreator()
        {
			...
			public void registerSprites(TextureMap iconRegistry)
            {
                ...
                while (var2.hasNext())
                {
                    ...
                    TextureAtlasSprite var4 = iconRegistry.registerSprite(var3);
            ...
            if (var4 != null)
            {
                ...
                else if (!this.isCustomRenderer(var4))
                {
                    ...
                    while (var5.hasNext())
                    {
                        ...
                        Iterator var7 = var6.mapFaces.values().iterator();
