...
public class ModelWitch extends ModelVillager
{
	...
	public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_)
    {
        ...
        this.villagerNose.rotateAngleX = MathHelper.sin(p_78087_7_.ticksExisted * var8) * 4.5F * (float)Math.PI / 180.0F;
        this.villagerNose.rotateAngleY = 0.0F;
        this.villagerNose.rotateAngleZ = MathHelper.cos(p_78087_7_.ticksExisted * var8) * 2.5F * (float)Math.PI / 180.0F;
