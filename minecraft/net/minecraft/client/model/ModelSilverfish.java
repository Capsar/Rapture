...
public class ModelSilverfish extends ModelBase
{
    ...
    public ModelSilverfish()
    {
        ...
        for (int var2 = 0; var2 < this.silverfishBodyParts.length; ++var2)
        {
            ...
            this.silverfishBodyParts[var2].addBox(silverfishBoxLength[var2][0] * -0.5F, 0.0F, silverfishBoxLength[var2][2] * -0.5F, silverfishBoxLength[var2][0], silverfishBoxLength[var2][1], silverfishBoxLength[var2][2]);
	...
	public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale)
    {
        ...
        {
            this.silverfishBodyParts[var8].render(scale);
        }

        for (var8 = 0; var8 < this.silverfishWings.length; ++var8)
        {
            this.silverfishWings[var8].render(scale);
        }
    }
	...
	public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_)
    {
        ...
        {
            this.silverfishBodyParts[var8].rotateAngleY = MathHelper.cos(p_78087_3_ * 0.9F + var8 * 0.15F * (float)Math.PI) * (float)Math.PI * 0.05F * (1 + Math.abs(var8 - 2));
            this.silverfishBodyParts[var8].rotationPointX = MathHelper.sin(p_78087_3_ * 0.9F + var8 * 0.15F * (float)Math.PI) * (float)Math.PI * 0.2F * Math.abs(var8 - 2);
        }
