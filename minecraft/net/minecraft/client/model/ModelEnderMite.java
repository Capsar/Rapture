...
public class ModelEnderMite extends ModelBase
{
	...
	public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale)
    {
        ...
        {
            this.field_178713_d[var8].render(scale);
        }
    }
	...
	public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_)
    {
        for (int var8 = 0; var8 < this.field_178713_d.length; ++var8)
        {
            this.field_178713_d[var8].rotateAngleY = MathHelper.cos(p_78087_3_ * 0.9F + var8 * 0.15F * (float)Math.PI) * (float)Math.PI * 0.01F * (1 + Math.abs(var8 - 2));
            this.field_178713_d[var8].rotationPointX = MathHelper.sin(p_78087_3_ * 0.9F + var8 * 0.15F * (float)Math.PI) * (float)Math.PI * 0.1F * Math.abs(var8 - 2);
        }
    }
}
