...
public class ModelSquid extends ModelBase
{
    ...
    public ModelSquid()
    {
        ...
        for (int var2 = 0; var2 < this.squidTentacles.length; ++var2)
        {
            ...
            double var3 = var2 * Math.PI * 2.0D / this.squidTentacles.length;
            ...
            var3 = var2 * Math.PI * -2.0D / this.squidTentacles.length + (Math.PI / 2D);
	...
	public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale)
    {
        ...
        {
            this.squidTentacles[var8].render(scale);
        }
    }
}
