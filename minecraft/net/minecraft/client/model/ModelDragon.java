...
public class ModelDragon extends ModelBase
{
	...
	public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale)
    {
        ...
        EntityDragon var8 = (EntityDragon)entityIn;
        ...
        for (int var19 = 0; var19 < 5; ++var19)
        {
            ...
            this.spine.rotateAngleZ = -this.updateRotations(var20[0] - var17) * (float)Math.PI / 180.0F * var14;
        ...
        this.head.rotateAngleZ = -this.updateRotations(var22[0] - var17) * (float)Math.PI / 180.0F * 1.0F;
        ...
        for (int var25 = 0; var25 < 12; ++var25)
        {
            ...
            this.spine.rotateAngleZ = this.updateRotations(var22[0] - var17) * (float)Math.PI / 180.0F * var14;
            this.spine.rotationPointY = var11;
            this.spine.rotationPointZ = var12;
            this.spine.rotationPointX = var13;
            var11 = (float)(var11 + Math.sin(this.spine.rotateAngleX) * 10.0D);
