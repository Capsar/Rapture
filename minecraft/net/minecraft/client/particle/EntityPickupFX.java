...
public class EntityPickupFX extends EntityFX
{
    ...
    {
        float var9 = (this.age + partialTicks) / this.maxAge;
        var9 *= var9;
        double var10 = this.field_174840_a.posX;
        double var12 = this.field_174840_a.posY;
        double var14 = this.field_174840_a.posZ;
        double var16 = this.field_174843_ax.lastTickPosX + (this.field_174843_ax.posX - this.field_174843_ax.lastTickPosX) * partialTicks;
        double var18 = this.field_174843_ax.lastTickPosY + (this.field_174843_ax.posY - this.field_174843_ax.lastTickPosY) * partialTicks + this.field_174841_aA;
        double var20 = this.field_174843_ax.lastTickPosZ + (this.field_174843_ax.posZ - this.field_174843_ax.lastTickPosZ) * partialTicks;
        double var22 = var10 + (var16 - var10) * var9;
        double var24 = var12 + (var18 - var12) * var9;
        double var26 = var14 + (var20 - var14) * var9;
        int var28 = this.getBrightnessForRender(partialTicks);
        ...
        var24 -= interpPosY;
        var26 -= interpPosZ;
        this.field_174842_aB.renderEntityWithPosYaw(this.field_174840_a, ((float)var22), ((float)var24), ((float)var26), this.field_174840_a.rotationYaw, partialTicks);
    }
