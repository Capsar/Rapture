...
public class EntityFlameFX extends EntityFX
{
    ...
    protected EntityFlameFX(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn)
    {
        ...
        double var10000 = xCoordIn + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.05F;
        var10000 = yCoordIn + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.05F;
        var10000 = zCoordIn + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.05F;
