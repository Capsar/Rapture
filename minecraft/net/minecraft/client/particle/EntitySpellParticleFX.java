...
public class EntitySpellParticleFX extends EntityFX
{
    ...
    {
        float var9 = ((float)this.particleAge + partialTicks) / (float)this.particleMaxAge * 32.0F;
    ...
    public static class AmbientMobFactory implements IParticleFactory
    {
        ...
        {
            EntitySpellParticleFX var16 = new EntitySpellParticleFX(worldIn, xCoordIn, yCoordIn, zCoordIn, xSpeedIn, ySpeedIn, zSpeedIn);
            var16.setAlphaF(0.15F);
            var16.setRBGColorF((float)xSpeedIn, (float)ySpeedIn, (float)zSpeedIn);
            return var16;
        }
    }
