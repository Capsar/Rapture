...
public class EntityFireworkStarterFX extends EntityFX
{
    ...
    public EntityFireworkStarterFX(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn, EffectRenderer effectRendererIn, NBTTagCompound p_i46355_15_)
    {
        ...
        for (int var14 = -size; var14 <= size; ++var14)
        {
            for (int var15 = -size; var15 <= size; ++var15)
            {
                for (int var16 = -size; var16 <= size; ++var16)
                {
                    ...
                    double var23 = MathHelper.sqrt_double(var17 * var17 + var19 * var19 + var21 * var21) / speed + this.rand.nextGaussian() * 0.05D;
                    this.createParticle(var8, var10, var12, var17 / var23, var19 / var23, var21 / var23, colours, fadeColours, trail, twinkleIn);
    ...
    private void createShaped(double speed, double[][] shape, int[] colours, int[] fadeColours, boolean trail, boolean twinkleIn, boolean p_92038_8_)
    {
        ...
        this.createParticle(this.posX, this.posY, this.posZ, var9 * speed, var11 * speed, 0.0D, colours, fadeColours, trail, twinkleIn);
        ...
        for (int var16 = 0; var16 < 3; ++var16)
        {
            ...
            for (int var23 = 1; var23 < shape.length; ++var23)
            {
                ...
                {
                    double var30 = (var19 + (var24 - var19) * var28) * speed;
                    double var32 = (var21 + (var26 - var21) * var28) * speed;
                    double var34 = var30 * Math.sin(var17);
                    var30 *= Math.cos(var17);

                    for (double var36 = -1.0D; var36 <= 1.0D; var36 += 2.0D)
                    {
                        this.createParticle(this.posX, this.posY, this.posZ, var30 * var36, var32, var34 * var36, colours, fadeColours, trail, twinkleIn);
                    }
                }
    ...
    private void createBurst(int[] colours, int[] fadeColours, boolean trail, boolean twinkleIn)
    {
        ...
        for (int var9 = 0; var9 < 70; ++var9)
        {
            ...
            this.createParticle(this.posX, this.posY, this.posZ, var10, var14, var12, colours, fadeColours, trail, twinkleIn);
        }
    }
