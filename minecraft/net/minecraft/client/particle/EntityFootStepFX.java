...
public class EntityFootStepFX extends EntityFX
{
    ...
    {
        float var9 = ((float)this.footstepAge + partialTicks) / (float)this.footstepMaxAge;
        var9 *= var9;
        ...
        worldRendererIn.addVertexWithUV((double)(var12 - var11), (double)var13, (double)(var14 + var11), 0.0D, 1.0D);
        worldRendererIn.addVertexWithUV((double)(var12 + var11), (double)var13, (double)(var14 + var11), 1.0D, 1.0D);
        worldRendererIn.addVertexWithUV((double)(var12 + var11), (double)var13, (double)(var14 - var11), 1.0D, 0.0D);
        worldRendererIn.addVertexWithUV((double)(var12 - var11), (double)var13, (double)(var14 - var11), 0.0D, 0.0D);
