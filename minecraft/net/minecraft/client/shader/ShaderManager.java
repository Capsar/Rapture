...
public class ShaderManager
{
        ...
        try
        {
            ...
            if (this.attributes != null)
            {
                ...
                while (var32.hasNext())
                {
                    ...
                    this.attribLocations.add(Integer.valueOf(var37));
                }
            }
        }
    ...
    {
        JsonObject var2 = JsonUtils.getJsonObject(p_147996_1_, "sampler");
    ...
    {
        JsonObject var2 = JsonUtils.getJsonObject(p_147987_1_, "uniform");
        String var3 = JsonUtils.getString(var2, "name");
