...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
        ...
        else if (id == 13)
        {
            if (result)
            {
                try
                {
                    ...
                    var3.getMethod("browse", new Class[] {URI.class}).invoke(var4, new Object[] {new URI(this.openGLWarningLink)});
                }
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        float var9 = 1.8F - MathHelper.abs(MathHelper.sin(Minecraft.getSystemTime() % 1000L / 1000.0F * (float)Math.PI * 2.0F) * 0.1F);
