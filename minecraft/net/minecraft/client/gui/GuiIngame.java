...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        {
            var7 = this.mc.thePlayer.prevTimeInPortal + (this.mc.thePlayer.timeInPortal - this.mc.thePlayer.prevTimeInPortal) * partialTicks;
        ...
        if (this.recordPlayingUpFor > 0)
        {
            ...
            var7 = this.recordPlayingUpFor - partialTicks;
        ...
        if (this.field_175195_w > 0)
        {
            ...
            var7 = this.field_175195_w - partialTicks;
            var8 = 255;

            if (this.field_175195_w > this.field_175193_B + this.field_175192_A)
            {
                float var12 = this.field_175199_z + this.field_175192_A + this.field_175193_B - var7;
                var8 = (int)(var12 * 255.0F / this.field_175199_z);
            }

            if (this.field_175195_w <= this.field_175193_B)
            {
                var8 = (int)(var7 * 255.0F / this.field_175193_B);
            }
            ...
            if (var8 > 8)
            {
                ...
                this.getFontRenderer().drawString(this.field_175201_x, -this.getFontRenderer().getStringWidth(this.field_175201_x) / 2, -10.0F, 16777215 | var9, true);
                GlStateManager.popMatrix();
                GlStateManager.pushMatrix();
                GlStateManager.scale(2.0F, 2.0F, 2.0F);
                this.getFontRenderer().drawString(this.field_175200_y, -this.getFontRenderer().getStringWidth(this.field_175200_y) / 2, 5.0F, 16777215 | var9, true);
                GlStateManager.popMatrix();
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
            }
        ...
        ScorePlayerTeam var15 = var121.getPlayersTeam(this.mc.thePlayer.getCommandSenderName());
        ...
        if (this.mc.gameSettings.keyBindPlayerList.isKeyDown() && (!this.mc.isIntegratedServerRunning() || this.mc.thePlayer.sendQueue.func_175106_d().size() > 1 || var161 != null))
        {
            this.overlayPlayerList.updatePlayerList(true);
            this.overlayPlayerList.renderPlayerlist(var3, var121, var161);
        }
        else
        {
    ...
    protected void renderTooltip(ScaledResolution sr, float partialTicks)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            ...
            this.zLevel = -90.0F;
            this.drawTexturedModalRect(var4 - 91, sr.getScaledHeight() - 22, 0, 0, 182, 22);
            this.drawTexturedModalRect(var4 - 91 - 1 + var3.inventory.currentItem * 20, sr.getScaledHeight() - 22 - 1, 0, 22, 24, 22);
            this.zLevel = var5;
    ...
    public void renderExpBar(ScaledResolution p_175176_1_, int p_175176_2_)
    {
        ...
        {
            short var9 = 182;
            int var10 = (int)(this.mc.thePlayer.experience * (var9 + 1));
    ...
    public void renderHeldItemTooltips(ScaledResolution p_175182_1_)
    {
        ...
        if (this.remainingHighlightTicks > 0 && this.highlightingItemStack != null)
        {
            ...
            if (var5 > 0)
            {
                ...
                GlStateManager.enableBlend();
                GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
                this.getFontRenderer().drawStringWithShadow(var2, var3, var4, 16777215 + (var5 << 24));
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
            }
        }
    ...
    public void renderDemo(ScaledResolution p_175185_1_)
    {
        ...
        this.getFontRenderer().drawStringWithShadow(var2, p_175185_1_.getScaledWidth() - var3 - 10, 5.0F, 16777215);
        this.mc.mcProfiler.endSection();
    }
    ...
    private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_)
    {
        ...
        for (Iterator var22 = var21.iterator(); var22.hasNext(); var6 = Math.max(var6, this.getFontRenderer().getStringWidth(var10)))
        {
        ...
        while (var12.hasNext())
        {
            ...
            if (var11 == var21.size())
            {
                ...
                this.getFontRenderer().drawString(var20, var25 + var6 / 2 - this.getFontRenderer().getStringWidth(var20) / 2, var18 - this.getFontRenderer().FONT_HEIGHT, 553648127);
            }
        }
    }
    ...
    private void renderPlayerStats(ScaledResolution p_180477_1_)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            ...
            boolean var4 = this.field_175191_F > this.updateCounter && (this.field_175191_F - this.updateCounter) / 3L % 2L == 1L;
    ...
    private void renderBossHealth()
    {
        if (BossStatus.bossName != null && BossStatus.statusBarTime > 0)
        {
            ...
            this.getFontRenderer().drawStringWithShadow(var8, var3 / 2 - this.getFontRenderer().getStringWidth(var8) / 2, var7 - 10, 16777215);
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
            this.mc.getTextureManager().bindTexture(icons);
        }
    }
    ...
    private void func_180480_a(float p_180480_1_, ScaledResolution p_180480_2_)
    {
        if (Config.isVignetteEnabled())
        {
            ...
            double var5 = Math.min(var3.getResizeSpeed() * var3.getWarningTime() * 1000.0D, Math.abs(var3.getTargetSize() - var3.getDiameter()));
            ...
            this.prevVignetteBrightness = (float)(this.prevVignetteBrightness + (p_180480_1_ - this.prevVignetteBrightness) * 0.01D);
            GlStateManager.disableDepth();
            GlStateManager.depthMask(false);
    ...
    private void renderHotbarItem(int index, int xPos, int yPos, float partialTicks, EntityPlayer p_175184_5_)
    {
        ...
        if (var6 != null)
        {
            float var7 = var6.animationsToGo - partialTicks;
