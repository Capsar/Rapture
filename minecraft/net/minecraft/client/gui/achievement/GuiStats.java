...
public class GuiStats extends GuiScreen implements IProgressMeter
{
    ...
    private void drawSprite(int p_146527_1_, int p_146527_2_, int p_146527_3_, int p_146527_4_)
    {
        ...
        var10.addVertexWithUV(p_146527_1_ + 0, p_146527_2_ + 18, this.zLevel, (p_146527_3_ + 0) * 0.0078125F, (p_146527_4_ + 18) * 0.0078125F);
        var10.addVertexWithUV(p_146527_1_ + 18, p_146527_2_ + 18, this.zLevel, (p_146527_3_ + 18) * 0.0078125F, (p_146527_4_ + 18) * 0.0078125F);
        var10.addVertexWithUV(p_146527_1_ + 18, p_146527_2_ + 0, this.zLevel, (p_146527_3_ + 18) * 0.0078125F, (p_146527_4_ + 0) * 0.0078125F);
        var10.addVertexWithUV(p_146527_1_ + 0, p_146527_2_ + 0, this.zLevel, (p_146527_3_ + 0) * 0.0078125F, (p_146527_4_ + 0) * 0.0078125F);
        var9.draw();
    }
    ...
    abstract class Stats extends GuiSlot
    {
        ...
        protected void func_148209_a(StatBase p_148209_1_, int p_148209_2_, int p_148209_3_, boolean p_148209_4_)
        {
            ...
            if (p_148209_1_ != null)
            {
                var5 = p_148209_1_.format(GuiStats.this.field_146546_t.readStat(p_148209_1_));
    ...
    class StatsBlock extends GuiStats.Stats
    {
        ...
        public StatsBlock(Minecraft mcIn)
        {
            ...
            while (var3.hasNext())
            {
                ...
                if (GuiStats.this.field_146546_t.readStat(var4) > 0)
                {
                    var5 = true;
                }
                else if (StatList.objectUseStats[var6] != null && GuiStats.this.field_146546_t.readStat(StatList.objectUseStats[var6]) > 0)
                {
                    var5 = true;
                }
                else if (StatList.objectCraftStats[var6] != null && GuiStats.this.field_146546_t.readStat(StatList.objectCraftStats[var6]) > 0)
                {
                    var5 = true;
                }
            ...
            this.statSorter = new Comparator()
            {
                ...
                public int compare(StatCrafting p_compare_1_, StatCrafting p_compare_2_)
                {
                    ...
                    if (var5 != null || var6 != null)
                    {
                        ...
                        int var7 = GuiStats.this.field_146546_t.readStat(var5);
                        int var8 = GuiStats.this.field_146546_t.readStat(var6);
        ...
        {
            StatCrafting var7 = this.func_148211_c(entryID);
            ...
            this.func_148209_a(StatList.objectCraftStats[var9], p_180791_2_ + 115, p_180791_3_, entryID % 2 == 0);
            this.func_148209_a(StatList.objectUseStats[var9], p_180791_2_ + 165, p_180791_3_, entryID % 2 == 0);
            this.func_148209_a(var7, p_180791_2_ + 215, p_180791_3_, entryID % 2 == 0);
        }
    ...
    class StatsGeneral extends GuiSlot
    {
		...
		protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn)
        {
            StatBase var7 = (StatBase)StatList.generalStats.get(entryID);
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, var7.getStatName().getUnformattedText(), p_180791_2_ + 2, p_180791_3_ + 1, entryID % 2 == 0 ? 16777215 : 9474192);
            String var8 = var7.format(GuiStats.this.field_146546_t.readStat(var7));
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, var8, p_180791_2_ + 2 + 213 - GuiStats.this.fontRendererObj.getStringWidth(var8), p_180791_3_ + 1, entryID % 2 == 0 ? 16777215 : 9474192);
        }
    }
    ...
    class StatsItem extends GuiStats.Stats
    {
        ...
        public StatsItem(Minecraft mcIn)
        {
            ...
            while (var3.hasNext())
            {
                ...
                else if (StatList.objectBreakStats[var6] != null && GuiStats.this.field_146546_t.readStat(StatList.objectBreakStats[var6]) > 0)
                {
                    var5 = true;
                }
                else if (StatList.objectCraftStats[var6] != null && GuiStats.this.field_146546_t.readStat(StatList.objectCraftStats[var6]) > 0)
		...
		protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn)
        {
            ...
            GuiStats.this.drawStatsScreen(p_180791_2_ + 40, p_180791_3_, var8);
            int var9 = Item.getIdFromItem(var8);
            this.func_148209_a(StatList.objectBreakStats[var9], p_180791_2_ + 115, p_180791_3_, entryID % 2 == 0);
            this.func_148209_a(StatList.objectCraftStats[var9], p_180791_2_ + 165, p_180791_3_, entryID % 2 == 0);
            this.func_148209_a(var7, p_180791_2_ + 215, p_180791_3_, entryID % 2 == 0);
        }
    ...
    class StatsMobsList extends GuiSlot
    {
        ...
        public StatsMobsList(Minecraft mcIn)
        {
            ...
            while (var3.hasNext())
            {
                ...
                if (GuiStats.this.field_146546_t.readStat(var4.field_151512_d) > 0 || GuiStats.this.field_146546_t.readStat(var4.field_151513_e) > 0)
                {
		...
		protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn)
        {
            EntityList.EntityEggInfo var7 = (EntityList.EntityEggInfo)this.field_148222_l.get(entryID);
            String var8 = I18n.format("entity." + EntityList.getStringFromID(var7.spawnedID) + ".name", new Object[0]);
            int var9 = GuiStats.this.field_146546_t.readStat(var7.field_151512_d);
            int var10 = GuiStats.this.field_146546_t.readStat(var7.field_151513_e);
