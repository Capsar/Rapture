...
public class GuiSelectWorld extends GuiScreen implements GuiYesNoCallback
{
    ...
    class List extends GuiSlot
    {
		...
		protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY)
        {
            ...
            GuiSelectWorld.this.selectButton.enabled = var5;
            GuiSelectWorld.this.deleteButton.enabled = var5;
            GuiSelectWorld.this.renameButton.enabled = var5;
            GuiSelectWorld.this.recreateButton.enabled = var5;
        ...
        {
            SaveFormatComparator var7 = (SaveFormatComparator)GuiSelectWorld.this.field_146639_s.get(entryID);
            String var8 = var7.getDisplayName();

            if (StringUtils.isEmpty(var8))
            {
                var8 = GuiSelectWorld.this.field_146637_u + " " + (entryID + 1);
            }
