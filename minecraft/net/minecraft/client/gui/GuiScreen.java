...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    protected void renderToolTip(ItemStack stack, int x, int y)
    {
        ...
        for (int var5 = 0; var5 < var4.size(); ++var5)
        {
            if (var5 == 0)
            {
                var4.set(var5, stack.getRarity().rarityColor + (String)var4.get(var5));
            }
            else
            {
    ...
    protected void handleComponentHover(IChatComponent p_175272_1_, int p_175272_2_, int p_175272_3_)
    {
        if (p_175272_1_ != null && p_175272_1_.getChatStyle().getChatHoverEvent() != null)
        {
            ...
            else
            {
                ...
                {
                    this.drawHoveringText(NEWLINE_SPLITTER.splitToList(var4.getValue().getFormattedText()), p_175272_2_, p_175272_3_);
                }
