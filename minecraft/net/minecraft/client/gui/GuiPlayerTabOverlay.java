...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn)
    {
        ...
        if (var17 != null)
        {
            ...
            for (var19 = var17.iterator(); var19.hasNext(); var15 += this.mc.fontRendererObj.FONT_HEIGHT)
            {
                ...
                this.mc.fontRendererObj.drawStringWithShadow(var20, (float)(width / 2 - var21 / 2), (float)var15, -1);
            }
        ...
        for (int var30 = 0; var30 < var28; ++var30)
        {
            ...
            if (var30 < var5.size())
            {
                ...
                {
                    this.mc.fontRendererObj.drawStringWithShadow(var25, (float)var22, (float)var23, -1);
                }
    ...
    private void drawScoreboardValues(ScoreObjective p_175247_1_, int p_175247_2_, String p_175247_3_, int p_175247_4_, int p_175247_5_, NetworkPlayerInfo p_175247_6_)
    {
        ...
        if (p_175247_1_.getRenderType() == IScoreObjectiveCriteria.EnumRenderType.HEARTS)
        {
            ...
            boolean var10 = p_175247_6_.func_178858_o() > (long)this.guiIngame.getUpdateCounter() && (p_175247_6_.func_178858_o() - (long)this.guiIngame.getUpdateCounter()) / 3L % 2L == 1L;
            ...
            if (var8 > 0)
            {
                ...
                if (var11 > 3.0F)
                {
                    ...
                    {
                        this.drawTexturedModalRect((float)p_175247_4_ + (float)var12 * var11, (float)p_175247_2_, var10 ? 25 : 16, 0, 9, 9);
                    }
                    ...
                    for (var12 = 0; var12 < var8; ++var12)
                    {
                        ...
                        if (var10)
                        {
                            ...
                            {
                                this.drawTexturedModalRect((float)p_175247_4_ + (float)var12 * var11, (float)p_175247_2_, 70, 0, 9, 9);
                            }

                            if (var12 * 2 + 1 == p_175247_6_.func_178860_m())
                            {
                                this.drawTexturedModalRect((float)p_175247_4_ + (float)var12 * var11, (float)p_175247_2_, 79, 0, 9, 9);
                            }
                        }

                        if (var12 * 2 + 1 < var7)
                        {
                            this.drawTexturedModalRect((float)p_175247_4_ + (float)var12 * var11, (float)p_175247_2_, var12 >= 10 ? 160 : 52, 0, 9, 9);
                        }

                        if (var12 * 2 + 1 == var7)
                        {
                            this.drawTexturedModalRect((float)p_175247_4_ + (float)var12 * var11, (float)p_175247_2_, var12 >= 10 ? 169 : 61, 0, 9, 9);
                        }
                    }
                }
                else
                {
                    ...
                    this.mc.fontRendererObj.drawStringWithShadow(var14, (float)((p_175247_5_ + p_175247_4_) / 2 - this.mc.fontRendererObj.getStringWidth(var14) / 2), (float)p_175247_2_, var13);
                }
            }
        }
        else
        {
            ...
            this.mc.fontRendererObj.drawStringWithShadow(var15, (float)(p_175247_5_ - this.mc.fontRendererObj.getStringWidth(var15)), (float)p_175247_2_, 16777215);
        }
    }
