...
public abstract class GuiSlot
{
    ...
    protected void overlayBackground(int startY, int endY, int startAlpha, int endAlpha)
    {
        ...
        var6.addVertexWithUV((double)this.left, (double)endY, 0.0D, 0.0D, (double)((float)endY / var7));
        var6.addVertexWithUV((double)(this.left + this.width), (double)endY, 0.0D, (double)((float)this.width / var7), (double)((float)endY / var7));
        var6.setColorRGBA_I(4210752, startAlpha);
        var6.addVertexWithUV((double)(this.left + this.width), (double)startY, 0.0D, (double)((float)this.width / var7), (double)((float)startY / var7));
        var6.addVertexWithUV((double)this.left, (double)startY, 0.0D, 0.0D, (double)((float)startY / var7));
        var5.draw();
    }
