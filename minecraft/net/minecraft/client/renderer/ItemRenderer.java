...
public class ItemRenderer {
	...
	private void func_178109_a(AbstractClientPlayer clientPlayer) {
		int var2 = this.mc.theWorld.getCombinedLight(
				new BlockPos(clientPlayer.posX, clientPlayer.posY + (double) clientPlayer.getEyeHeight(), clientPlayer.posZ), 0);
	...
	private void func_178110_a(EntityPlayerSP entityplayerspIn, float partialTicks) {
		float var3 = entityplayerspIn.prevRenderArmPitch + (entityplayerspIn.renderArmPitch - entityplayerspIn.prevRenderArmPitch)
				* partialTicks;
	 ...
	 * 
	 * @param equipProgress
	 *            The progress of the animation to equip (raise from out of
	 *            frame) while switching held items.
	 * @param swingProgress
	 *            The progress of the arm swing animation.
	 */
	 ...
	 * 
	 * @param partialTicks
	 *            The amount of time passed during the current tick, ranging
	 *            from 0 to 1.
	 */
