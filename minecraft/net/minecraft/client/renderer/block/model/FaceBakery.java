...
//    }
    ...
    private void func_178407_a(Vector3d p_178407_1_, BlockPartRotation partRotation)
    {
        if (partRotation != null)
        {
            ...
            {
                case 1:
                    var3.mul(this.getMatrixRotation(new AxisAngle4d(1.0D, 0.0D, 0.0D, (double)partRotation.angle * 0.017453292519943295D)));
                    var4.set(0.0D, 1.0D, 1.0D);
                    break;

                case 2:
                    var3.mul(this.getMatrixRotation(new AxisAngle4d(0.0D, 1.0D, 0.0D, (double)partRotation.angle * 0.017453292519943295D)));
                    var4.set(1.0D, 0.0D, 1.0D);
                    break;

                case 3:
                    var3.mul(this.getMatrixRotation(new AxisAngle4d(0.0D, 0.0D, 1.0D, (double)partRotation.angle * 0.017453292519943295D)));
