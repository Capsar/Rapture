...
public class BreakingFour extends BakedQuad
{
    ...
    private void func_178216_a(int p_178216_1_)
    {
        ...
        this.vertexData[var2 + 4] = Float.floatToRawIntBits(this.texture.getInterpolatedU(var6));
        this.vertexData[var2 + 4 + 1] = Float.floatToRawIntBits(this.texture.getInterpolatedV(var7));
    }
