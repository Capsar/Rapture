...
public class BlockPart
{
    ...
    static class Deserializer implements JsonDeserializer
    {
        ...
        {
            float var2 = JsonUtils.getFloat(p_178255_1_, "angle");
        ...
        {
            String var2 = JsonUtils.getString(p_178252_1_, "axis");
        ...
        {
            JsonArray var3 = JsonUtils.getJsonArray(p_178251_1_, p_178251_2_);
            ...
            else
            {
                ...
                {
                    var4[var5] = JsonUtils.getFloat(var3.get(var5), p_178251_2_ + "[" + var5 + "]");
                }
