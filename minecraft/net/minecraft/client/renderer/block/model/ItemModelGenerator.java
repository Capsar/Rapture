...
public class ItemModelGenerator
{
    ...
    public ModelBlock makeItemModel(TextureMap textureMapIn, ModelBlock blockModel)
    {
        ...
        for (int var5 = 0; var5 < LAYERS.size(); ++var5)
        {
            ...
            if (!blockModel.isTexturePresent(var6))
            {
                break;
            }

            String var7 = blockModel.resolveTextureName(var6);
            var3.put(var6, var7);
            TextureAtlasSprite var8 = textureMapIn.getAtlasSprite((new ResourceLocation(var7)).toString());
        ...
        {
            var3.put("particle", blockModel.isTexturePresent("particle") ? blockModel.resolveTextureName("particle") : (String)var3.get("layer0"));
            return new ModelBlock(var4, var3, false, false, new ItemCameraTransforms(blockModel.getThirdPersonTransform(), blockModel.getFirstPersonTransform(), blockModel.getHeadTransform(), blockModel.getInGuiTransform()));
        }
    }
    ...
    private List func_178397_a(TextureAtlasSprite p_178397_1_, String p_178397_2_, int p_178397_3_)
    {
        ...
        while (var7.hasNext())
        {
            ...
            switch (ItemModelGenerator.SwitchSpanFacing.values[var22.ordinal()])
            {
                case 1:
                    var13 = var19;
                    var9 = var19;
            ...
            var25.put(var22.getFacing(), new BlockPartFace((EnumFacing)null, p_178397_3_, p_178397_2_, new BlockFaceUV(new float[] {var13, var15, var14, var16}, 0)));
    ...
    static enum SpanFacing
    {
        ...
        private SpanFacing(String p_i46215_1_, int p_i46215_2_, EnumFacing facing, int p_i46215_4_, int p_i46215_5_)
        {
            this.facing = facing;
    ...
    {
        static final int[] values = new int[ItemModelGenerator.SpanFacing.values().length];
        ...
        static
        {
            try
            {
                values[ItemModelGenerator.SpanFacing.UP.ordinal()] = 1;
            }
            ...
            try
            {
                values[ItemModelGenerator.SpanFacing.DOWN.ordinal()] = 2;
            }
            ...
            try
            {
                values[ItemModelGenerator.SpanFacing.LEFT.ordinal()] = 3;
            }
            ...
            try
            {
                values[ItemModelGenerator.SpanFacing.RIGHT.ordinal()] = 4;
            }
