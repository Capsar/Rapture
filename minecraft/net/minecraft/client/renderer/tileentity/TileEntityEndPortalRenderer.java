...
public class TileEntityEndPortalRenderer extends TileEntitySpecialRenderer
{
    ...
    public void func_180544_a(TileEntityEndPortal endPortal, double p_180544_2_, double p_180544_4_, double p_180544_6_, float p_180544_8_, int p_180544_9_)
    {
        ...
        for (int var14 = 0; var14 < 16; ++var14)
        {
            ...
            float var18 = (float)(-(p_180544_4_ + var13));
    ...
    {
        this.func_180544_a((TileEntityEndPortal)te, x, y, z, partialTicks, destroyStage);
    }
}
