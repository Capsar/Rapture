...
public class RenderItemFrame extends Render
{
    ...
    public void doRender(EntityItemFrame entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        double var11 = (double)var10.getX() - entity.posX + x;
        double var13 = (double)var10.getY() - entity.posY + y;
        double var15 = (double)var10.getZ() - entity.posZ + z;
        ...
        GlStateManager.popMatrix();
        this.func_147914_a(entity, x + (double)((float)entity.facingDirection.getFrontOffsetX() * 0.3F), y - 0.25D, z + (double)((float)entity.facingDirection.getFrontOffsetZ() * 0.3F));
    }
            ...
            else
            {
                ...
                if (var4 == Items.compass)
                {
                    ...
                    if (var12 instanceof TextureCompass)
                    {
                        ...
                        var13.updateCompass(itemFrame.worldObj, itemFrame.posX, itemFrame.posZ, (double)MathHelper.wrapAngleTo180_float((float)(180 + itemFrame.facingDirection.getHorizontalIndex() * 90)), false, true);
