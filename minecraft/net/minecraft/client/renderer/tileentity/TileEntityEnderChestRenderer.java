...
public class TileEntityEnderChestRenderer extends TileEntitySpecialRenderer
{
    ...
    public void func_180540_a(TileEntityEnderChest enderChest, double p_180540_2_, double p_180540_4_, double p_180540_6_, float p_180540_8_, int p_180540_9_)
    {
        int var10 = 0;
        ...
        GlStateManager.translate(-0.5F, -0.5F, -0.5F);
        float var12 = enderChest.prevLidAngle + (enderChest.field_145972_a - enderChest.prevLidAngle) * p_180540_8_;
        var12 = 1.0F - var12;
    ...
    {
        this.func_180540_a((TileEntityEnderChest)te, x, y, z, partialTicks, destroyStage);
    }
}
