...
public class SimpleTexture extends AbstractTexture
{
    ...
    public void loadTexture(IResourceManager resourceManager) throws IOException
    {
        ...
        try
        {
            ...
            if (this.textureLocation.file != null) {
                var2 = new FileInputStream(this.textureLocation.file);
            } else {
                var3 = resourceManager.getResource(this.textureLocation);
            ...
            if (this.textureLocation.file == null && var3 != null && var3.hasMetadata())
            {
                try
                {
