...
public class LayeredColorMaskTexture extends AbstractTexture
{
	...
	public void loadTexture(IResourceManager resourceManager) throws IOException
    {
        ...
        try
        {
            BufferedImage var3 = TextureUtil.readBufferedImage(resourceManager.getResource(this.textureLocation).getInputStream());
            ...
            for (int var6 = 0; var6 < this.field_174949_h.size() && var6 < this.field_174950_i.size(); ++var6)
            {
                ...
                if (var7 != null)
                {
                    InputStream var9 = resourceManager.getResource(new ResourceLocation(var7)).getInputStream();
