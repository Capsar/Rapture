...
public class TextureUtil
{
    ...
    {
        BufferedImage var2 = readBufferedImage(resourceManager.getResource(imageLocation).getInputStream());
    ...
    public static BufferedImage readBufferedImage(InputStream imageStream) throws IOException, IOException
    {
        BufferedImage var1;
