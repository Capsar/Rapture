...
public class BlockModelRenderer {
	...
	public boolean renderModel(IBlockAccess blockAccessIn, IBakedModel modelIn, IBlockState blockStateIn, BlockPos blockPosIn,
	...
	public boolean renderModel(IBlockAccess blockAccessIn, IBakedModel modelIn, IBlockState blockStateIn, BlockPos blockPosIn,
			WorldRenderer worldRendererIn, boolean checkSides) {
		boolean var7 = Minecraft.isAmbientOcclusionEnabled() && blockStateIn.getBlock().getLightValue() == 0
				&& modelIn.isAmbientOcclusion();

		try {
			Block var11 = blockStateIn.getBlock();
				return var7 ? this.renderModelAmbientOcclusion(blockAccessIn, modelIn, var11, blockStateIn, blockPosIn, worldRendererIn,
						checkSides) : this.renderModelStandard(blockAccessIn, modelIn, var11, blockStateIn, blockPosIn, worldRendererIn,
						checkSides);
	...
	public boolean renderModelAmbientOcclusion(IBlockAccess blockAccessIn, IBakedModel modelIn, Block blockIn, BlockPos blockPosIn,
			WorldRenderer worldRendererIn, boolean checkSides) {
		return this.renderModelAmbientOcclusion(blockAccessIn, modelIn, blockIn, blockAccessIn.getBlockState(blockPosIn), blockPosIn,
				worldRendererIn, checkSides);
	}

	public boolean renderModelAmbientOcclusion(IBlockAccess blockAccessIn, IBakedModel modelIn, Block blockIn, IBlockState blockStateIn,
		...
		for (int var17 = 0; var17 < var12; ++var17) {
			...
			List stateSnow = modelIn.getFaceQuads(modelSnow);
		...
		List var161 = modelIn.getGeneralQuads();
	...
	public boolean renderModelStandard(IBlockAccess blockAccessIn, IBakedModel modelIn, Block blockIn, BlockPos blockPosIn,
			WorldRenderer worldRendererIn, boolean checkSides) {
		return this.renderModelStandard(blockAccessIn, modelIn, blockIn, blockAccessIn.getBlockState(blockPosIn), blockPosIn,
				worldRendererIn, checkSides);
	}

	public boolean renderModelStandard(IBlockAccess blockAccessIn, IBakedModel modelIn, Block blockIn, IBlockState blockStateIn,
			BlockPos blockPosIn, WorldRenderer worldRendererIn, boolean checkSides) {
		boolean var7 = false;
		RenderEnv renderEnv = null;
		...
		for (int var16 = 0; var16 < var10; ++var16) {
			...
			if (!stateSnow.isEmpty()) {
				...
				if (!checkSides || blockIn.shouldSideBeRendered(blockAccessIn, var14, modelSnow)) {
					...
					this.renderModelStandardQuads(blockAccessIn, blockIn, blockPosIn, modelSnow, var15, false, worldRendererIn, stateSnow,
							renderEnv);
					var7 = true;
				}
			}
		...
		List var17 = modelIn.getGeneralQuads();
		...
		if (var17.size() > 0) {
			...
			this.renderModelStandardQuads(blockAccessIn, blockIn, blockPosIn, (EnumFacing) null, -1, true, worldRendererIn, var17,
					renderEnv);
			var7 = true;
		}
	...
	private void renderModelAmbientOcclusionQuads(IBlockAccess blockAccessIn, Block blockIn, BlockPos blockPosIn,
			WorldRenderer worldRendererIn, List listQuadsIn, RenderEnv renderEnv) {
		...
		if (var15 != Block.EnumOffsetType.NONE) {
			long var22 = MathHelper.getPositionRandom(blockPosIn);
		...
		for (Iterator var221 = listQuadsIn.iterator(); var221.hasNext(); worldRendererIn.putPosition(var9, var11, var13)) {
			BakedQuad var17 = (BakedQuad) var221.next();

			if (var17.getSprite() != null) {
			...
			this.fillQuadBounds(blockIn, var17.getVertexData(), var17.getFace(), quadBounds, boundsFlags);
			aoFaceIn.updateVertexBrightness(blockAccessIn, blockIn, blockPosIn, var17.getFace(), quadBounds, boundsFlags);

			if (worldRendererIn.isMultiTexture()) {
				worldRendererIn.addVertexData(var17.getVertexDataSingle());
				worldRendererIn.putSprite(var17.getSprite());
			} else {
				worldRendererIn.addVertexData(var17.getVertexData());
			}

			worldRendererIn.putBrightness4(aoFaceIn.vertexBrightness[0], aoFaceIn.vertexBrightness[1], aoFaceIn.vertexBrightness[2],
					aoFaceIn.vertexBrightness[3]);
			int colorMultiplier1 = CustomColorizer.getColorMultiplier(var17, blockIn, blockAccessIn, blockPosIn, renderEnv);

			if (!var17.hasTintIndex() && colorMultiplier1 < 0) {
				...
				if (colorMultiplier1 >= 0) {
					...
					var18 = blockIn.colorMultiplier(blockAccessIn, blockPosIn, var17.getTintIndex());
				}

				if (EntityRenderer.anaglyphEnable) {
					var18 = TextureUtil.anaglyphColor(var18);
				}

				float var19 = (var18 >> 16 & 255) / 255.0F;
				float var20 = (var18 >> 8 & 255) / 255.0F;
				float var21 = (var18 & 255) / 255.0F;
				worldRendererIn.putColorMultiplier(aoFaceIn.vertexColorMultiplier[0] * var19, aoFaceIn.vertexColorMultiplier[0] * var20,
						aoFaceIn.vertexColorMultiplier[0] * var21, 4);
				worldRendererIn.putColorMultiplier(aoFaceIn.vertexColorMultiplier[1] * var19, aoFaceIn.vertexColorMultiplier[1] * var20,
						aoFaceIn.vertexColorMultiplier[1] * var21, 3);
				worldRendererIn.putColorMultiplier(aoFaceIn.vertexColorMultiplier[2] * var19, aoFaceIn.vertexColorMultiplier[2] * var20,
						aoFaceIn.vertexColorMultiplier[2] * var21, 2);
				worldRendererIn.putColorMultiplier(aoFaceIn.vertexColorMultiplier[3] * var19, aoFaceIn.vertexColorMultiplier[3] * var20,
						aoFaceIn.vertexColorMultiplier[3] * var21, 1);
			}
		}
	}
	...
	private void fillQuadBounds(Block blockIn, int[] vertexData, EnumFacing facingIn, float[] quadBounds, BitSet boundsFlags) {
		...
		for (int var16 = 0; var16 < 4; ++var16) {
			var13 = Float.intBitsToFloat(vertexData[var16 * 7]);
			float var14 = Float.intBitsToFloat(vertexData[var16 * 7 + 1]);
			float var15 = Float.intBitsToFloat(vertexData[var16 * 7 + 2]);
	...
	private void renderModelStandardQuads(IBlockAccess blockAccessIn, Block blockIn, BlockPos blockPosIn, EnumFacing faceIn,
			int brightnessIn, boolean ownBrightness, WorldRenderer worldRendererIn, List listQuadsIn, RenderEnv renderEnv) {
		BitSet boundsFlags = renderEnv.getBoundsFlags();
		IBlockState blockStateIn = renderEnv.getBlockState();
		...
		for (Iterator var231 = listQuadsIn.iterator(); var231.hasNext(); worldRendererIn.putPosition(var10, var12, var14)) {
			BakedQuad var241 = (BakedQuad) var231.next();

			if (var241.getSprite() != null) {
			...
			if (ownBrightness) {
				this.fillQuadBounds(blockIn, var241.getVertexData(), var241.getFace(), (float[]) null, boundsFlags);
				brightnessIn = boundsFlags.get(0) ? blockIn.getMixedBrightnessForBlock(blockAccessIn, blockPosIn.offset(var241.getFace()))
						: blockIn.getMixedBrightnessForBlock(blockAccessIn, blockPosIn);
			}

			if (worldRendererIn.isMultiTexture()) {
				worldRendererIn.addVertexData(var241.getVertexDataSingle());
				worldRendererIn.putSprite(var241.getSprite());
			} else {
				worldRendererIn.addVertexData(var241.getVertexData());
			}

			worldRendererIn.putBrightness4(brightnessIn, brightnessIn, brightnessIn, brightnessIn);
			int colorMultiplier2 = CustomColorizer.getColorMultiplier(var241, blockIn, blockAccessIn, blockPosIn, renderEnv);

			if (var241.hasTintIndex() || colorMultiplier2 >= 0) {
				int var25;

				if (colorMultiplier2 >= 0) {
					var25 = colorMultiplier2;
				} else {
					var25 = blockIn.colorMultiplier(blockAccessIn, blockPosIn, var241.getTintIndex());
				}
				...
				float var20 = (var25 >> 16 & 255) / 255.0F;
				float var21 = (var25 >> 8 & 255) / 255.0F;
				float var22 = (var25 & 255) / 255.0F;
				worldRendererIn.putColorMultiplier(var20, var21, var22, 4);
				worldRendererIn.putColorMultiplier(var20, var21, var22, 3);
				worldRendererIn.putColorMultiplier(var20, var21, var22, 2);
				worldRendererIn.putColorMultiplier(var20, var21, var22, 1);
			}
		}
	}

	public void renderModelBrightnessColor(IBakedModel bakedModel, float p_178262_2_, float p_178262_3_, float p_178262_4_,
			float p_178262_5_) {
		...
		for (int var8 = 0; var8 < var7; ++var8) {
			...
			this.renderModelBrightnessColorQuads(p_178262_2_, p_178262_3_, p_178262_4_, p_178262_5_, bakedModel.getFaceQuads(var9));
		}
	...
	public void renderModelBrightness(IBakedModel p_178266_1_, IBlockState p_178266_2_, float p_178266_3_, boolean p_178266_4_) {
		...
		this.renderModelBrightnessColor(p_178266_1_, p_178266_3_, var7, var8, var9);
	}

	private void renderModelBrightnessColorQuads(float p_178264_1_, float p_178264_2_, float p_178264_3_, float p_178264_4_,
			List p_178264_5_) {
		...
		while (var8.hasNext()) {
			...
			var7.setVertexFormat(DefaultVertexFormats.ITEM);
			var7.addVertexData(var9.getVertexData());

			if (var9.hasTintIndex()) {
				var7.putColorRGB_F4(p_178264_2_ * p_178264_1_, p_178264_3_ * p_178264_1_, p_178264_4_ * p_178264_1_);
			} else {
				var7.putColorRGB_F4(p_178264_1_, p_178264_1_, p_178264_1_);
			}
	...
	public static class AmbientOcclusionFace {
		...
		public void updateVertexBrightness(IBlockAccess blockAccessIn, Block blockIn, BlockPos blockPosIn, EnumFacing facingIn,
				float[] quadBounds, BitSet boundsFlags) {
			BlockPos var7 = boundsFlags.get(0) ? blockPosIn.offset(facingIn) : blockPosIn;
			BlockModelRenderer.EnumNeighborInfo var8 = BlockModelRenderer.EnumNeighborInfo.getNeighbourInfo(facingIn);
			...
			float var34 = boundsFlags.get(0) ? blockAccessIn.getBlockState(var7).getBlock().getAmbientOcclusionLightValue() : blockAccessIn
					.getBlockState(blockPosIn).getBlock().getAmbientOcclusionLightValue();
			var34 = BlockModelRenderer.fixAoLightValue(var34);
			BlockModelRenderer.VertexTranslations var35 = BlockModelRenderer.VertexTranslations.getVertexTranslations(facingIn);
			float var36;
			float var37;
			float var38;
			float var39;
			...
			if (boundsFlags.get(1) && var8.field_178289_i) {
				...
				this.vertexColorMultiplier[var35.field_178191_g] = var36 * var40 + var37 * var41 + var38 * var42 + var39 * var43;
				this.vertexColorMultiplier[var35.field_178200_h] = var36 * var44 + var37 * var45 + var38 * var46 + var39 * var47;
				this.vertexColorMultiplier[var35.field_178201_i] = var36 * var48 + var37 * var49 + var38 * var50 + var39 * var51;
				this.vertexColorMultiplier[var35.field_178198_j] = var36 * var52 + var37 * var53 + var38 * var54 + var39 * var55;
				...
				this.vertexBrightness[var35.field_178191_g] = this.getVertexBrightness(var56, var57, var58, var59, var40, var41, var42,
						var43);
				this.vertexBrightness[var35.field_178200_h] = this.getVertexBrightness(var56, var57, var58, var59, var44, var45, var46,
						var47);
				this.vertexBrightness[var35.field_178201_i] = this.getVertexBrightness(var56, var57, var58, var59, var48, var49, var50,
						var51);
				this.vertexBrightness[var35.field_178198_j] = this.getVertexBrightness(var56, var57, var58, var59, var52, var53, var54,
						var55);
			} else {
				var36 = (var20 + var17 + var26 + var34) * 0.25F;
				var37 = (var19 + var17 + var25 + var34) * 0.25F;
				var38 = (var19 + var18 + var27 + var34) * 0.25F;
				var39 = (var20 + var18 + var28 + var34) * 0.25F;
				this.vertexBrightness[var35.field_178191_g] = this.getAoBrightness(var16, var13, var30, var60);
				this.vertexBrightness[var35.field_178200_h] = this.getAoBrightness(var15, var13, var29, var60);
				this.vertexBrightness[var35.field_178201_i] = this.getAoBrightness(var15, var14, var31, var60);
				this.vertexBrightness[var35.field_178198_j] = this.getAoBrightness(var16, var14, var32, var60);
		...
		private int getVertexBrightness(int p_178203_1_, int p_178203_2_, int p_178203_3_, int p_178203_4_, float p_178203_5_,
				float p_178203_6_, float p_178203_7_, float p_178203_8_) {
			int var9 = (int) ((p_178203_1_ >> 16 & 255) * p_178203_5_ + (p_178203_2_ >> 16 & 255) * p_178203_6_
					+ (p_178203_3_ >> 16 & 255) * p_178203_7_ + (p_178203_4_ >> 16 & 255) * p_178203_8_) & 255;
			int var10 = (int) ((p_178203_1_ & 255) * p_178203_5_ + (p_178203_2_ & 255) * p_178203_6_
	...
	public static enum EnumNeighborInfo {
		DOWN("DOWN", 0, "DOWN", 0, new EnumFacing[] { EnumFacing.WEST, EnumFacing.EAST, EnumFacing.NORTH, EnumFacing.SOUTH }, 0.5F, false,
				new BlockModelRenderer.Orientation[0], new BlockModelRenderer.Orientation[0], new BlockModelRenderer.Orientation[0],
				new BlockModelRenderer.Orientation[0]), UP("UP", 1, "UP", 1, new EnumFacing[] { EnumFacing.EAST, EnumFacing.WEST,
				EnumFacing.NORTH, EnumFacing.SOUTH }, 1.0F, false, new BlockModelRenderer.Orientation[0],
				new BlockModelRenderer.Orientation[0], new BlockModelRenderer.Orientation[0], new BlockModelRenderer.Orientation[0]), NORTH(
				"NORTH", 2, "NORTH", 2, new EnumFacing[] { EnumFacing.UP, EnumFacing.DOWN, EnumFacing.EAST, EnumFacing.WEST }, 0.8F, true,
				new BlockModelRenderer.Orientation[] { BlockModelRenderer.Orientation.UP, BlockModelRenderer.Orientation.FLIP_WEST,
						BlockModelRenderer.Orientation.UP, BlockModelRenderer.Orientation.WEST, BlockModelRenderer.Orientation.FLIP_UP,
						BlockModelRenderer.Orientation.WEST, BlockModelRenderer.Orientation.FLIP_UP,
						BlockModelRenderer.Orientation.FLIP_WEST }, new BlockModelRenderer.Orientation[] {
						BlockModelRenderer.Orientation.UP, BlockModelRenderer.Orientation.FLIP_EAST, BlockModelRenderer.Orientation.UP,
				...
				new BlockModelRenderer.Orientation[] { BlockModelRenderer.Orientation.DOWN, BlockModelRenderer.Orientation.FLIP_EAST,
						...
						BlockModelRenderer.Orientation.FLIP_EAST }, new BlockModelRenderer.Orientation[] {
						BlockModelRenderer.Orientation.DOWN, BlockModelRenderer.Orientation.FLIP_WEST, BlockModelRenderer.Orientation.DOWN,
						BlockModelRenderer.Orientation.WEST, BlockModelRenderer.Orientation.FLIP_DOWN, BlockModelRenderer.Orientation.WEST,
						BlockModelRenderer.Orientation.FLIP_DOWN, BlockModelRenderer.Orientation.FLIP_WEST }), SOUTH("SOUTH", 3, "SOUTH",
				3, new EnumFacing[] { EnumFacing.WEST, EnumFacing.EAST, EnumFacing.DOWN, EnumFacing.UP }, 0.8F, true,
				new BlockModelRenderer.Orientation[] { BlockModelRenderer.Orientation.UP, BlockModelRenderer.Orientation.FLIP_WEST,
						BlockModelRenderer.Orientation.FLIP_UP, BlockModelRenderer.Orientation.FLIP_WEST,
						BlockModelRenderer.Orientation.FLIP_UP, BlockModelRenderer.Orientation.WEST, BlockModelRenderer.Orientation.UP,
				...
				new BlockModelRenderer.Orientation[] { BlockModelRenderer.Orientation.DOWN, BlockModelRenderer.Orientation.FLIP_EAST,
						BlockModelRenderer.Orientation.FLIP_DOWN, BlockModelRenderer.Orientation.FLIP_EAST,
						BlockModelRenderer.Orientation.FLIP_DOWN, BlockModelRenderer.Orientation.EAST, BlockModelRenderer.Orientation.DOWN,
				...
				"WEST", 4, "WEST", 4, new EnumFacing[] { EnumFacing.UP, EnumFacing.DOWN, EnumFacing.NORTH, EnumFacing.SOUTH }, 0.6F, true,
				...
				new BlockModelRenderer.Orientation[] { BlockModelRenderer.Orientation.DOWN, BlockModelRenderer.Orientation.SOUTH,
						...
						BlockModelRenderer.Orientation.FLIP_DOWN, BlockModelRenderer.Orientation.SOUTH }), EAST("EAST", 5, "EAST", 5,
				new EnumFacing[] { EnumFacing.DOWN, EnumFacing.UP, EnumFacing.NORTH, EnumFacing.SOUTH }, 0.6F, true,
				new BlockModelRenderer.Orientation[] { BlockModelRenderer.Orientation.FLIP_DOWN, BlockModelRenderer.Orientation.SOUTH,
						BlockModelRenderer.Orientation.FLIP_DOWN, BlockModelRenderer.Orientation.FLIP_SOUTH,
						BlockModelRenderer.Orientation.DOWN, BlockModelRenderer.Orientation.FLIP_SOUTH,
						BlockModelRenderer.Orientation.DOWN, BlockModelRenderer.Orientation.SOUTH }, new BlockModelRenderer.Orientation[] {
						BlockModelRenderer.Orientation.FLIP_DOWN, BlockModelRenderer.Orientation.NORTH,
						BlockModelRenderer.Orientation.FLIP_DOWN, BlockModelRenderer.Orientation.FLIP_NORTH,
						BlockModelRenderer.Orientation.DOWN, BlockModelRenderer.Orientation.FLIP_NORTH,
						BlockModelRenderer.Orientation.DOWN, BlockModelRenderer.Orientation.NORTH }, new BlockModelRenderer.Orientation[] {
						BlockModelRenderer.Orientation.FLIP_UP, BlockModelRenderer.Orientation.NORTH,
						BlockModelRenderer.Orientation.FLIP_UP, BlockModelRenderer.Orientation.FLIP_NORTH,
						BlockModelRenderer.Orientation.UP, BlockModelRenderer.Orientation.FLIP_NORTH, BlockModelRenderer.Orientation.UP,
						BlockModelRenderer.Orientation.NORTH }, new BlockModelRenderer.Orientation[] {
						BlockModelRenderer.Orientation.FLIP_UP, BlockModelRenderer.Orientation.SOUTH,
						BlockModelRenderer.Orientation.FLIP_UP, BlockModelRenderer.Orientation.FLIP_SOUTH,
						BlockModelRenderer.Orientation.UP, BlockModelRenderer.Orientation.FLIP_SOUTH, BlockModelRenderer.Orientation.UP,
		...
		private static final BlockModelRenderer.EnumNeighborInfo[] $VALUES = new BlockModelRenderer.EnumNeighborInfo[] { DOWN, UP, NORTH,
				SOUTH, WEST, EAST };

		private static final BlockModelRenderer.EnumNeighborInfo[] $VALUES$ = new BlockModelRenderer.EnumNeighborInfo[] { DOWN, UP, NORTH,
				SOUTH, WEST, EAST };

		private EnumNeighborInfo(String p_i46390_1_, int p_i46390_2_, String p_i46236_1_, int p_i46236_2_, EnumFacing[] p_i46236_3_,
				float p_i46236_4_, boolean p_i46236_5_, BlockModelRenderer.Orientation[] p_i46236_6_,
				BlockModelRenderer.Orientation[] p_i46236_7_, BlockModelRenderer.Orientation[] p_i46236_8_,
	...
	public static enum Orientation {
		DOWN("DOWN", 0, "DOWN", 0, EnumFacing.DOWN, false), UP("UP", 1, "UP", 1, EnumFacing.UP, false), NORTH("NORTH", 2, "NORTH", 2,
				EnumFacing.NORTH, false), SOUTH("SOUTH", 3, "SOUTH", 3, EnumFacing.SOUTH, false), WEST("WEST", 4, "WEST", 4,
				EnumFacing.WEST, false), EAST("EAST", 5, "EAST", 5, EnumFacing.EAST, false), FLIP_DOWN("FLIP_DOWN", 6, "FLIP_DOWN", 6,
				EnumFacing.DOWN, true), FLIP_UP("FLIP_UP", 7, "FLIP_UP", 7, EnumFacing.UP, true), FLIP_NORTH("FLIP_NORTH", 8, "FLIP_NORTH",
				8, EnumFacing.NORTH, true), FLIP_SOUTH("FLIP_SOUTH", 9, "FLIP_SOUTH", 9, EnumFacing.SOUTH, true), FLIP_WEST("FLIP_WEST",
				10, "FLIP_WEST", 10, EnumFacing.WEST, true), FLIP_EAST("FLIP_EAST", 11, "FLIP_EAST", 11, EnumFacing.EAST, true);
		protected final int field_178229_m;
		private static final BlockModelRenderer.Orientation[] $VALUES = new BlockModelRenderer.Orientation[] { DOWN, UP, NORTH, SOUTH,
				WEST, EAST, FLIP_DOWN, FLIP_UP, FLIP_NORTH, FLIP_SOUTH, FLIP_WEST, FLIP_EAST };

		private static final BlockModelRenderer.Orientation[] $VALUES$ = new BlockModelRenderer.Orientation[] { DOWN, UP, NORTH, SOUTH,
				WEST, EAST, FLIP_DOWN, FLIP_UP, FLIP_NORTH, FLIP_SOUTH, FLIP_WEST, FLIP_EAST };

		private Orientation(String p_i46392_1_, int p_i46392_2_, String p_i46233_1_, int p_i46233_2_, EnumFacing p_i46233_3_,
				boolean p_i46233_4_) {
	...
	static enum VertexTranslations {
		DOWN("DOWN", 0, "DOWN", 0, 0, 1, 2, 3), UP("UP", 1, "UP", 1, 2, 3, 0, 1), NORTH("NORTH", 2, "NORTH", 2, 3, 0, 1, 2), SOUTH("SOUTH",
				3, "SOUTH", 3, 0, 1, 2, 3), WEST("WEST", 4, "WEST", 4, 3, 0, 1, 2), EAST("EAST", 5, "EAST", 5, 1, 2, 3, 0);
		...
		private static final BlockModelRenderer.VertexTranslations[] $VALUES = new BlockModelRenderer.VertexTranslations[] { DOWN, UP,
				NORTH, SOUTH, WEST, EAST };

		private static final BlockModelRenderer.VertexTranslations[] $VALUES$ = new BlockModelRenderer.VertexTranslations[] { DOWN, UP,
				NORTH, SOUTH, WEST, EAST };

		private VertexTranslations(String p_i46391_1_, int p_i46391_2_, String p_i46234_1_, int p_i46234_2_, int p_i46234_3_,
				int p_i46234_4_, int p_i46234_5_, int p_i46234_6_) {
