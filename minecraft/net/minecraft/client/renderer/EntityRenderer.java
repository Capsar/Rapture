...
import pq.rapture.module.ClearLiquid;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void hurtCameraEffect(float partialTicks)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityLivingBase)
        {
            ...
            float var3 = (float)var2.hurtTime - partialTicks;
            float var4;

            if (var2.getHealth() <= 0.0F)
            {
                var4 = (float)var2.deathTime + partialTicks;
    ...
    private void orientCamera(float partialTicks)
    {
        ...
        double var4 = var2.prevPosX + (var2.posX - var2.prevPosX) * (double)partialTicks;
        double var6 = var2.prevPosY + (var2.posY - var2.prevPosY) * (double)partialTicks + (double)var3;
        double var8 = var2.prevPosZ + (var2.posZ - var2.prevPosZ) * (double)partialTicks;
        ...
        if (var2 instanceof EntityLivingBase && ((EntityLivingBase)var2).isPlayerSleeping())
        {
            ...
            if (!this.mc.gameSettings.debugCamEnable)
            {
                ...
                {
                    int var30 = ((EnumFacing)var11.getValue(BlockBed.FACING)).getHorizontalIndex();
        ...
        {
            double var28 = (double)(this.thirdPersonDistanceTemp + (this.thirdPersonDistance - this.thirdPersonDistanceTemp) * partialTicks);
        ...
        var4 = var2.prevPosX + (var2.posX - var2.prevPosX) * (double)partialTicks;
        var6 = var2.prevPosY + (var2.posY - var2.prevPosY) * (double)partialTicks + (double)var3;
        var8 = var2.prevPosZ + (var2.posZ - var2.prevPosZ) * (double)partialTicks;
     ...
     */
    protected void renderHand(float partialTicks, int xOffset)
    {
        if (!this.debugView)
        {
            GlStateManager.matrixMode(5889);
            ...
            if (this.mc.gameSettings.anaglyph)
            {
                GlStateManager.translate((float)(-(xOffset * 2 - 1)) * var3, 0.0F, 0.0F);
            }
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        {
            GlStateManager.clear(256);
            EventManager.getInstance().fire(new EventRenderGlobal());
    ...
    private void setupFog(int p_78468_1_, float partialTicks)
    {
        ...
        else
        {
            ...
            else if (var5.getMaterial() == Material.water && Wrapper.getMod(ClearLiquid.class) != null && !Wrapper.getMod(ClearLiquid.class).getState())
            {
                GlStateManager.setFog(2048);
            ...
            else if (var5.getMaterial() == Material.lava && !Wrapper.getMod(ClearLiquid.class).getState())
            {
                GlStateManager.setFog(2048);
    ...
    private void frameInit()
    {
        ...
        if (world != null)
        {
            if (Config.getNewRelease() != null)
            {
                ...
                ChatComponentText msg1 = new ChatComponentText("A new \u00a7eOptiFine\u00a7f version is available: \u00a7e" + fullNewVer + "\u00a7f");
            ...
            if (Config.isNotify64BitJava())
            {
                ...
                ChatComponentText msg2 = new ChatComponentText("You can install \u00a7e64-bit Java\u00a7f to increase performance");
