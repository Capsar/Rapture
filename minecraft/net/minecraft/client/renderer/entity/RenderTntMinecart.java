...
public class RenderTntMinecart extends RenderMinecart
{
    ...
    protected void func_180561_a(EntityMinecartTNT minecartTNT, float partialTicks, IBlockState state)
    {
        ...
        if (var4 > -1 && (float)var4 - partialTicks + 1.0F < 10.0F)
        {
            float var5 = 1.0F - ((float)var4 - partialTicks + 1.0F) / 10.0F;
        ...
        if (var4 > -1 && var4 / 5 % 2 == 0)
        {
            ...
            GlStateManager.color(1.0F, 1.0F, 1.0F, (1.0F - ((float)var4 - partialTicks + 1.0F) / 100.0F) * 0.8F);
