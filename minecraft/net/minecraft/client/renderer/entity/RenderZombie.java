...
public class RenderZombie extends RenderBiped
{
    ...
    protected void rotateCorpse(EntityZombie bat, float p_77043_2_, float p_77043_3_, float p_77043_4_)
    {
        if (bat.isConverting())
        {
    ...
    {
        this.rotateCorpse((EntityZombie)bat, p_77043_2_, p_77043_3_, p_77043_4_);
    }
