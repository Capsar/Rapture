...
public class LayerHeldItemWitch implements LayerRenderer
{
    ...
    public void func_177143_a(EntityWitch witch, float p_177143_2_, float p_177143_3_, float p_177143_4_, float p_177143_5_, float p_177143_6_, float p_177143_7_, float p_177143_8_)
    {
        ItemStack var9 = witch.getHeldItem();
        ...
        if (var9 != null)
        {
            ...
            var11.getItemRenderer().renderItem(witch, var9, ItemCameraTransforms.TransformType.THIRD_PERSON);
    ...
    {
        this.func_177143_a((EntityWitch)entitylivingbaseIn, p_177141_2_, p_177141_3_, partialTicks, p_177141_5_, p_177141_6_, p_177141_7_, scale);
    }
}
