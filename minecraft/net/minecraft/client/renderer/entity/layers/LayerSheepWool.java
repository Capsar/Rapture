...
public class LayerSheepWool implements LayerRenderer
{
    ...
    public void doRenderLayer(EntitySheep sheep, float p_177162_2_, float p_177162_3_, float p_177162_4_, float p_177162_5_, float p_177162_6_, float p_177162_7_, float scale)
    {
        if (!sheep.getSheared() && !sheep.isInvisible())
        {
            ...
            this.sheepModel.render(sheep, p_177162_2_, p_177162_3_, p_177162_5_, p_177162_6_, p_177162_7_, scale);
        }
    }
