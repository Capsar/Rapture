...
public class LayerCustomHead implements LayerRenderer
{
    ...
    {
        ItemStack var9 = entitylivingbaseIn.getCurrentArmor(3);
        ...
        if (var9 != null && var9.getItem() != null)
        {
            ...
            boolean var12 = entitylivingbaseIn instanceof EntityVillager || entitylivingbaseIn instanceof EntityZombie && ((EntityZombie)entitylivingbaseIn).isVillager();
            float var13;

            if (!var12 && entitylivingbaseIn.isChild())
            {
                var13 = 2.0F;
                float var14 = 1.4F;
            ...
            if (var10 instanceof ItemBlock)
            {
                ...
                var11.getItemRenderer().renderItem(entitylivingbaseIn, var9, ItemCameraTransforms.TransformType.HEAD);
            }
