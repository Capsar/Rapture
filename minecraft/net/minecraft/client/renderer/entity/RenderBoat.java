...
public class RenderBoat extends Render
{
    ...
    public void doRender(EntityBoat boat, double p_180552_2_, double p_180552_4_, double p_180552_6_, float p_180552_8_, float p_180552_9_)
    {
        ...
        float var10 = (float)boat.getTimeSinceHit() - p_180552_9_;
        ...
        if (var10 > 0.0F)
        {
            GlStateManager.rotate(MathHelper.sin(var10) * var10 * var11 / 10.0F * (float)boat.getForwardDirection(), 1.0F, 0.0F, 0.0F);
        }
