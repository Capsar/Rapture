...
public class RenderManager
{
    ...
    public Render getEntityRenderObject(Entity entityIn)
    {
        ...
        {
            String var2 = ((AbstractClientPlayer)entityIn).getSkinType();
    ...
    public void cacheActiveRenderInfo(World worldIn, FontRenderer textRendererIn, Entity livingPlayerIn, Entity pointedEntityIn, GameSettings optionsIn, float partialTicks)
    {
        ...
        {
            IBlockState var7 = worldIn.getBlockState(new BlockPos(livingPlayerIn));
            Block var8 = var7.getBlock();

            if (var8 == Blocks.bed)
            {
                int var9 = ((EnumFacing)var7.getValue(BlockBed.FACING)).getHorizontalIndex();
    ...
    {
        Render var9 = this.getEntityRenderObject(entityIn);
        return var9 != null && var9.shouldRender(entityIn, camera, camX, camY, camZ);
    }
    ...
    public boolean renderEntityStatic(Entity entity, float partialTicks, boolean p_147936_3_)
    {
        ...
        float var10 = entity.prevRotationYaw + (entity.rotationYaw - entity.prevRotationYaw) * partialTicks;
        int var11 = entity.getBrightnessForRender(partialTicks);
        ...
        return this.doRenderEntity(entity, var4 - this.renderPosX, var6 - this.renderPosY, var8 - this.renderPosZ, var10, partialTicks, p_147936_3_);
    }

    public void renderWitherSkull(Entity entityIn, float partialTicks)
    {
        double var3 = entityIn.lastTickPosX + (entityIn.posX - entityIn.lastTickPosX) * (double)partialTicks;
        double var5 = entityIn.lastTickPosY + (entityIn.posY - entityIn.lastTickPosY) * (double)partialTicks;
        double var7 = entityIn.lastTickPosZ + (entityIn.posZ - entityIn.lastTickPosZ) * (double)partialTicks;
        Render var9 = this.getEntityRenderObject(entityIn);

        if (var9 != null && this.renderEngine != null)
        {
            int var10 = entityIn.getBrightnessForRender(partialTicks);
            int var11 = var10 % 65536;
            int var12 = var10 / 65536;
            OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, (float)var11 / 1.0F, (float)var12 / 1.0F);
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
            var9.renderName(entityIn, var3 - this.renderPosX, var5 - this.renderPosY, var7 - this.renderPosZ);
        }
    }
    ...
    public boolean doRenderEntity(Entity entity, double x, double y, double z, float entityYaw, float partialTicks, boolean p_147939_10_)
    {
        ...
        try
        {
            var11 = this.getEntityRenderObject(entity);
            ...
            if (var11 != null && this.renderEngine != null)
            {
                try
                {
                    ...
                    var11.doRender(entity, x, y, z, entityYaw, partialTicks);
                }
                ...
                try
                {
                    ...
                    {
                        var11.doRenderShadowAndFire(entity, x, y, z, entityYaw, partialTicks);
                    }
                }
        ...
        catch (Throwable var19)
        {
            ...
            entity.addEntityCrashInfo(var14);
            CrashReportCategory var15 = var13.makeCategory("Renderer details");
            var15.addCrashSection("Assigned renderer", var11);
            var15.addCrashSection("Location", CrashReportCategory.getCoordinateInfo(x, y, z));
            var15.addCrashSection("Rotation", Float.valueOf(entityYaw));
            var15.addCrashSection("Delta", Float.valueOf(partialTicks));
    ...
    private void renderDebugBoundingBox(Entity entityIn, double p_85094_2_, double p_85094_4_, double p_85094_6_, float p_85094_8_, float p_85094_9_)
    {
        ...
        var14.addVertex(p_85094_2_ + var15.xCoord * 2.0D, p_85094_4_ + (double)entityIn.getEyeHeight() + var15.yCoord * 2.0D, p_85094_6_ + var15.zCoord * 2.0D);
        var16.draw();
