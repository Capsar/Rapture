...
public class RenderLeashKnot extends Render
{
    ...
    public void func_180559_a(EntityLeashKnot leashKnot, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        this.bindEntityTexture(leashKnot);
        this.leashKnotModel.render(leashKnot, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, var10);
        GlStateManager.popMatrix();
        super.doRender(leashKnot, x, y, z, entityYaw, partialTicks);
    }
    ...
    {
        this.func_180559_a((EntityLeashKnot)entity, x, y, z, entityYaw, partialTicks);
    }
}
