...
import pq.rapture.module.NameTags;
...
public abstract class RendererLivingEntity extends Render {
	 ...
	 */
	protected void renderModel(EntityLivingBase entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_,
	...
	protected void rotateCorpse(EntityLivingBase bat, float p_77043_2_, float p_77043_3_, float p_77043_4_) {
		...
		if (bat.deathTime > 0) {
			float var5 = ((float) bat.deathTime + p_77043_4_ - 1.0F) / 20.0F * 1.6F;
			...
			if (var6 != null && (var6.equals("Dinnerbone") || var6.equals("Grumm"))
	...
	protected float handleRotationFloat(EntityLivingBase livingBase, float p_77044_2_) {
		return (float) livingBase.ticksExisted + p_77044_2_;
	}

	protected void renderLayers(EntityLivingBase entitylivingbaseIn, float p_177093_2_, float p_177093_3_, float p_177093_4_,
		...
		while (var9.hasNext()) {
			...
			var10.doRenderLayer(entitylivingbaseIn, p_177093_2_, p_177093_3_, p_177093_4_, p_177093_5_, p_177093_6_, p_177093_7_,
					p_177093_8_);
	...
	public void passSpecialRender(EntityLivingBase entitylivingbaseIn, double x, double y, double z) {
		//NAMETAG
		EventRenderNametag nametags = new EventRenderNametag(entitylivingbaseIn);
		EventManager.getInstance().fire(nametags);
		if (nametags.isCancelled()) return;
		if (this.canRenderName(entitylivingbaseIn)) {
			...
			if (var8 < (double) (var10 * var10)) {
				...
				if (entitylivingbaseIn.isSneaking()) {
					...
					GlStateManager.pushMatrix();
					GlStateManager.translate((float) x, (float) y + entitylivingbaseIn.height + 0.5F
							- (entitylivingbaseIn.isChild() ? entitylivingbaseIn.height / 2.0F : 0.0F), (float) z);
					...
					this.renderOffsetLivingLabel(entitylivingbaseIn, x, y
							- (entitylivingbaseIn.isChild() ? (double) (entitylivingbaseIn.height / 2.0F) : 0.0D), z, var11, 0.02666667F,
							var8);
				}
			}
		}
	...
	protected boolean canRenderName(EntityLivingBase targetEntity) {
		...
		return Minecraft.isGuiEnabled() && targetEntity != this.renderManager.livingPlayer && !targetEntity.isInvisibleToPlayer(var2)
				&& targetEntity.riddenByEntity == null;
	}
