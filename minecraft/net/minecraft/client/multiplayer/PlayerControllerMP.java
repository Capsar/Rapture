...
import pq.rapture.hooks.EntityPlayerSPHook;
...
public class PlayerControllerMP
{
    ...
    {
        EventManager.getInstance().fire(new EventBlockBreak(pos, side));
    ...
    public boolean clickBlock(BlockPos loc, EnumFacing face)
    {
        ...
        EventManager.getInstance().fire(new EventBlockClick(loc));
        ...
        else
        {
            if (this.currentGameType.isCreative())
            {
                ...
                func_178891_a(this.mc, this, loc, face);
                this.blockHitDelay = 5;
            }
            else if (!this.isHittingBlock || !this.func_178893_a(loc))
            {
    ...
    private boolean func_178893_a(BlockPos p_178893_1_)
    {
        ...
        return p_178893_1_.equals(this.currentBlock) && var3;
    }
    ...
    {
        this.syncCurrentPlayItem();
        float var7 = (float)(hitVec.xCoord - hitPos.getX());
        float var8 = (float)(hitVec.yCoord - hitPos.getY());
        float var9 = (float)(hitVec.zCoord - hitPos.getZ());
        boolean var10 = false;
    ...
    {
    	//TODO: EntityPlayerSPHook
        return new EntityPlayerSPHook(this.mc, worldIn, this.netClientHandler, p_178892_2_);
    }
