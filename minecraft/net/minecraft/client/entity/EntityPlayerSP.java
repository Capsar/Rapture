...
import pq.rapture.module.NoSlowDown;
...
public class EntityPlayerSP extends AbstractClientPlayer
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        if (this.isCurrentViewEntity())
        {
            ...
            double var9 = this.rotationYaw - this.lastReportedYaw;
            double var11 = this.rotationPitch - this.lastReportedPitch;
	...
	public void onLivingUpdate()
    {
        ...
        if (this.isUsingItem() && !this.isRiding() && Wrapper.getMod(NoSlowDown.class) != null && !Wrapper.getMod(NoSlowDown.class).getState())
        {
