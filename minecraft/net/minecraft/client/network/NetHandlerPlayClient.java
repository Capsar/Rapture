...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
	...
	public void handleJoinGame(S01PacketJoinGame packetIn) {
		...
		this.clientWorldController = new WorldClient(this, new WorldSettings(0L, packetIn.getGameType(), false, packetIn.isHardcoreMode(),
				packetIn.getWorldType()), packetIn.getDimension(), packetIn.getDifficulty(), this.gameController.mcProfiler);
		...
		this.netManager.sendPacket(new C17PacketCustomPayload("MC|Brand", (new PacketBuffer(Unpooled.buffer()))
	...
	public void handleSpawnObject(S0EPacketSpawnObject packetIn) {
		PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
		double var2 = (double) packetIn.getX() / 32.0D;
		double var4 = (double) packetIn.getY() / 32.0D;
		double var6 = (double) packetIn.getZ() / 32.0D;
		Object var8 = null;

		if (packetIn.getType() == 10) {
			var8 = EntityMinecart.func_180458_a(this.clientWorldController, var2, var4, var6,
			...
			var8 = new EntityItemFrame(this.clientWorldController, new BlockPos(MathHelper.floor_double(var2),
					MathHelper.floor_double(var4), MathHelper.floor_double(var6)), EnumFacing.getHorizontal(packetIn.func_149009_m()));
			packetIn.func_149002_g(0);
		} else if (packetIn.getType() == 77) {
			var8 = new EntityLeashKnot(this.clientWorldController, new BlockPos(MathHelper.floor_double(var2),
			...
			var8 = new EntityLargeFireball(this.clientWorldController, var2, var4, var6, (double) packetIn.getSpeedX() / 8000.0D,
					(double) packetIn.getSpeedY() / 8000.0D, (double) packetIn.getSpeedZ() / 8000.0D);
			packetIn.func_149002_g(0);
		} else if (packetIn.getType() == 64) {
			var8 = new EntitySmallFireball(this.clientWorldController, var2, var4, var6, (double) packetIn.getSpeedX() / 8000.0D,
					(double) packetIn.getSpeedY() / 8000.0D, (double) packetIn.getSpeedZ() / 8000.0D);
			packetIn.func_149002_g(0);
		} else if (packetIn.getType() == 66) {
			var8 = new EntityWitherSkull(this.clientWorldController, var2, var4, var6, (double) packetIn.getSpeedX() / 8000.0D,
					(double) packetIn.getSpeedY() / 8000.0D, (double) packetIn.getSpeedZ() / 8000.0D);
			packetIn.func_149002_g(0);
			...
			var8 = new EntityFallingBlock(this.clientWorldController, var2, var4, var6,
		...
		if (var8 != null) {
			...
			((Entity) var8).rotationPitch = (float) (packetIn.getPitch() * 360) / 256.0F;
			((Entity) var8).rotationYaw = (float) (packetIn.getYaw() * 360) / 256.0F;
			...
			if (packetIn.func_149009_m() > 0) {
				...
				((Entity) var8).setVelocity((double) packetIn.getSpeedX() / 8000.0D, (double) packetIn.getSpeedY() / 8000.0D,
	...
	public void handleSpawnExperienceOrb(S11PacketSpawnExperienceOrb packetIn) {
		PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
		EntityXPOrb var2 = new EntityXPOrb(this.clientWorldController, (double) packetIn.func_148984_d(),
				(double) packetIn.func_148983_e(), (double) packetIn.func_148982_f(), packetIn.getXPValue());
	...
	public void handleSpawnPainting(S10PacketSpawnPainting packetIn) {
		PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
		EntityPainting var2 = new EntityPainting(this.clientWorldController, packetIn.getPosition(), packetIn.getFacing(),
				packetIn.getTitle());
		this.clientWorldController.addEntityToWorld(packetIn.getEntityID(), var2);
	}
	...
	public void handleEntityVelocity(S12PacketEntityVelocity packetIn) {
		...
		if (var2 != null) {
			var2.setVelocity((double) packetIn.func_149411_d() / 8000.0D, (double) packetIn.func_149410_e() / 8000.0D,
	...
	public void handleSpawnPlayer(S0CPacketSpawnPlayer packetIn) {
		...
		EntityOtherPlayerMP var10 = new EntityOtherPlayerMP(this.gameController.theWorld, this.getPlayerInfo(packetIn.getPlayer())
				.getGameProfile());
	...
	public void handleEntityTeleport(S18PacketEntityTeleport packetIn) {
		...
		if (var2 != null) {
			...
			float var9 = (float) (packetIn.getYaw() * 360) / 256.0F;
			float var10 = (float) (packetIn.getPitch() * 360) / 256.0F;
	...
	public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn) {
		...
		this.netManager.sendPacket(new C03PacketPlayer.C06PacketPlayerPosLook(var2.posX, var2.getEntityBoundingBox().minY, var2.posZ,
	...
	public void handleChunkData(S21PacketChunkData packetIn) {
		...
		this.clientWorldController.markBlockRangeForRenderUpdate(packetIn.getChunkX() << 4, 0, packetIn.getChunkZ() << 4,
				(packetIn.getChunkX() << 4) + 15, 256, (packetIn.getChunkZ() << 4) + 15);
	...
	public void onDisconnect(IChatComponent reason) {
		...
		if (this.guiScreenServer != null) {
			if (this.guiScreenServer instanceof GuiScreenRealmsProxy) {
				this.gameController.displayGuiScreen((new DisconnectedRealmsScreen(((GuiScreenRealmsProxy) this.guiScreenServer)
						.func_154321_a(), "disconnect.lost", reason)).getProxy());
			} else {
				this.gameController.displayGuiScreen(new GuiDisconnected(this.guiScreenServer, "disconnect.lost", reason));
			}
		} else {
			this.gameController.displayGuiScreen(new GuiDisconnected(new GuiMultiplayer(new GuiMainMenuHook()), "disconnect.lost", reason));
		}
	}
	...
	public void addToSendQueue(Packet p_147297_1_) {
		if (p_147297_1_ instanceof C01PacketChatMessage) {
			...
			// TODO: EventSendChat
			EventSendChatMessage sendChat = new EventSendChatMessage(chatMessage.getMessage());
			EventManager.getInstance().fire(sendChat);
			p_147297_1_ = new C01PacketChatMessage(sendChat.getMessage());
			if (sendChat.isCancelled())
				return;

		} else {
			// TODO: EventPacketSend
			EventPacketSend packetSend = new EventPacketSend(p_147297_1_, getNetworkManager());
			EventManager.getInstance().fire(packetSend);
			p_147297_1_ = packetSend.getPacket();
	...
	public void handleCollectItem(S0DPacketCollectItem packetIn) {
		...
		Object var3 = (EntityLivingBase) this.clientWorldController.getEntityByID(packetIn.getEntityID());
		...
		if (var2 != null) {
			if (var2 instanceof EntityXPOrb) {
				this.clientWorldController.playSoundAtEntity(var2, "random.orb", 0.2F,
						((this.avRandomizer.nextFloat() - this.avRandomizer.nextFloat()) * 0.7F + 1.0F) * 2.0F);
			} else {
				this.clientWorldController.playSoundAtEntity(var2, "random.pop", 0.2F,
						((this.avRandomizer.nextFloat() - this.avRandomizer.nextFloat()) * 0.7F + 1.0F) * 2.0F);
			}
	...
	public void handleSpawnMob(S0FPacketSpawnMob packetIn) {
		...
		double var4 = (double) packetIn.getY() / 32.0D;
		double var6 = (double) packetIn.getZ() / 32.0D;
		float var8 = (float) (packetIn.getYaw() * 360) / 256.0F;
		float var9 = (float) (packetIn.getPitch() * 360) / 256.0F;
		...
		var10.rotationYawHead = (float) (packetIn.getHeadPitch() * 360) / 256.0F;
		...
		var10.setPositionAndRotation(var2, var4, var6, var8, var9);
		var10.motionX = (double) ((float) packetIn.getVelocityX() / 8000.0F);
		var10.motionY = (double) ((float) packetIn.getVelocityY() / 8000.0F);
		var10.motionZ = (double) ((float) packetIn.getVelocityZ() / 8000.0F);
		this.clientWorldController.addEntityToWorld(packetIn.getEntityID(), var10);
		...
		if (packetIn.getLeash() == 0) {
			...
			if (var4) {
				...
				this.gameController.ingameGUI.setRecordPlaying(
						I18n.format("mount.onboard", new Object[]{GameSettings.getKeyDisplayString(var5.keyBindSneak.getKeyCode())}),
						false);
			}
	...
	public void handleRespawn(S07PacketRespawn packetIn) {
		...
		if (packetIn.func_149082_c() != this.gameController.thePlayer.dimension) {
			...
			this.clientWorldController = new WorldClient(this, new WorldSettings(0L, packetIn.func_149083_e(), false,
					this.gameController.theWorld.getWorldInfo().isHardcoreModeEnabled(), packetIn.func_149080_f()),
	...
	public void handleExplosion(S27PacketExplosion packetIn) {
		PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
		Explosion var2 = new Explosion(this.gameController.theWorld, (Entity) null, packetIn.func_149148_f(), packetIn.func_149143_g(),
				packetIn.func_149145_h(), packetIn.func_149146_i(), packetIn.func_149150_j());
	...
	public void handleSignEditorOpen(S36PacketSignEditorOpen packetIn) {
		...
		TileEntitySign sign = (TileEntitySign) var2;
		EventPlaceSign event = new EventPlaceSign(sign);
		EventManager.getInstance().fire(event);
		//if(!event.isCancelled()) {
			var2 = event.getSign();
			//if(event.getShouldPlaceBlock()) {
	...
	public void handleUpdateSign(S33PacketUpdateSign packetIn) {
		...
		if (!var2 && this.gameController.thePlayer != null) {
			this.gameController.thePlayer.addChatMessage(new ChatComponentText("Unable to locate sign at "
					+ packetIn.func_179704_a().getX() + ", " + packetIn.func_179704_a().getY() + ", " + packetIn.func_179704_a().getZ()));
		}
	}
	...
	public void handleUpdateTileEntity(S35PacketUpdateTileEntity packetIn) {
		...
		if (this.gameController.theWorld.isBlockLoaded(packetIn.func_179823_a())) {
			...
			if (var3 == 1 && var2 instanceof TileEntityMobSpawner || var3 == 2 && var2 instanceof TileEntityCommandBlock || var3 == 3
					&& var2 instanceof TileEntityBeacon || var3 == 4 && var2 instanceof TileEntitySkull || var3 == 5
					&& var2 instanceof TileEntityFlowerPot || var3 == 6 && var2 instanceof TileEntityBanner) {
	...
	public void handleBlockAction(S24PacketBlockAction packetIn) {
		PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
		this.gameController.theWorld.addBlockEvent(packetIn.getBlockPosition(), packetIn.getBlockType(), packetIn.getData1(),
				packetIn.getData2());
	}
		...
		if (var3 == 1) {
			...
			if (var4 == 0.0F) {
				...
				this.gameController.ingameGUI.getChatGUI().printChatMessage(
						new ChatComponentTranslation("demo.help.movement", new Object[] {
				...
				this.gameController.ingameGUI.getChatGUI().printChatMessage(
						new ChatComponentTranslation("demo.help.jump", new Object[] { GameSettings.getKeyDisplayString(var6.keyBindJump
								.getKeyCode()) }));
			} else if (var4 == 103.0F) {
				this.gameController.ingameGUI.getChatGUI().printChatMessage(
						new ChatComponentTranslation("demo.help.inventory", new Object[] { GameSettings
								.getKeyDisplayString(var6.keyBindInventory.getKeyCode()) }));
			}
		} else if (var3 == 6) {
			this.clientWorldController.playSound(var2.posX, var2.posY + (double) var2.getEyeHeight(), var2.posZ, "random.successful_hit",
					0.18F, 0.45F, false);
		} else if (var3 == 7) {
			...
			this.clientWorldController.spawnParticle(EnumParticleTypes.MOB_APPEARANCE, var2.posX, var2.posY, var2.posZ, 0.0D, 0.0D, 0.0D,
					new int[0]);
	...
	public void handleStatistics(S37PacketStatistics packetIn) {
		...
		for (Iterator var3 = packetIn.func_148974_c().entrySet().iterator(); var3.hasNext(); this.gameController.thePlayer
				.getStatFileWriter().func_150873_a(this.gameController.thePlayer, var5, var6)) {
	...
	public void handleEntityEffect(S1DPacketEntityEffect packetIn) {
		...
		if (var2 instanceof EntityLivingBase) {
			PotionEffect var3 = new PotionEffect(packetIn.getEffectId(), packetIn.getDuration(), packetIn.getAmplifier(), false,
	...
	public void handleCombatEvent(S42PacketCombatEvent packetIn) {
		...
		if (packetIn.field_179776_a == S42PacketCombatEvent.Event.END_COMBAT) {
			long var4 = (long) (1000 * packetIn.field_179772_d / 20);
	...
	public void handleTitle(S45PacketTitle packetIn) {
		...
		this.gameController.ingameGUI.displayTitle(var3, var4, packetIn.getFadeInTime(), packetIn.getDisplayTime(),
	...
	public void handlePlayerListHeaderFooter(S47PacketPlayerListHeaderFooter packetIn) {
		this.gameController.ingameGUI.getTabList().setHeader(
				packetIn.getHeader().getFormattedText().length() == 0 ? null : packetIn.getHeader());
		this.gameController.ingameGUI.getTabList().setFooter(
				packetIn.getFooter().getFormattedText().length() == 0 ? null : packetIn.getFooter());
	}
	...
	public void handleSoundEffect(S29PacketSoundEffect packetIn) {
		PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
		this.gameController.theWorld.playSound(packetIn.func_149207_d(), packetIn.func_149211_e(), packetIn.func_149210_f(),
				packetIn.func_149212_c(), packetIn.func_149208_g(), packetIn.func_149209_h(), false);
	}
			...
			if (var6.isFile()) {
				...
				Futures.addCallback(this.gameController.getResourcePackRepository().func_177319_a(var6), new FutureCallback() {
					...
					public void onSuccess(Object p_onSuccess_1_) {
						NetHandlerPlayClient.this.netManager.sendPacket(new C19PacketResourcePackStatus(var3,
			...
			if (this.gameController.getCurrentServerData() != null
				...
				this.gameController.addScheduledTask(new Runnable() {
					...
					public void run() {
							...
							public void confirmClicked(boolean result, int id) {
								...
								if (result) {
									if (NetHandlerPlayClient.this.gameController.getCurrentServerData() != null) {
										NetHandlerPlayClient.this.gameController.getCurrentServerData().setResourceMode(
												ServerData.ServerResourceMode.ENABLED);
									}

									NetHandlerPlayClient.this.netManager.sendPacket(new C19PacketResourcePackStatus(var3,
											C19PacketResourcePackStatus.Action.ACCEPTED));
									Futures.addCallback(NetHandlerPlayClient.this.gameController.getResourcePackRepository()
											.downloadResourcePack(var2, var3), new FutureCallback() {
						...
						}, I18n.format("multiplayer.texturePrompt.line1", new Object[0]), I18n.format("multiplayer.texturePrompt.line2",
								new Object[0]), 0));
					}
				});
			}
	...
	public void handleTeams(S3EPacketTeams packetIn) {
		...
		if (packetIn.func_149307_h() == 0 || packetIn.func_149307_h() == 2) {
			...
			if (var4 != null) {
				var3.settNameTagVisibility(var4);
			}
		}
	...
	public void handleParticles(S2APacketParticles packetIn) {
		...
		if (packetIn.getParticleCount() == 0) {
			double var2 = (double) (packetIn.getParticleSpeed() * packetIn.getXOffset());
			double var4 = (double) (packetIn.getParticleSpeed() * packetIn.getYOffset());
			double var6 = (double) (packetIn.getParticleSpeed() * packetIn.getZOffset());

			try {
				this.clientWorldController.spawnParticle(packetIn.getParticleType(), packetIn.isLongDistance(), packetIn.getXCoordinate(),
						packetIn.getYCoordinate(), packetIn.getZCoordinate(), var2, var4, var6, packetIn.getParticleArgs());
			...
			for (int var18 = 0; var18 < packetIn.getParticleCount(); ++var18) {
				double var3 = this.avRandomizer.nextGaussian() * (double) packetIn.getXOffset();
				double var5 = this.avRandomizer.nextGaussian() * (double) packetIn.getYOffset();
				double var7 = this.avRandomizer.nextGaussian() * (double) packetIn.getZOffset();
				double var9 = this.avRandomizer.nextGaussian() * (double) packetIn.getParticleSpeed();
				double var11 = this.avRandomizer.nextGaussian() * (double) packetIn.getParticleSpeed();
				double var13 = this.avRandomizer.nextGaussian() * (double) packetIn.getParticleSpeed();

				try {
					this.clientWorldController.spawnParticle(packetIn.getParticleType(), packetIn.isLongDistance(),
							packetIn.getXCoordinate() + var3, packetIn.getYCoordinate() + var5, packetIn.getZCoordinate() + var7, var9,
							var11, var13, packetIn.getParticleArgs());
		...
		if (var2 != null) {
			if (!(var2 instanceof EntityLivingBase)) {
				...
				while (var4.hasNext()) {
					...
					if (var6 == null) {
						var6 = var3.registerAttribute(new RangedAttribute((IAttribute) null, var5.func_151409_a(), 0.0D,
