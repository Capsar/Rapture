...
import pq.rapture.hooks.EntityRendererHook;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private static final List macDisplayModes = Lists.newArrayList(new DisplayMode[]{new DisplayMode(2560, 1600),
    ...
    /**
     * The BlockRenderDispatcher instance that will be used based off
	 * gamesettings
	 */
	...
	public Minecraft(GameConfiguration gameConfig) {
		...
		this.mcDefaultResourcePack = new DefaultResourcePack((new ResourceIndex(gameConfig.folderInfo.assetsDir,
				gameConfig.folderInfo.assetIndex)).getResourceMap());
		this.proxy = gameConfig.userInfo.proxy == null ? Proxy.NO_PROXY : gameConfig.userInfo.proxy;
		this.sessionService = (new YggdrasilAuthenticationService(gameConfig.userInfo.proxy, UUID.randomUUID().toString()))
    ...
    public static int getGLMaximumTextureSize() {
        for (int var0 = 16384; var0 > 0; var0 >>= 1) {
            GL11.glTexImage2D(GL11.GL_PROXY_TEXTURE_2D, 0, GL11.GL_RGBA, var0, var0, 0, GL11.GL_RGBA, GL11.GL_UNSIGNED_BYTE,
                    (ByteBuffer) null);
    ...
    private void startGame() throws LWJGLException {
        ...
        this.mcResourcePackRepository = new ResourcePackRepository(this.fileResourcepacks,
                new File(this.mcDataDir, "server-resource-packs"), this.mcDefaultResourcePack, this.metadataSerializer_, this.gameSettings);
        ...
        this.standardGalacticFontRenderer = new FontRenderer(this.gameSettings, new ResourceLocation("textures/font/ascii_sga.png"),
            ...
            public String formatString(String p_74535_1_) {
                try {
                    return String.format(p_74535_1_,
                            new Object[]{GameSettings.getKeyDisplayString(Minecraft.this.gameSettings.keyBindInventory.getKeyCode())});
        ...
        this.entityRenderer = new EntityRendererHook(this, this.mcResourceManager);
        ...
        // TODO LoadUp
        this.ingameGUI = new RaptureRender(this);

        if (this.serverName != null) {
            this.displayGuiScreen(new GuiConnecting(new GuiMainMenuHook(), this, this.serverName, this.serverPort));
        } else {
            this.displayGuiScreen(new GuiMainMenuHook());
        }
    ...
    private void initStream() {
        try {
            this.stream = new TwitchStream(this,
                    (Property) Iterables.getFirst(this.twitchDetails.get("twitch_access_token"), (Object) null));
	...
	private void drawSplashScreen(TextureManager textureManagerInstance) {
		...
		try {
			...
			this.mojangLogo = textureManagerInstance.getDynamicTextureLocation("logo", new DynamicTexture(ImageIO.read(var5)));
	...
	public void scaledTessellator(int width, int height, int width2, int height2, int stdTextureWidth, int stdTextureHeight) {
		...
		var9.addVertexWithUV((double) (width + 0), (double) (height + stdTextureHeight), 0.0D, (double) ((float) (width2 + 0) * var7),
				(double) ((float) (height2 + stdTextureHeight) * var8));
		var9.addVertexWithUV((double) (width + stdTextureWidth), (double) (height + stdTextureHeight), 0.0D,
				(double) ((float) (width2 + stdTextureWidth) * var7), (double) ((float) (height2 + stdTextureHeight) * var8));
		var9.addVertexWithUV((double) (width + stdTextureWidth), (double) (height + 0), 0.0D,
				(double) ((float) (width2 + stdTextureWidth) * var7), (double) ((float) (height2 + 0) * var8));
		var9.addVertexWithUV((double) (width + 0), (double) (height + 0), 0.0D, (double) ((float) (width2 + 0) * var7),
				(double) ((float) (height2 + 0) * var8));
	...
	public void displayGuiScreen(GuiScreen guiScreenIn) {
		...
		if (guiScreenIn == null && this.theWorld == null) {
			guiScreenIn = new GuiMainMenuHook();
		} else if (guiScreenIn == null && this.thePlayer.getHealth() <= 0.0F) {
			EventDeath death = new EventDeath();
			EventManager.getInstance().fire(death);
			if(!death.isCancelled()) {
				guiScreenIn = new GuiGameOver();
			} else {
				this.thePlayer.setHealth(20);
				this.thePlayer.getFoodStats().setFoodLevel(20);
		...
		while (getSystemTime() >= this.debugUpdateTime + 1000L) {
			...
			this.debug = String.format(
					...
					new Object[] {
							...
							(float) this.gameSettings.limitFramerate == GameSettings.Options.FRAMERATE_LIMIT.getValueMax() ? "inf"
									: Integer.valueOf(this.gameSettings.limitFramerate), this.gameSettings.enableVsync ? " vsync" : "",
							this.gameSettings.fancyGraphics ? "" : " fast", this.gameSettings.clouds ? " clouds" : "",
	...
	private void displayDebugInfo(long elapsedTicksTime) {
		if (this.mcProfiler.profilingEnabled) {
			...
			this.fontRendererObj.drawStringWithShadow(var20 = var19.format(var4.field_76330_b) + "%",
					(float) (var8 + var7 - this.fontRendererObj.getStringWidth(var20)), (float) (var9 - var7 / 2 - 16), var14);
			...
			for(int var21 = 0; var21 < var3.size(); ++var21) {
				...
				this.fontRendererObj.drawStringWithShadow(var23, (float) (var8 - var7), (float) (var9 + var7 / 2 + var21 * 8 + 20),
						var22.func_76329_a());
				this.fontRendererObj.drawStringWithShadow(var23 = var19.format(var22.field_76332_a) + "%",
						(float) (var8 + var7 - 50 - this.fontRendererObj.getStringWidth(var23)),
						(float) (var9 + var7 / 2 + var21 * 8 + 20), var22.func_76329_a());
				this.fontRendererObj.drawStringWithShadow(var23 = var19.format(var22.field_76330_b) + "%",
						(float) (var8 + var7 - this.fontRendererObj.getStringWidth(var23)), (float) (var9 + var7 / 2 + var21 * 8 + 20),
						var22.func_76329_a());
			}
		}
	}
		...
		if (this.objectMouseOver == null) {
			...
			case 2:
				...
				if (this.theWorld.getBlockState(var3).getBlock().getMaterial() != Material.air) {
					...
					if (this.playerController.onPlayerRightClick(this.thePlayer, this.theWorld, var2, var3, this.objectMouseOver.sideHit,
    ...
    public void runTick() throws IOException {
        ...
        EventManager.getInstance().fire(new EventTick());
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Mouse.next()) {
                ...
                if (var1 != -1) {
                    if (Mouse.getEventButtonState()) {
                        EventManager.getInstance().fire(new EventMousePresses(var1, true, EventMousePresses.State.ONPRESS));
                    } else if (!Mouse.getEventButtonState()) {
                        EventManager.getInstance().fire(new EventMousePresses(var1, false, EventMousePresses.State.UNPRESS));
                    }
                }
                if (Mouse.getEventButtonState()) {
                    ...
                    if (var4 != 0) {
                        if (this.thePlayer.isSpectator()) {
                            ...
                            if (this.ingameGUI.getSpectatorGui().func_175262_a()) {
                                ...
                                float var5 = MathHelper.clamp_float(this.thePlayer.capabilities.getFlySpeed() + (float) var4 * 0.005F,
                                        0.0F, 0.2F);
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    EventManager.getInstance().fire(new EventKeyPresses(var1, true, EventKeyPresses.State.ONPRESS));
                } else if (!Keyboard.getEventKeyState()) {
                    EventManager.getInstance().fire(new EventKeyPresses(var1, false, EventKeyPresses.State.UNPRESS));
                }
            ...
            // EventManager.getInstance().fire(new
            // EventMousePresses(Mouse.getEventButton(), true,
            // EventMousePresses.State.WHILE));

            EventManager.getInstance().fire(new EventKeyPresses(Keyboard.getEventKey(), true, EventKeyPresses.State.WHILE));
        ...
        if (this.objectMouseOver != null) {
            ...
            if (this.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                ...
                if (this.objectMouseOver.entityHit instanceof EntityPainting) {
                    ...
                    switch (Minecraft.SwitchEnumMinecartType.field_178901_b[var12.getMinecartType().ordinal()]) {
                        case 1:
    ...
    public void addServerStatsToSnooper(PlayerUsageSnooper playerSnooper) {
        ...
        playerSnooper.addClientStat("run_time",
                Long.valueOf((MinecraftServer.getCurrentTimeMillis() - playerSnooper.getMinecraftStartTimeMillis()) / 60L * 1000L));
	...
	public MusicTicker.MusicType getAmbientMusicType() {
		return this.currentScreen instanceof GuiWinGame ? MusicTicker.MusicType.CREDITS
				: (this.thePlayer != null ? (this.thePlayer.worldObj.provider instanceof WorldProviderHell ? MusicTicker.MusicType.NETHER
						: (this.thePlayer.worldObj.provider instanceof WorldProviderEnd ? (BossStatus.bossName != null
								&& BossStatus.statusBarTime > 0 ? MusicTicker.MusicType.END_BOSS : MusicTicker.MusicType.END)
								: (this.thePlayer.capabilities.isCreativeMode && this.thePlayer.capabilities.allowFlying ? MusicTicker.MusicType.CREATIVE
