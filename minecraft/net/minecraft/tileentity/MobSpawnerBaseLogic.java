...
public abstract class MobSpawnerBaseLogic
{
    ...
    private boolean isActivated()
    {
        ...
        return this.getSpawnerWorld().isAnyPlayerWithinRangeAt(var1.getX() + 0.5D, var1.getY() + 0.5D, var1.getZ() + 0.5D, this.activatingRangeFromPlayer);
    }
    ...
    public void updateSpawner()
    {
        if (this.isActivated())
        {
            ...
            {
                double var2 = var1.getX() + this.getSpawnerWorld().rand.nextFloat();
                double var4 = var1.getY() + this.getSpawnerWorld().rand.nextFloat();
                var6 = var1.getZ() + this.getSpawnerWorld().rand.nextFloat();
            ...
            else
            {
                ...
                for (int var3 = 0; var3 < this.spawnCount; ++var3)
                {
                    ...
                    int var5 = this.getSpawnerWorld().getEntitiesWithinAABB(var14.getClass(), (new AxisAlignedBB(var1.getX(), var1.getY(), var1.getZ(), var1.getX() + 1, var1.getY() + 1, var1.getZ() + 1)).expand(this.spawnRange, this.spawnRange, this.spawnRange)).size();
                    ...
                    var6 = var1.getX() + (this.getSpawnerWorld().rand.nextDouble() - this.getSpawnerWorld().rand.nextDouble()) * this.spawnRange + 0.5D;
                    double var8 = var1.getY() + this.getSpawnerWorld().rand.nextInt(3) - 1;
                    double var10 = var1.getZ() + (this.getSpawnerWorld().rand.nextDouble() - this.getSpawnerWorld().rand.nextDouble()) * this.spawnRange + 0.5D;
    ...
    public void writeToNBT(NBTTagCompound nbt)
    {
        ...
        if (this.getRandomEntity() != null)
        {
            nbt.setTag("SpawnData", this.getRandomEntity().field_98222_b.copy());
        }
