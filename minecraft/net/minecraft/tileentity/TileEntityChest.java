...
public class TileEntityChest extends TileEntityLockable implements IUpdatePlayerListBox, IInventory
{
    ...
    public boolean doesChestHaveAdjacentChests(){
        return adjacentChestChecked && (adjacentChestXNeg != null || adjacentChestXPos != null || adjacentChestZNeg != null  || adjacentChestZPos != null);
    }


    public TileEntityChest getAdjacent(){
        if(doesChestHaveAdjacentChests()){
    ...
    {
        BlockPos var2 = this.pos.offset(side);
        ...
        if (this.isChestAt(var2))
        {
            ...
            if (var3 instanceof TileEntityChest)
            {
                ...
                var4.func_174910_a(this, side.getOpposite());
                return var4;
            }
        }
    ...
    private boolean isChestAt(BlockPos posIn)
    {
        ...
        {
            Block var2 = this.worldObj.getBlockState(posIn).getBlock();
