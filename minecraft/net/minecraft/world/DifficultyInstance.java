...
public class DifficultyInstance
{
    ...
    private float calculateAdditionalDifficulty(EnumDifficulty difficulty, long worldTime, long chunkInhabitedTime, float moonPhaseFactor)
    {
        ...
        else
        {
            ...
            float var8 = 0.75F;
            float var9 = MathHelper.clamp_float(((float)worldTime + -72000.0F) / 1440000.0F, 0.0F, 1.0F) * 0.25F;
            var8 += var9;
            float var10 = 0.0F;
            var10 += MathHelper.clamp_float((float)chunkInhabitedTime / 3600000.0F, 0.0F, 1.0F) * (var7 ? 1.0F : 0.75F);
            ...
            var8 += var10;
            return (float)difficulty.getDifficultyId() * var8;
        }
    }
}
