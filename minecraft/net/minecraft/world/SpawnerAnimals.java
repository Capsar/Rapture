...
public final class SpawnerAnimals
{
    ...
    public int findChunksForSpawning(WorldServer p_77192_1_, boolean spawnHostileMobs, boolean spawnPeacefulMobs, boolean p_77192_4_)
    {
        ...
        else
        {
            ...
            for (int var39 = 0; var39 < var9; ++var39)
            {
                ...
                if ((!var40.getPeacefulCreature() || spawnPeacefulMobs) && (var40.getPeacefulCreature() || spawnHostileMobs) && (!var40.getAnimal() || p_77192_4_))
                {
                    var12 = p_77192_1_.countEntities(var40.getCreatureClass());
                    int var41 = var40.getMaxNumberOfCreature() * var5 / MOB_COUNT_DIV;
                    ...
                    if (var12 <= var41)
                    {
                        ...
                        while (var42.hasNext())
                        {
                            ...
                            BlockPos var16 = getRandomChunkPosition(p_77192_1_, var15.chunkXPos, var15.chunkZPos);
                                    ...
                                    while (true)
                                    {
                                        if (var29 < 4)
                                        {
                                            label108:
                                            {
                                                ...
                                                if (!p_77192_1_.isAnyPlayerWithinRangeAt(var31, var24, var32, 24.0D) && var37.distanceSq(var31, var24, var32) >= 576.0D)
                                                {
                                                    if (var27 == null)
                                                    {
                                                        var27 = p_77192_1_.getSpawnListEntryForTypeAt(var40, var30);
                                                    ...
                                                    if (p_77192_1_.func_175732_a(var40, var27, var30) && canCreatureTypeSpawnAtLocation(EntitySpawnPlacementRegistry.getPlacementForEntity(var27.entityClass), p_77192_1_, var30))
                                                    {
                                                        EntityLiving var33;
    ...
    {
        Chunk var3 = worldIn.getChunkFromChunkCoords(x, z);
        int var4 = x * 16 + worldIn.rand.nextInt(16);
        int var5 = z * 16 + worldIn.rand.nextInt(16);
    ...
    public static boolean canCreatureTypeSpawnAtLocation(EntityLiving.SpawnPlacementType p_180267_0_, World worldIn, BlockPos pos)
    {
        ...
        else
        {
            ...
            {
                return var3.getMaterial().isLiquid() && worldIn.getBlockState(pos.down()).getBlock().getMaterial().isLiquid() && !worldIn.getBlockState(pos.up()).getBlock().isNormalCube();
            }
            else
            {
                ...
                else
                {
                    ...
                    return var6 && !var3.isNormalCube() && !var3.getMaterial().isLiquid() && !worldIn.getBlockState(pos.up()).getBlock().isNormalCube();
                }
            }
        }
    }
        ...
        if (!var7.isEmpty())
        {
            while (p_77191_6_.nextFloat() < p_77191_1_.getSpawningChance())
            {
                ...
                for (int var15 = 0; var15 < var9; ++var15)
                {
                    ...
                    {
                        BlockPos var18 = worldIn.getTopSolidOrLiquidBlock(new BlockPos(var11, 0, var12));

                        if (canCreatureTypeSpawnAtLocation(EntityLiving.SpawnPlacementType.ON_GROUND, worldIn, var18))
                        {
                            EntityLiving var19;
