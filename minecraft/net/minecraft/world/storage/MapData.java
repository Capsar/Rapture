...
public class MapData extends WorldSavedData
{
    ...
    private void updatePlayersVisibleOnMap(int type, World worldIn, String entityIdentifier, double x, double y, double z)
    {
        int var10 = 1 << this.scale;
        float var11 = (float)(x - (double)this.xCenter) / (float)var10;
        float var12 = (float)(y - (double)this.zCenter) / (float)var10;
