...
public class StructureVillagePieces
{
    ...
    public static class Church extends StructureVillagePieces.Village
    {
        ...
        {
            StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(p_175854_3_, p_175854_4_, p_175854_5_, 0, 0, 0, 5, 12, 9, p_175854_6_);
    ...
    public static class Field1 extends StructureVillagePieces.Village
    {
        ...
        {
            StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(p_175851_3_, p_175851_4_, p_175851_5_, 0, 0, 0, 13, 4, 9, p_175851_6_);
    ...
    public static class Field2 extends StructureVillagePieces.Village
    {
        ...
        {
            StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(p_175852_3_, p_175852_4_, p_175852_5_, 0, 0, 0, 7, 4, 9, p_175852_6_);
    ...
    public static class Hall extends StructureVillagePieces.Village
    {
        ...
        {
            StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(p_175857_3_, p_175857_4_, p_175857_5_, 0, 0, 0, 9, 7, 11, p_175857_6_);
    ...
    public static class House1 extends StructureVillagePieces.Village
    {
        ...
        {
            StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(p_175850_3_, p_175850_4_, p_175850_5_, 0, 0, 0, 9, 9, 6, p_175850_6_);
    ...
    public static class House2 extends StructureVillagePieces.Village
    {
        ...
        {
            StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(p_175855_3_, p_175855_4_, p_175855_5_, 0, 0, 0, 10, 6, 7, p_175855_6_);
    ...
    public static class House3 extends StructureVillagePieces.Village
    {
        ...
        {
            StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(p_175849_3_, p_175849_4_, p_175849_5_, 0, 0, 0, 9, 7, 12, p_175849_6_);
    ...
    public static class House4Garden extends StructureVillagePieces.Village
    {
        ...
        {
            StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(p_175858_3_, p_175858_4_, p_175858_5_, 0, 0, 0, 5, 6, 5, p_175858_6_);
    ...
    public static class Path extends StructureVillagePieces.Road
    {
        ...
        public static StructureBoundingBox func_175848_a(StructureVillagePieces.Start p_175848_0_, List p_175848_1_, Random p_175848_2_, int p_175848_3_, int p_175848_4_, int p_175848_5_, EnumFacing p_175848_6_)
        {
            ...
            {
                StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(p_175848_3_, p_175848_4_, p_175848_5_, 0, 0, 0, 3, 3, var7, p_175848_6_);
    ...
    public static class Torch extends StructureVillagePieces.Village
    {
        ...
        {
            StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(p_175856_3_, p_175856_4_, p_175856_5_, 0, 0, 0, 3, 4, 2, p_175856_6_);
    ...
    abstract static class Village extends StructureComponent
    {
        ...
        protected Village(StructureVillagePieces.Start p_i2107_1_, int p_i2107_2_)
        {
            ...
            if (p_i2107_1_ != null)
            {
                this.isDesertVillage = p_i2107_1_.inDesert;
            }
        }
    ...
    public static class WoodHut extends StructureVillagePieces.Village
    {
        ...
        {
            StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(p_175853_3_, p_175853_4_, p_175853_5_, 0, 0, 0, 4, 6, 5, p_175853_6_);
