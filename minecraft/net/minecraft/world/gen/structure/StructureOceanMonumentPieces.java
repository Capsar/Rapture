...
public class StructureOceanMonumentPieces
{
    ...
    public static class DoubleXRoom extends StructureOceanMonumentPieces.Piece
    {
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            {
                this.func_175821_a(worldIn, structureBoundingBoxIn, 8, 0, var4.field_175966_c[EnumFacing.DOWN.getIndex()]);
                this.func_175821_a(worldIn, structureBoundingBoxIn, 0, 0, var5.field_175966_c[EnumFacing.DOWN.getIndex()]);
            }
            ...
            {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 3, 1, 0, 4, 2, 0, field_175822_f, field_175822_f, false);
            }

            if (var5.field_175966_c[EnumFacing.NORTH.getIndex()])
            {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 3, 1, 7, 4, 2, 7, field_175822_f, field_175822_f, false);
            }

            if (var5.field_175966_c[EnumFacing.WEST.getIndex()])
            {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 1, 3, 0, 2, 4, field_175822_f, field_175822_f, false);
            }

            if (var4.field_175966_c[EnumFacing.SOUTH.getIndex()])
            {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 11, 1, 0, 12, 2, 0, field_175822_f, field_175822_f, false);
            }

            if (var4.field_175966_c[EnumFacing.NORTH.getIndex()])
            {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 11, 1, 7, 12, 2, 7, field_175822_f, field_175822_f, false);
            }

            if (var4.field_175966_c[EnumFacing.EAST.getIndex()])
            {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 15, 1, 3, 15, 2, 4, field_175822_f, field_175822_f, false);
            }
    ...
    public static class DoubleXYRoom extends StructureOceanMonumentPieces.Piece
    {
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            for (int var8 = 1; var8 <= 7; ++var8)
            {
                ...
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, var8, 0, 0, var8, 7, var9, var9, false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 15, var8, 0, 15, var8, 7, var9, var9, false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, var8, 0, 15, var8, 0, var9, var9, false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, var8, 7, 14, var8, 7, var9, var9, false);
            }
            ...
            {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 3, 5, 0, 4, 6, 0, field_175822_f, field_175822_f, false);
            }

            if (var6.field_175966_c[EnumFacing.NORTH.getIndex()])
            {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 3, 5, 7, 4, 6, 7, field_175822_f, field_175822_f, false);
            }

            if (var6.field_175966_c[EnumFacing.WEST.getIndex()])
            {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 5, 3, 0, 6, 4, field_175822_f, field_175822_f, false);
            }

            if (var7.field_175966_c[EnumFacing.SOUTH.getIndex()])
            {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 11, 5, 0, 12, 6, 0, field_175822_f, field_175822_f, false);
            }

            if (var7.field_175966_c[EnumFacing.NORTH.getIndex()])
            {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 11, 5, 7, 12, 6, 7, field_175822_f, field_175822_f, false);
            }

            if (var7.field_175966_c[EnumFacing.EAST.getIndex()])
            {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 15, 5, 3, 15, 6, 4, field_175822_f, field_175822_f, false);
            }
    ...
    public static class DoubleYRoom extends StructureOceanMonumentPieces.Piece
    {
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            for (int var6 = 1; var6 <= 5; var6 += 4)
            {
                ...
                if (var5.field_175966_c[EnumFacing.SOUTH.getIndex()])
                {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 2, var6, var7, 2, var6 + 2, var7, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 5, var6, var7, 5, var6 + 2, var7, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 3, var6 + 2, var7, 4, var6 + 2, var7, field_175826_b, field_175826_b, false);
                }
                else
                {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, var6, var7, 7, var6 + 2, var7, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, var6 + 1, var7, 7, var6 + 1, var7, field_175828_a, field_175828_a, false);
                }
                ...
                if (var5.field_175966_c[EnumFacing.WEST.getIndex()])
                {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, var8, var6, 2, var8, var6 + 2, 2, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, var8, var6, 5, var8, var6 + 2, 5, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, var8, var6 + 2, 3, var8, var6 + 2, 4, field_175826_b, field_175826_b, false);
                }
                else
                {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, var8, var6, 0, var8, var6 + 2, 7, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, var8, var6 + 1, 0, var8, var6 + 1, 7, field_175828_a, field_175828_a, false);
                }
    ...
    public static class DoubleYZRoom extends StructureOceanMonumentPieces.Piece
    {
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            if (this.field_175830_k.field_175967_a / 25 > 0)
            {
                this.func_175821_a(worldIn, structureBoundingBoxIn, 0, 8, var4.field_175966_c[EnumFacing.DOWN.getIndex()]);
                this.func_175821_a(worldIn, structureBoundingBoxIn, 0, 0, var5.field_175966_c[EnumFacing.DOWN.getIndex()]);
            }
            ...
            for (var8 = 1; var8 <= 7; ++var8)
            {
                ...
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, var8, 0, 0, var8, 15, var9, var9, false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 7, var8, 0, 7, var8, 15, var9, var9, false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, var8, 0, 6, var8, 0, var9, var9, false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, var8, 15, 6, var8, 15, var9, var9, false);
            }
            ...
            for (var8 = 1; var8 <= 7; ++var8)
            {
                ...
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 3, var8, 7, 4, var8, 8, var9, var9, false);
            }
            ...
            if (var5.field_175966_c[EnumFacing.EAST.getIndex()])
            {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 7, 1, 3, 7, 2, 4, field_175822_f, field_175822_f, false);
            }
            ...
            if (var4.field_175966_c[EnumFacing.NORTH.getIndex()])
            {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 3, 1, 15, 4, 2, 15, field_175822_f, field_175822_f, false);
            }

            if (var4.field_175966_c[EnumFacing.WEST.getIndex()])
            {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 1, 11, 0, 2, 12, field_175822_f, field_175822_f, false);
            }

            if (var4.field_175966_c[EnumFacing.EAST.getIndex()])
            {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 7, 1, 11, 7, 2, 12, field_175822_f, field_175822_f, false);
            }
            ...
            if (var7.field_175966_c[EnumFacing.EAST.getIndex()])
            {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 7, 5, 3, 7, 6, 4, field_175822_f, field_175822_f, false);
            ...
            if (var6.field_175966_c[EnumFacing.NORTH.getIndex()])
            {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 3, 5, 15, 4, 6, 15, field_175822_f, field_175822_f, false);
            }

            if (var6.field_175966_c[EnumFacing.WEST.getIndex()])
            {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 5, 11, 0, 6, 12, field_175822_f, field_175822_f, false);
            ...
            {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 7, 5, 11, 7, 6, 12, field_175822_f, field_175822_f, false);
    ...
    public static class EntryRoom extends StructureOceanMonumentPieces.Piece
    {
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 1, 3, 1, 2, 4, field_175822_f, field_175822_f, false);
            }

            if (this.field_175830_k.field_175966_c[EnumFacing.EAST.getIndex()])
            {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 6, 1, 3, 7, 2, 4, field_175822_f, field_175822_f, false);
            }
    ...
    public static class MonumentBuilding extends StructureOceanMonumentPieces.Piece
    {
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            for (var4 = 0; var4 < 7; ++var4)
            {
                ...
                while (var5 < 7)
                {
                    ...
                    for (int var8 = 0; var8 < 4; ++var8)
                    {
                        ...
                        {
                            this.setBlockState(worldIn, field_175826_b, var6 + var8, 0, var7 + var9, structureBoundingBoxIn);
                            this.replaceAirAndLiquidDownwards(worldIn, field_175826_b, var6 + var8, -1, var7 + var9, structureBoundingBoxIn);
                        }
                    }
            ...
            for (var4 = 0; var4 < 5; ++var4)
            {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, -1 - var4, 0 + var4 * 2, -1 - var4, -1 - var4, 23, 58 + var4, field_175822_f, field_175822_f, false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 58 + var4, 0 + var4 * 2, -1 - var4, 58 + var4, 23, 58 + var4, field_175822_f, field_175822_f, false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0 - var4, 0 + var4 * 2, -1 - var4, 57 + var4, 23, -1 - var4, field_175822_f, field_175822_f, false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0 - var4, 0 + var4 * 2, 58 + var4, 57 + var4, 23, 58 + var4, field_175822_f, field_175822_f, false);
            }
            ...
            while (var10.hasNext())
            {
                ...
                if (var11.getBoundingBox().intersectsWith(structureBoundingBoxIn))
                {
                    var11.addComponentParts(worldIn, randomIn, structureBoundingBoxIn);
                }
            }
        ...
        private void func_175840_a(boolean p_175840_1_, int p_175840_2_, World worldIn, Random p_175840_4_, StructureBoundingBox p_175840_5_)
        {
            ...
            if (this.func_175818_a(p_175840_5_, p_175840_2_, 0, p_175840_2_ + 23, 20))
            {
                ...
                this.fillWithBlocks(worldIn, p_175840_5_, p_175840_2_ + 0, 1, 0, p_175840_2_ + 24, 10, 20, field_175822_f, field_175822_f, false);
                int var7;

                for (var7 = 0; var7 < 4; ++var7)
                {
                    this.fillWithBlocks(worldIn, p_175840_5_, p_175840_2_ + var7, var7 + 1, var7, p_175840_2_ + var7, var7 + 1, 20, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, p_175840_5_, p_175840_2_ + var7 + 7, var7 + 5, var7 + 7, p_175840_2_ + var7 + 7, var7 + 5, 20, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, p_175840_5_, p_175840_2_ + 17 - var7, var7 + 5, var7 + 7, p_175840_2_ + 17 - var7, var7 + 5, 20, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, p_175840_5_, p_175840_2_ + 24 - var7, var7 + 1, var7, p_175840_2_ + 24 - var7, var7 + 1, 20, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, p_175840_5_, p_175840_2_ + var7 + 1, var7 + 1, var7, p_175840_2_ + 23 - var7, var7 + 1, var7, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, p_175840_5_, p_175840_2_ + var7 + 8, var7 + 5, var7 + 7, p_175840_2_ + 16 - var7, var7 + 5, var7 + 7, field_175826_b, field_175826_b, false);
                }
                ...
                {
                    this.setBlockState(worldIn, field_175824_d, var7, 5, var9, p_175840_5_);
                }

                for (var9 = 19; var9 >= 7; var9 -= 3)
                {
                    this.setBlockState(worldIn, field_175824_d, var8, 5, var9, p_175840_5_);
                }

                for (var9 = 0; var9 < 4; ++var9)
                {
                    int var10 = p_175840_1_ ? p_175840_2_ + (24 - (17 - var9 * 3)) : p_175840_2_ + 17 - var9 * 3;
                    this.setBlockState(worldIn, field_175824_d, var10, 5, 5, p_175840_5_);
                }

                this.setBlockState(worldIn, field_175824_d, var8, 5, 5, p_175840_5_);
        ...
        private void func_175839_b(World worldIn, Random p_175839_2_, StructureBoundingBox p_175839_3_)
        {
            ...
            {
                this.fillWithBlocks(worldIn, p_175839_3_, 25, 0, 0, 32, 8, 20, field_175822_f, field_175822_f, false);

                for (int var4 = 0; var4 < 4; ++var4)
                {
                    this.fillWithBlocks(worldIn, p_175839_3_, 24, 2, 5 + var4 * 4, 24, 4, 5 + var4 * 4, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, p_175839_3_, 22, 4, 5 + var4 * 4, 23, 4, 5 + var4 * 4, field_175826_b, field_175826_b, false);
                    this.setBlockState(worldIn, field_175826_b, 25, 5, 5 + var4 * 4, p_175839_3_);
                    this.setBlockState(worldIn, field_175826_b, 26, 6, 5 + var4 * 4, p_175839_3_);
                    this.setBlockState(worldIn, field_175825_e, 26, 5, 5 + var4 * 4, p_175839_3_);
                    this.fillWithBlocks(worldIn, p_175839_3_, 33, 2, 5 + var4 * 4, 33, 4, 5 + var4 * 4, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, p_175839_3_, 34, 4, 5 + var4 * 4, 35, 4, 5 + var4 * 4, field_175826_b, field_175826_b, false);
                    this.setBlockState(worldIn, field_175826_b, 32, 5, 5 + var4 * 4, p_175839_3_);
                    this.setBlockState(worldIn, field_175826_b, 31, 6, 5 + var4 * 4, p_175839_3_);
                    this.setBlockState(worldIn, field_175825_e, 31, 5, 5 + var4 * 4, p_175839_3_);
                    this.fillWithBlocks(worldIn, p_175839_3_, 27, 6, 5 + var4 * 4, 30, 6, 5 + var4 * 4, field_175828_a, field_175828_a, false);
                }
            }
        }
        ...
        private void func_175837_c(World worldIn, Random p_175837_2_, StructureBoundingBox p_175837_3_)
        {
            if (this.func_175818_a(p_175837_3_, 15, 20, 42, 21))
            {
                ...
                this.fillWithBlocks(worldIn, p_175837_3_, 26, 1, 21, 31, 3, 21, field_175822_f, field_175822_f, false);
                ...
                for (var4 = 0; var4 < 7; ++var4)
                {
                    this.setBlockState(worldIn, field_175827_c, 28 - var4, 6 + var4, 21, p_175837_3_);
                    this.setBlockState(worldIn, field_175827_c, 29 + var4, 6 + var4, 21, p_175837_3_);
                }

                for (var4 = 0; var4 < 4; ++var4)
                {
                    this.setBlockState(worldIn, field_175827_c, 28 - var4, 9 + var4, 21, p_175837_3_);
                    this.setBlockState(worldIn, field_175827_c, 29 + var4, 9 + var4, 21, p_175837_3_);
                }
                ...
                {
                    this.setBlockState(worldIn, field_175827_c, 22 - var4 * 2, 8, 21, p_175837_3_);
                    this.setBlockState(worldIn, field_175827_c, 22 - var4 * 2, 9, 21, p_175837_3_);
                    this.setBlockState(worldIn, field_175827_c, 35 + var4 * 2, 8, 21, p_175837_3_);
                    this.setBlockState(worldIn, field_175827_c, 35 + var4 * 2, 9, 21, p_175837_3_);
                }

                this.fillWithBlocks(worldIn, p_175837_3_, 15, 13, 21, 42, 15, 21, field_175822_f, field_175822_f, false);
                this.fillWithBlocks(worldIn, p_175837_3_, 15, 1, 21, 15, 6, 21, field_175822_f, field_175822_f, false);
                this.fillWithBlocks(worldIn, p_175837_3_, 16, 1, 21, 16, 5, 21, field_175822_f, field_175822_f, false);
                this.fillWithBlocks(worldIn, p_175837_3_, 17, 1, 21, 20, 4, 21, field_175822_f, field_175822_f, false);
                this.fillWithBlocks(worldIn, p_175837_3_, 21, 1, 21, 21, 3, 21, field_175822_f, field_175822_f, false);
                this.fillWithBlocks(worldIn, p_175837_3_, 22, 1, 21, 22, 2, 21, field_175822_f, field_175822_f, false);
                this.fillWithBlocks(worldIn, p_175837_3_, 23, 1, 21, 24, 1, 21, field_175822_f, field_175822_f, false);
                this.fillWithBlocks(worldIn, p_175837_3_, 42, 1, 21, 42, 6, 21, field_175822_f, field_175822_f, false);
                this.fillWithBlocks(worldIn, p_175837_3_, 41, 1, 21, 41, 5, 21, field_175822_f, field_175822_f, false);
                this.fillWithBlocks(worldIn, p_175837_3_, 37, 1, 21, 40, 4, 21, field_175822_f, field_175822_f, false);
                this.fillWithBlocks(worldIn, p_175837_3_, 36, 1, 21, 36, 3, 21, field_175822_f, field_175822_f, false);
                this.fillWithBlocks(worldIn, p_175837_3_, 35, 1, 21, 35, 2, 21, field_175822_f, field_175822_f, false);
                this.fillWithBlocks(worldIn, p_175837_3_, 33, 1, 21, 34, 1, 21, field_175822_f, field_175822_f, false);
            }
        }
        ...
        private void func_175841_d(World worldIn, Random p_175841_2_, StructureBoundingBox p_175841_3_)
        {
            if (this.func_175818_a(p_175841_3_, 21, 21, 36, 36))
            {
                ...
                this.fillWithBlocks(worldIn, p_175841_3_, 21, 1, 22, 36, 23, 36, field_175822_f, field_175822_f, false);

                for (int var4 = 0; var4 < 4; ++var4)
                {
                    this.fillWithBlocks(worldIn, p_175841_3_, 21 + var4, 13 + var4, 21 + var4, 36 - var4, 13 + var4, 21 + var4, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, p_175841_3_, 21 + var4, 13 + var4, 36 - var4, 36 - var4, 13 + var4, 36 - var4, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, p_175841_3_, 21 + var4, 13 + var4, 22 + var4, 21 + var4, 13 + var4, 35 - var4, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, p_175841_3_, 36 - var4, 13 + var4, 22 + var4, 36 - var4, 13 + var4, 35 - var4, field_175826_b, field_175826_b, false);
                }
        ...
        private void func_175835_e(World worldIn, Random p_175835_2_, StructureBoundingBox p_175835_3_)
        {
            ...
            if (this.func_175818_a(p_175835_3_, 0, 21, 6, 58))
            {
                ...
                this.fillWithBlocks(worldIn, p_175835_3_, 0, 1, 21, 6, 7, 57, field_175822_f, field_175822_f, false);
                this.fillWithBlocks(worldIn, p_175835_3_, 4, 4, 21, 6, 4, 53, field_175828_a, field_175828_a, false);

                for (var4 = 0; var4 < 4; ++var4)
                {
                    this.fillWithBlocks(worldIn, p_175835_3_, var4, var4 + 1, 21, var4, var4 + 1, 57 - var4, field_175826_b, field_175826_b, false);
                }

                for (var4 = 23; var4 < 53; var4 += 3)
                {
                    this.setBlockState(worldIn, field_175824_d, 5, 5, var4, p_175835_3_);
                }
            ...
            if (this.func_175818_a(p_175835_3_, 51, 21, 58, 58))
            {
                ...
                this.fillWithBlocks(worldIn, p_175835_3_, 51, 1, 21, 57, 7, 57, field_175822_f, field_175822_f, false);
                this.fillWithBlocks(worldIn, p_175835_3_, 51, 4, 21, 53, 4, 53, field_175828_a, field_175828_a, false);

                for (var4 = 0; var4 < 4; ++var4)
                {
                    this.fillWithBlocks(worldIn, p_175835_3_, 57 - var4, var4 + 1, 21, 57 - var4, var4 + 1, 57 - var4, field_175826_b, field_175826_b, false);
                }

                for (var4 = 23; var4 < 53; var4 += 3)
                {
                    this.setBlockState(worldIn, field_175824_d, 52, 5, var4, p_175835_3_);
                }
            ...
            if (this.func_175818_a(p_175835_3_, 0, 51, 57, 57))
            {
                ...
                this.fillWithBlocks(worldIn, p_175835_3_, 7, 1, 51, 50, 10, 57, field_175822_f, field_175822_f, false);

                for (var4 = 0; var4 < 4; ++var4)
                {
                    this.fillWithBlocks(worldIn, p_175835_3_, var4 + 1, var4 + 1, 57 - var4, 56 - var4, var4 + 1, 57 - var4, field_175826_b, field_175826_b, false);
                }
            }
        }
        ...
        private void func_175842_f(World worldIn, Random p_175842_2_, StructureBoundingBox p_175842_3_)
        {
            ...
            if (this.func_175818_a(p_175842_3_, 7, 21, 13, 50))
            {
                ...
                this.fillWithBlocks(worldIn, p_175842_3_, 7, 1, 21, 13, 10, 50, field_175822_f, field_175822_f, false);
                this.fillWithBlocks(worldIn, p_175842_3_, 11, 8, 21, 13, 8, 53, field_175828_a, field_175828_a, false);

                for (var4 = 0; var4 < 4; ++var4)
                {
                    this.fillWithBlocks(worldIn, p_175842_3_, var4 + 7, var4 + 5, 21, var4 + 7, var4 + 5, 54, field_175826_b, field_175826_b, false);
                }

                for (var4 = 21; var4 <= 45; var4 += 3)
                {
                    this.setBlockState(worldIn, field_175824_d, 12, 9, var4, p_175842_3_);
                }
            }
            ...
            if (this.func_175818_a(p_175842_3_, 44, 21, 50, 54))
            {
                ...
                this.fillWithBlocks(worldIn, p_175842_3_, 44, 1, 21, 50, 10, 50, field_175822_f, field_175822_f, false);
                this.fillWithBlocks(worldIn, p_175842_3_, 44, 8, 21, 46, 8, 53, field_175828_a, field_175828_a, false);

                for (var4 = 0; var4 < 4; ++var4)
                {
                    this.fillWithBlocks(worldIn, p_175842_3_, 50 - var4, var4 + 5, 21, 50 - var4, var4 + 5, 54, field_175826_b, field_175826_b, false);
                }

                for (var4 = 21; var4 <= 45; var4 += 3)
                {
                    this.setBlockState(worldIn, field_175824_d, 45, 9, var4, p_175842_3_);
                }
            }
            ...
            if (this.func_175818_a(p_175842_3_, 8, 44, 49, 54))
            {
                ...
                this.fillWithBlocks(worldIn, p_175842_3_, 14, 1, 44, 43, 10, 50, field_175822_f, field_175822_f, false);

                for (var4 = 12; var4 <= 45; var4 += 3)
                {
                    this.setBlockState(worldIn, field_175824_d, var4, 9, 45, p_175842_3_);
                    this.setBlockState(worldIn, field_175824_d, var4, 9, 52, p_175842_3_);

                    if (var4 == 12 || var4 == 18 || var4 == 24 || var4 == 33 || var4 == 39 || var4 == 45)
                    {
                        this.setBlockState(worldIn, field_175824_d, var4, 9, 47, p_175842_3_);
                        this.setBlockState(worldIn, field_175824_d, var4, 9, 50, p_175842_3_);
                        this.setBlockState(worldIn, field_175824_d, var4, 10, 45, p_175842_3_);
                        this.setBlockState(worldIn, field_175824_d, var4, 10, 46, p_175842_3_);
                        this.setBlockState(worldIn, field_175824_d, var4, 10, 51, p_175842_3_);
                        this.setBlockState(worldIn, field_175824_d, var4, 10, 52, p_175842_3_);
                        this.setBlockState(worldIn, field_175824_d, var4, 11, 47, p_175842_3_);
                        this.setBlockState(worldIn, field_175824_d, var4, 11, 50, p_175842_3_);
                        this.setBlockState(worldIn, field_175824_d, var4, 12, 48, p_175842_3_);
                        this.setBlockState(worldIn, field_175824_d, var4, 12, 49, p_175842_3_);
                    }
                }

                for (var4 = 0; var4 < 3; ++var4)
                {
                    this.fillWithBlocks(worldIn, p_175842_3_, 8 + var4, 5 + var4, 54, 49 - var4, 5 + var4, 54, field_175828_a, field_175828_a, false);
                }
        ...
        private void func_175838_g(World worldIn, Random p_175838_2_, StructureBoundingBox p_175838_3_)
        {
            ...
            if (this.func_175818_a(p_175838_3_, 14, 21, 20, 43))
            {
                ...
                this.fillWithBlocks(worldIn, p_175838_3_, 14, 1, 22, 20, 14, 43, field_175822_f, field_175822_f, false);
                ...
                for (var4 = 0; var4 < 4; ++var4)
                {
                    this.fillWithBlocks(worldIn, p_175838_3_, var4 + 14, var4 + 9, 21, var4 + 14, var4 + 9, 43 - var4, field_175826_b, field_175826_b, false);
                }

                for (var4 = 23; var4 <= 39; var4 += 3)
                {
                    this.setBlockState(worldIn, field_175824_d, 19, 13, var4, p_175838_3_);
                }
            }
            ...
            if (this.func_175818_a(p_175838_3_, 37, 21, 43, 43))
            {
                ...
                this.fillWithBlocks(worldIn, p_175838_3_, 37, 1, 22, 43, 14, 43, field_175822_f, field_175822_f, false);
                ...
                for (var4 = 0; var4 < 4; ++var4)
                {
                    this.fillWithBlocks(worldIn, p_175838_3_, 43 - var4, var4 + 9, 21, 43 - var4, var4 + 9, 43 - var4, field_175826_b, field_175826_b, false);
                }

                for (var4 = 23; var4 <= 39; var4 += 3)
                {
                    this.setBlockState(worldIn, field_175824_d, 38, 13, var4, p_175838_3_);
                }
            }
            ...
            if (this.func_175818_a(p_175838_3_, 15, 37, 42, 43))
            {
                ...
                this.fillWithBlocks(worldIn, p_175838_3_, 21, 1, 37, 36, 14, 43, field_175822_f, field_175822_f, false);
                this.fillWithBlocks(worldIn, p_175838_3_, 21, 12, 37, 36, 12, 39, field_175828_a, field_175828_a, false);

                for (var4 = 0; var4 < 4; ++var4)
                {
                    this.fillWithBlocks(worldIn, p_175838_3_, 15 + var4, var4 + 9, 43 - var4, 42 - var4, var4 + 9, 43 - var4, field_175826_b, field_175826_b, false);
                }

                for (var4 = 21; var4 <= 36; var4 += 3)
                {
                    this.setBlockState(worldIn, field_175824_d, var4, 13, 38, p_175838_3_);
                }
            }
        }
    }
    ...
    public static class MonumentCoreRoom extends StructureOceanMonumentPieces.Piece
    {
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, var4, 0, 0, var4, 15, var5, var5, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 15, var4, 0, 15, var4, 15, var5, var5, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, var4, 0, 15, var4, 0, var5, var5, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, var4, 15, 14, var4, 15, var5, var5, false);
            int var7;
            ...
            for (var7 = 1; var7 <= 6; ++var7)
            {
                ...
                {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, var6, var7, 0, var6, var7, 1, var5, var5, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, var6, var7, 6, var6, var7, 9, var5, var5, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, var6, var7, 14, var6, var7, 15, var5, var5, false);
                }

                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, var7, 0, 1, var7, 0, var5, var5, false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 6, var7, 0, 9, var7, 0, var5, var5, false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 14, var7, 0, 14, var7, 0, var5, var5, false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, var7, 15, 14, var7, 15, var5, var5, false);
            }
            ...
            for (var7 = 3; var7 <= 6; var7 += 3)
            {
                ...
                {
                    this.setBlockState(worldIn, field_175825_e, var8, var7, 6, structureBoundingBoxIn);
                    this.setBlockState(worldIn, field_175825_e, var8, var7, 9, structureBoundingBoxIn);
                }
            }
    ...
    public static class Penthouse extends StructureOceanMonumentPieces.Piece
    {
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            {
                this.setBlockState(worldIn, field_175825_e, 0, 0, var4, structureBoundingBoxIn);
                this.setBlockState(worldIn, field_175825_e, 13, 0, var4, structureBoundingBoxIn);
                this.setBlockState(worldIn, field_175825_e, var4, 0, 0, structureBoundingBoxIn);
            }
            ...
            for (int var5 = 0; var5 < 2; ++var5)
            {
                ...
                {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, var7, 0, var6, var7, 2, var6, field_175826_b, field_175826_b, false);
                }
            ...
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 6, -1, 3, 7, -1, 4, field_175822_f, field_175822_f, false);
    ...
    public abstract static class Piece extends StructureComponent
    {
        ...
        protected void func_175819_a(World worldIn, StructureBoundingBox p_175819_2_, int p_175819_3_, int p_175819_4_, int p_175819_5_, int p_175819_6_, int p_175819_7_, int p_175819_8_, IBlockState p_175819_9_)
        {
            for (int var10 = p_175819_4_; var10 <= p_175819_7_; ++var10)
            {
                for (int var11 = p_175819_3_; var11 <= p_175819_6_; ++var11)
                {
                    ...
                    {
                        if (this.getBlockStateFromPos(worldIn, var11, var10, var12, p_175819_2_) == field_175822_f)
                        {
                            this.setBlockState(worldIn, p_175819_9_, var11, var10, var12, p_175819_2_);
                        }
                    }
                }
            }
        ...
        protected boolean func_175817_a(World worldIn, StructureBoundingBox p_175817_2_, int p_175817_3_, int p_175817_4_, int p_175817_5_)
        {
            ...
            if (p_175817_2_.isVecInside(new BlockPos(var6, var7, var8)))
            {
    ...
    public static class SimpleRoom extends StructureOceanMonumentPieces.Piece
    {
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            boolean var4 = this.field_175833_o != 0 && randomIn.nextBoolean() && !this.field_175830_k.field_175966_c[EnumFacing.DOWN.getIndex()] && !this.field_175830_k.field_175966_c[EnumFacing.UP.getIndex()] && this.field_175830_k.func_175960_c() > 1;
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            for (int var4 = 1; var4 <= 6; ++var4)
            {
                for (int var5 = 1; var5 <= 6; ++var5)
                {
                    ...
                    {
                        int var6 = 2 + (randomIn.nextInt(4) == 0 ? 0 : 1);
                        this.fillWithBlocks(worldIn, structureBoundingBoxIn, var4, var6, var5, var4, 3, var5, Blocks.sponge.getStateFromMeta(1), Blocks.sponge.getStateFromMeta(1), false);
                    }
                }
            }
    ...
    public static class WingRoom extends StructureOceanMonumentPieces.Piece
    {
		...
		public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            if (this.field_175834_o == 0)
            {
                ...
                for (var4 = 0; var4 < 4; ++var4)
                {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 10 - var4, 3 - var4, 20 - var4, 12 + var4, 3 - var4, 20, field_175826_b, field_175826_b, false);
                }
                ...
                {
                    this.setBlockState(worldIn, field_175825_e, 6, 3, var4, structureBoundingBoxIn);
                    this.setBlockState(worldIn, field_175825_e, 16, 3, var4, structureBoundingBoxIn);
                }
            ...
            else if (this.field_175834_o == 1)
            {
                ...
                {
                    this.setBlockState(worldIn, field_175826_b, var8, var6 + 1, var5, structureBoundingBoxIn);
                    this.setBlockState(worldIn, field_175825_e, var8, var6, var5, structureBoundingBoxIn);
                    this.setBlockState(worldIn, field_175826_b, var8, var6 - 1, var5, structureBoundingBoxIn);
                    var8 = 13;
                }
                ...
                for (var7 = 0; var7 < 2; ++var7)
                {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, var8, 0, 10, var8, 6, 10, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, var8, 0, 12, var8, 6, 12, field_175826_b, field_175826_b, false);
                    this.setBlockState(worldIn, field_175825_e, var8, 0, 10, structureBoundingBoxIn);
                    this.setBlockState(worldIn, field_175825_e, var8, 0, 12, structureBoundingBoxIn);
                    this.setBlockState(worldIn, field_175825_e, var8, 4, 10, structureBoundingBoxIn);
                    this.setBlockState(worldIn, field_175825_e, var8, 4, 12, structureBoundingBoxIn);
                    var8 = 12;
                }
                ...
                for (var7 = 0; var7 < 2; ++var7)
                {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, var8, 0, 7, var8, 2, 7, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, var8, 0, 14, var8, 2, 14, field_175826_b, field_175826_b, false);
                    var8 = 14;
                }
