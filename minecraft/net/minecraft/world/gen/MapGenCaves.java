...
public class MapGenCaves extends MapGenBase
{
    ...
    {
        double var19 = p_180702_3_ * 16 + 8;
        double var21 = p_180702_4_ * 16 + 8;
        float var23 = 0.0F;
        float var24 = 0.0F;
        ...
        {
            double var29 = 1.5D + MathHelper.sin(p_180702_15_ * (float)Math.PI / p_180702_16_) * p_180702_12_ * 1.0F;
            ...
            if (var54 || var25.nextInt(4) != 0)
            {
                ...
                double var39 = p_180702_16_ - p_180702_15_;
                double var41 = p_180702_12_ + 2.0F + 16.0F;
                ...
                if (p_180702_6_ >= var19 - 16.0D - var29 * 2.0D && p_180702_10_ >= var21 - 16.0D - var29 * 2.0D && p_180702_6_ <= var19 + 16.0D + var29 * 2.0D && p_180702_10_ <= var21 + 16.0D + var29 * 2.0D)
                {
                    ...
                    if (!var58)
                    {
                        ...
                        {
                            double var59 = (var42 + p_180702_3_ * 16 + 0.5D - p_180702_6_) / var29;

                            for (int var60 = var57; var60 < var40; ++var60)
                            {
                                double var46 = (var60 + p_180702_4_ * 16 + 0.5D - p_180702_10_) / var29;
                                boolean var48 = false;
                                ...
                                if (var59 * var59 + var46 * var46 < 1.0D)
                                {
                                    ...
                                    {
                                        double var50 = (var49 - 1 + 0.5D - p_180702_8_) / var31;

                                        if (var50 > -0.7D && var59 * var59 + var50 * var50 + var46 * var46 < 1.0D)
                                        {
                                            IBlockState var52 = p_180702_5_.getBlockState(var42, var49, var60);
                                            IBlockState var53 = Objects.firstNonNull(p_180702_5_.getBlockState(var42, var49 + 1, var60), Blocks.air.getDefaultState());
                                            ...
                                            if (this.func_175793_a(var52, var53))
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    {
                                                        p_180702_5_.setBlockState(var42, var49 + 1, var60, var53.getValue(BlockSand.VARIANT) == BlockSand.EnumType.RED_SAND ? Blocks.red_sandstone.getDefaultState() : Blocks.sandstone.getDefaultState());
                                                    }
	...
	protected void func_180701_a(World worldIn, int p_180701_2_, int p_180701_3_, int p_180701_4_, int p_180701_5_, ChunkPrimer p_180701_6_)
    {
        ...
        {
            double var9 = p_180701_2_ * 16 + this.rand.nextInt(16);
            double var11 = this.rand.nextInt(this.rand.nextInt(120) + 8);
            double var13 = p_180701_3_ * 16 + this.rand.nextInt(16);
            int var15 = 1;
