	...
	public int[] getInts(int areaX, int areaY, int areaWidth, int areaHeight)
    {
        ...
        for (int var13 = 0; var13 < var8 - 1; ++var13)
        {
            ...
            for (int var16 = var9[var14 + 0 + (var13 + 1) * var7]; var14 < var7 - 1; ++var14)
            {
                ...
                double var19 = (this.nextInt(1024) / 1024.0D - 0.5D) * 3.6D;
                double var21 = (this.nextInt(1024) / 1024.0D - 0.5D) * 3.6D;
                this.initChunkSeed(var14 + var5 + 1 << 2, var13 + var6 << 2);
                double var23 = (this.nextInt(1024) / 1024.0D - 0.5D) * 3.6D + 4.0D;
                double var25 = (this.nextInt(1024) / 1024.0D - 0.5D) * 3.6D;
                this.initChunkSeed(var14 + var5 << 2, var13 + var6 + 1 << 2);
                double var27 = (this.nextInt(1024) / 1024.0D - 0.5D) * 3.6D;
                double var29 = (this.nextInt(1024) / 1024.0D - 0.5D) * 3.6D + 4.0D;
                this.initChunkSeed(var14 + var5 + 1 << 2, var13 + var6 + 1 << 2);
                double var31 = (this.nextInt(1024) / 1024.0D - 0.5D) * 3.6D + 4.0D;
                double var33 = (this.nextInt(1024) / 1024.0D - 0.5D) * 3.6D + 4.0D;
