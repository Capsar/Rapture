...
public class ChunkProviderFlat implements IChunkProvider
{
	...
	public Chunk provideChunk(int x, int z)
    {
        ...
        while (var8.hasNext())
        {
            ...
            var10.generate(this, this.worldObj, x, z, var3);
        }

        Chunk var9 = new Chunk(this.worldObj, var3, x, z);
        BiomeGenBase[] var11 = this.worldObj.getWorldChunkManager().loadBlockGeneratorData((BiomeGenBase[])null, x * 16, z * 16, 16, 16);
	...
	public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_)
    {
        ...
        this.random.setSeed(p_73153_2_ * var9 + p_73153_3_ * var11 ^ this.worldObj.getSeed());
        ...
        {
            var7.decorate(this.worldObj, this.random, new BlockPos(var4, 0, var5));
        }
    }
	...
	public BlockPos getStrongholdGen(World worldIn, String structureName, BlockPos position)
    {
        if ("Stronghold".equals(structureName))
        {
            ...
            while (var4.hasNext())
            {
                ...
                {
                    return var5.getClosestStrongholdPos(worldIn, position);
                }
            }
        }
	...
	public void recreateStructures(Chunk p_180514_1_, int p_180514_2_, int p_180514_3_)
    {
        ...
        {
            MapGenStructure var5 = (MapGenStructure)var4.next();
            var5.generate(this, this.worldObj, p_180514_2_, p_180514_3_, (ChunkPrimer)null);
        }
    }
