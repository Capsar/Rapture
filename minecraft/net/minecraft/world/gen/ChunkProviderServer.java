...
public class ChunkProviderServer implements IChunkProvider
{
    ...
    {
        Chunk var3 = (Chunk)this.id2ChunkMap.getValueByKey(ChunkCoordIntPair.chunkXZ2Int(x, z));
        return var3 == null ? (!this.worldObj.isFindingSpawnPoint() && !this.chunkLoadOverride ? this.dummyChunk : this.loadChunk(x, z)) : var3;
    }
        ...
        else
        {
            try
            {
                ...
                if (var3 != null)
                {
                    ...
                    if (this.serverChunkGenerator != null)
                    {
                        this.serverChunkGenerator.recreateStructures(var3, x, z);
                    }
                }
