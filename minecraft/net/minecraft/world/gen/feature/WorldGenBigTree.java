...
public class WorldGenBigTree extends WorldGenAbstractTree
{
        ...
        for (; var3 >= 0; --var3)
        {
            ...
            if (var4 >= 0.0F)
            {
                for (int var5 = 0; var5 < var1; ++var5)
                {
                    ...
                    double var8 = (double)(this.rand.nextFloat() * 2.0F) * Math.PI;
        ...
        for (int var5 = -var4; var5 <= var4; ++var5)
        {
            for (int var6 = -var4; var6 <= var4; ++var6)
            {
                if (Math.pow((double)Math.abs(var5) + 0.5D, 2.0D) + Math.pow((double)Math.abs(var6) + 0.5D, 2.0D) <= (double)(p_180712_2_ * p_180712_2_))
                {
                    ...
                    {
                        this.setBlock(this.world, var7, p_180712_3_, 0);
                    }
                }
            }
        }
    ...
    int checkBlockLine(BlockPos posOne, BlockPos posTwo)
    {
        ...
        else
        {
            ...
            {
                BlockPos var9 = posOne.add((double)(0.5F + (float)var8 * var5), (double)(0.5F + (float)var8 * var6), (double)(0.5F + (float)var8 * var7));
