            ...
            else
            {
                ...
                if ((var19 == Blocks.grass || var19 == Blocks.dirt || var19 == Blocks.farmland) && position.getY() < 256 - var4 - 1)
                {
                        ...
                        for (var12 = position.getX() - var11; var12 <= position.getX() + var11; ++var12)
                        {
                            ...
                            for (int var14 = position.getZ() - var11; var14 <= position.getZ() + var11; ++var14)
                            {
                                ...
                                if (Math.abs(var13) != var11 || Math.abs(var15) != var11 || rand.nextInt(2) != 0 && var10 != 0)
                                {
                                    ...
                                    {
                                        this.setBlock(worldIn, var16, Blocks.leaves, this.metaLeaves);
                                    }
                                }
                            }
                        }
                    ...
                    for (var9 = 0; var9 < var4; ++var9)
                    {
                        ...
                        {
                            this.setBlock(worldIn, position.up(var9), Blocks.log, this.metaWood);

                            if (this.vinesGrow && var9 > 0)
                            {
                                if (rand.nextInt(3) > 0 && worldIn.isAirBlock(position.add(-1, var9, 0)))
                                {
                                    this.setBlock(worldIn, position.add(-1, var9, 0), Blocks.vine, BlockVine.EAST_FLAG);
                                }

                                if (rand.nextInt(3) > 0 && worldIn.isAirBlock(position.add(1, var9, 0)))
                                {
                                    this.setBlock(worldIn, position.add(1, var9, 0), Blocks.vine, BlockVine.WEST_FLAG);
                                }

                                if (rand.nextInt(3) > 0 && worldIn.isAirBlock(position.add(0, var9, -1)))
                                {
                                    this.setBlock(worldIn, position.add(0, var9, -1), Blocks.vine, BlockVine.SOUTH_FLAG);
                                }

                                if (rand.nextInt(3) > 0 && worldIn.isAirBlock(position.add(0, var9, 1)))
                                {
                                    this.setBlock(worldIn, position.add(0, var9, 1), Blocks.vine, BlockVine.NORTH_FLAG);
                                }
                            }
                        }
                    }
                            ...
                            for (var9 = 0; var9 < 2; ++var9)
                            {
                                for (var10 = 0; var10 < 4; ++var10)
                                {
                                    if (rand.nextInt(4 - var9) == 0)
                                    {
                                        ...
                                        this.setBlock(worldIn, position.add(var22.getFrontOffsetX(), var4 - 5 + var9, var22.getFrontOffsetZ()), Blocks.cocoa, var11 << 2 | EnumFacing.getHorizontal(var10).getHorizontalIndex());
                                    }
                                }
                            }
                        }
