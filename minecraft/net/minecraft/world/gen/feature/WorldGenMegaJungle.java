...
public class WorldGenMegaJungle extends WorldGenHugeTrees
{
        ...
        else
        {
            ...
            for (int var5 = position.getY() + var4 - 2 - rand.nextInt(4); var5 > position.getY() + var4 / 2; var5 -= 2 + rand.nextInt(4))
            {
                ...
                for (var9 = 0; var9 < 5; ++var9)
                {
                    ...
                    this.setBlock(worldIn, new BlockPos(var7, var5 - 3 + var9 / 2, var8), Blocks.log, this.woodMetadata);
                }
            ...
            for (int var13 = 0; var13 < var4; ++var13)
            {
                ...
                {
                    this.setBlock(worldIn, var14, Blocks.log, this.woodMetadata);
                ...
                if (var13 < var4 - 1)
                {
                    ...
                    {
                        this.setBlock(worldIn, var15, Blocks.log, this.woodMetadata);
                    ...
                    {
                        this.setBlock(worldIn, var16, Blocks.log, this.woodMetadata);
                    ...
                    {
                        this.setBlock(worldIn, var17, Blocks.log, this.woodMetadata);
    ...
    private void func_175932_b(World worldIn, Random p_175932_2_, BlockPos p_175932_3_, int p_175932_4_)
    {
        ...
        {
            this.setBlock(worldIn, p_175932_3_, Blocks.vine, p_175932_4_);
        }
    }
