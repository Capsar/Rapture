...
public class WorldGenDungeons extends WorldGenerator
{
    ...
    {
        boolean var4 = true;
        int var5 = rand.nextInt(2) + 2;
        int var6 = -var5 - 1;
        int var7 = var5 + 1;
        boolean var8 = true;
        boolean var9 = true;
        int var10 = rand.nextInt(2) + 2;
        int var11 = -var10 - 1;
        int var12 = var10 + 1;
        int var13 = 0;
        int var14;
        ...
        for (var14 = var6; var14 <= var7; ++var14)
        {
            for (var15 = -1; var15 <= 4; ++var15)
            {
                ...
                {
                    var17 = position.add(var14, var15, var16);
        ...
        if (var13 >= 1 && var13 <= 5)
        {
            ...
            while (var14 < 2)
            {
                ...
                while (true)
                {
                    if (var15 < 3)
                    {
                        label100:
                        {
                            var16 = position.getX() + rand.nextInt(var5 * 2 + 1) - var5;
                            int var24 = position.getY();
                            int var25 = position.getZ() + rand.nextInt(var10 * 2 + 1) - var10;
                            ...
                            if (worldIn.isAirBlock(var26))
                            {
                                ...
                                if (var20 == 1)
                                {
                                    worldIn.setBlockState(var26, Blocks.chest.correctFacing(worldIn, var26, Blocks.chest.getDefaultState()), 2);
                                    List var27 = WeightedRandomChestContent.func_177629_a(CHESTCONTENT, new WeightedRandomChestContent[] {Items.enchanted_book.getRandom(rand)});
                                    TileEntity var28 = worldIn.getTileEntity(var26);

                                    if (var28 instanceof TileEntityChest)
                                    {
                                        WeightedRandomChestContent.generateChestContents(rand, var27, (TileEntityChest)var28, 8);
                                    }
            ...
            TileEntity var23 = worldIn.getTileEntity(position);

            if (var23 instanceof TileEntityMobSpawner)
            {
                ((TileEntityMobSpawner)var23).getSpawnerBaseLogic().setEntityName(this.pickMobSpawner(rand));
            }
            else
            {
