            ...
            else
            {
                ...
                else
                {
                        ...
                        for (int var18 = position.getX() - var10; var18 <= position.getX() + var10; ++var18)
                        {
                            for (int var12 = position.getZ() - var10; var12 <= position.getZ() + var10; ++var12)
                            {
                                ...
                                if (var13 != 0 || position.getY() >= position.getY() + var5 - 1)
                                {
                                    ...
                                    {
                                        this.setBlock(worldIn, var14, Block.getBlockById(Block.getIdFromBlock(Blocks.brown_mushroom_block) + var4), var13);
                                    }
                                }
                            }
                        }
                    ...
                    for (var9 = 0; var9 < var5; ++var9)
                    {
                        ...
                        {
                            this.setBlock(worldIn, position.up(var9), Block.getBlockById(Block.getIdFromBlock(Blocks.brown_mushroom_block) + var4), 10);
                        }
                    }
