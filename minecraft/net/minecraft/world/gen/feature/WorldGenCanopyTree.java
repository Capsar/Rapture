...
public class WorldGenCanopyTree extends WorldGenAbstractTree
{
    ...
    {
        int var4 = rand.nextInt(3) + rand.nextInt(2) + 6;
        boolean var5 = true;
        ...
        if (position.getY() >= 1 && position.getY() + var4 + 1 <= 256)
        {
            ...
            {
                Block var18 = worldIn.getBlockState(position.down()).getBlock();

                if ((var18 == Blocks.grass || var18 == Blocks.dirt) && position.getY() < 256 - var4 - 1)
                {
                    this.func_175921_a(worldIn, position.down());
                    this.func_175921_a(worldIn, position.add(1, -1, 0));
                    this.func_175921_a(worldIn, position.add(1, -1, 1));
                    this.func_175921_a(worldIn, position.add(0, -1, 1));
                    EnumFacing var19 = EnumFacing.Plane.HORIZONTAL.random(rand);
                    var8 = var4 - rand.nextInt(4);
                    var9 = 2 - rand.nextInt(3);
                    ...
                    for (var13 = 0; var13 < var4; ++var13)
                    {
                        ...
                        {
                            this.setBlock(worldIn, var15, Blocks.log2, BlockPlanks.EnumType.DARK_OAK.getMetadata() - 4);
                            this.setBlock(worldIn, var15.east(), Blocks.log2, BlockPlanks.EnumType.DARK_OAK.getMetadata() - 4);
                            this.setBlock(worldIn, var15.south(), Blocks.log2, BlockPlanks.EnumType.DARK_OAK.getMetadata() - 4);
                            this.setBlock(worldIn, var15.east().south(), Blocks.log2, BlockPlanks.EnumType.DARK_OAK.getMetadata() - 4);
                            var12 = var14;
                        }
                    }
                    ...
                    for (var13 = -1; var13 <= 2; ++var13)
                    {
                        ...
                        {
                            if ((var13 < 0 || var13 > 1 || var14 < 0 || var14 > 1) && rand.nextInt(3) <= 0)
                            {
                                int var22 = rand.nextInt(3) + 2;
                                int var23;

                                for (var23 = 0; var23 < var22; ++var23)
                                {
                                    this.setBlock(worldIn, new BlockPos(position.getX() + var13, var12 - var23 - 1, position.getZ() + var14), Blocks.log2, BlockPlanks.EnumType.DARK_OAK.getMetadata() - 4);
                                }
    ...
    private void func_150526_a(World worldIn, int p_150526_2_, int p_150526_3_, int p_150526_4_)
    {
        ...
        {
            this.setBlock(worldIn, new BlockPos(p_150526_2_, p_150526_3_, p_150526_4_), Blocks.leaves2, 1);
        }
    }
}
