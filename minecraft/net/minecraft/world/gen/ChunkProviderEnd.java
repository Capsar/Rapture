...
public class ChunkProviderEnd implements IChunkProvider
{
	...
	public Chunk provideChunk(int x, int z)
    {
        ...
        this.func_180520_a(x, z, var3);
        this.func_180519_a(var3);
        Chunk var4 = new Chunk(this.endWorld, var3, x, z);
    ...
    private double[] initializeNoiseField(double[] p_73187_1_, int p_73187_2_, int p_73187_3_, int p_73187_4_, int p_73187_5_, int p_73187_6_, int p_73187_7_)
    {
        ...
        for (int var13 = 0; var13 < p_73187_5_; ++var13)
        {
            ...
            {
                float var15 = (var13 + p_73187_2_) / 1.0F;
                float var16 = (var14 + p_73187_4_) / 1.0F;
	...
	public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_)
    {
        ...
        this.endWorld.getBiomeGenForCoords(var4.add(16, 0, 16)).decorate(this.endWorld, this.endWorld.rand, var4);
