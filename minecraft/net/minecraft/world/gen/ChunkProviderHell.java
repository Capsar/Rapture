...
public class ChunkProviderHell implements IChunkProvider
{
    ...
    public Chunk provideChunk(int x, int z)
    {
        ...
        this.func_180515_a(x, z, var3);
        this.func_180516_b(x, z, var3);
        this.netherCaveGenerator.generate(this, this.worldObj, x, z, var3);

        if (this.field_177466_i)
        {
            this.genNetherBridge.generate(this, this.worldObj, x, z, var3);
        }

        Chunk var4 = new Chunk(this.worldObj, var3, x, z);
        BiomeGenBase[] var5 = this.worldObj.getWorldChunkManager().loadBlockGeneratorData((BiomeGenBase[])null, x * 16, z * 16, 16, 16);
