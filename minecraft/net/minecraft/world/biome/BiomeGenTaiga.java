...
public class BiomeGenTaiga extends BiomeGenBase
{
	...
	public void decorate(World worldIn, Random p_180624_2_, BlockPos p_180624_3_)
    {
        ...
        for (var4 = 0; var4 < 7; ++var4)
        {
            ...
            var6 = p_180624_2_.nextInt(16) + 8;
            var7 = p_180624_2_.nextInt(worldIn.getHeight(p_180624_3_.add(var5, 0, var6)).getY() + 32);
            DOUBLE_PLANT_GENERATOR.generate(worldIn, p_180624_2_, p_180624_3_.add(var5, var7, var6));
        }
