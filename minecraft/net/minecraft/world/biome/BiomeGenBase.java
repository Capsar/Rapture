...
public abstract class BiomeGenBase
{
    ...
    public final float getFloatTemperature(BlockPos pos)
    {
        if (pos.getY() > 64)
        {
            float var2 = (float)(temperatureNoise.func_151601_a((double)pos.getX() * 1.0D / 8.0D, (double)pos.getZ() * 1.0D / 8.0D) * 4.0D);
    ...
    {
        double var2 = (double)MathHelper.clamp_float(this.getFloatTemperature(p_180627_1_), 0.0F, 1.0F);
    ...
    {
        double var2 = (double)MathHelper.clamp_float(this.getFloatTemperature(p_180625_1_), 0.0F, 1.0F);
        double var4 = (double)MathHelper.clamp_float(this.getFloatRainfall(), 0.0F, 1.0F);
            ...
            else
            {
                ...
                else if (var16.getBlock() == Blocks.stone)
                {
                    if (var11 == -1)
                    {
                        ...
                        {
                            if (this.getFloatTemperature(new BlockPos(p_180628_4_, var15, p_180628_5_)) < 0.15F)
                            {
