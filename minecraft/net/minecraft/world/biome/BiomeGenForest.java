...
public class BiomeGenForest extends BiomeGenBase
{
	...
	public BlockFlower.EnumFlowerType pickRandomFlower(Random p_180623_1_, BlockPos p_180623_2_)
    {
        if (this.field_150632_aF == 1)
        {
            double var3 = MathHelper.clamp_double((1.0D + GRASS_COLOR_NOISE.func_151601_a(p_180623_2_.getX() / 48.0D, p_180623_2_.getZ() / 48.0D)) / 2.0D, 0.0D, 0.9999D);
        ...
        if (this.field_150632_aF == 3)
        {
            for (var4 = 0; var4 < 4; ++var4)
            {
                for (var5 = 0; var5 < 4; ++var5)
                {
                    ...
                    BlockPos var8 = worldIn.getHeight(p_180624_3_.add(var6, 0, var7));
        ...
        while (var5 < var4)
        {
            ...
            while (true)
            {
                if (var7 < 5)
                {
                    ...
                    int var10 = p_180624_2_.nextInt(worldIn.getHeight(p_180624_3_.add(var11, 0, var13)).getY() + 32);

                    if (!DOUBLE_PLANT_GENERATOR.generate(worldIn, p_180624_2_, new BlockPos(p_180624_3_.getX() + var11, var10, p_180624_3_.getZ() + var13)))
                    {
                        ++var7;
                        continue;
                    }
    ...
    {
        int var2 = super.getGrassColorAtPos(p_180627_1_);
