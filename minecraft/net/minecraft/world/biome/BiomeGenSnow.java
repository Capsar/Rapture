	...
	public void decorate(World worldIn, Random p_180624_2_, BlockPos p_180624_3_)
    {
        if (this.field_150615_aC)
        {
            ...
            for (var4 = 0; var4 < 3; ++var4)
            {
                ...
                this.field_150616_aD.generate(worldIn, p_180624_2_, worldIn.getHeight(p_180624_3_.add(var5, 0, var6)));
            }
            ...
            for (var4 = 0; var4 < 2; ++var4)
            {
                var5 = p_180624_2_.nextInt(16) + 8;
                var6 = p_180624_2_.nextInt(16) + 8;
                this.field_150617_aE.generate(worldIn, p_180624_2_, worldIn.getHeight(p_180624_3_.add(var5, 0, var6)));
            }
        }
