...
public class BiomeGenPlains extends BiomeGenBase
{
    ...
    {
        double var3 = GRASS_COLOR_NOISE.func_151601_a(p_180623_2_.getX() / 200.0D, p_180623_2_.getZ() / 200.0D);
        int var5;
    ...
    {
        double var4 = GRASS_COLOR_NOISE.func_151601_a((p_180624_3_.getX() + 8) / 200.0D, (p_180624_3_.getZ() + 8) / 200.0D);
        int var6;
        int var7;
        int var8;
        int var9;
        ...
        else
        {
            ...
            for (var6 = 0; var6 < 7; ++var6)
            {
                ...
                var9 = p_180624_2_.nextInt(worldIn.getHeight(p_180624_3_.add(var7, 0, var8)).getY() + 32);
                DOUBLE_PLANT_GENERATOR.generate(worldIn, p_180624_2_, p_180624_3_.add(var7, var9, var8));
            }
        }
