...
public class Teleporter
{
    ...
    public void placeInPortal(Entity entityIn, float rotationYaw)
    {
        ...
        else
        {
            ...
            entityIn.setLocationAndAngles((double)var3, (double)var4, (double)var5, entityIn.rotationYaw, 0.0F);
    ...
    public boolean placeInExistingPortal(Entity entityIn, float rotationYaw)
    {
        ...
        if (var4 >= 0.0D)
        {
            ...
            if (var18 != null)
            {
                ...
                entityIn.motionX = var30 * (double)var26 + var32 * (double)var29;
                entityIn.motionZ = var30 * (double)var28 + var32 * (double)var27;
                entityIn.rotationYaw = rotationYaw - (float)(var19.getHorizontalIndex() * 90) + (float)(var18.getHorizontalIndex() * 90);
            }
            else
            {
                entityIn.motionX = entityIn.motionY = entityIn.motionZ = 0.0D;
