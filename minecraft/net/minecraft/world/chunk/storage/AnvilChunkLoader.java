...
public class AnvilChunkLoader implements IChunkLoader, IThreadedFileIO
{
    ...
    protected Chunk checkedReadChunkFromNBT(World worldIn, int x, int z, NBTTagCompound p_75822_4_)
    {
        ...
        else
        {
            ...
            {
                logger.error("Chunk file at " + x + "," + z + " is in the wrong location; relocating. (Expected " + x + ", " + z + ", got " + var5.xPosition + ", " + var5.zPosition + ")");
    ...
    private void writeChunkToNBT(Chunk chunkIn, World worldIn, NBTTagCompound p_75820_3_)
    {
        ...
        ExtendedBlockStorage[] var4 = chunkIn.getBlockStorageArray();
        ...
        for (var8 = 0; var8 < chunkIn.getEntityLists().length; ++var8)
        {
            var22 = chunkIn.getEntityLists()[var8].iterator();
        ...
        var22 = chunkIn.getTileEntityMap().values().iterator();
        ...
        List var23 = worldIn.getPendingBlockUpdates(chunkIn, false);
        ...
        if (var23 != null)
        {
            ...
            while (var28.hasNext())
            {
                ...
                ResourceLocation var31 = (ResourceLocation)Block.blockRegistry.getNameForObject(var29.getBlock());
                var30.setString("i", var31 == null ? "" : var31.toString());
                var30.setInteger("x", var29.position.getX());
                var30.setInteger("y", var29.position.getY());
                var30.setInteger("z", var29.position.getZ());
        ...
        if (p_75823_2_.hasKey("TileTicks", 9))
        {
            ...
            if (var28 != null)
            {
                for (int var31 = 0; var31 < var28.tagCount(); ++var31)
                {
                    ...
                    worldIn.scheduleBlockUpdate(new BlockPos(var34.getInteger("x"), var34.getInteger("y"), var34.getInteger("z")), var36, var34.getInteger("t"), var34.getInteger("p"));
                }
            }
        }
