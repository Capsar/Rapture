...
public class AnvilSaveConverter extends SaveFormatOld
{
    ...
    {
        WorldInfo var2 = this.getWorldInfo(saveName);
	...
	public boolean convertMapFormat(String filename, IProgressUpdate progressCallback)
    {
        ...
        File var6 = new File(this.savesDirectory, filename);
        ...
        WorldInfo var10 = this.getWorldInfo(filename);
        Object var11 = null;
        ...
        this.convertFile(new File(var6, "region"), var3, (WorldChunkManager)var11, 0, var9, progressCallback);
        this.convertFile(new File(var7, "region"), var4, new WorldChunkManagerHell(BiomeGenBase.hell, 0.0F), var3.size(), var9, progressCallback);
        this.convertFile(new File(var8, "region"), var5, new WorldChunkManagerHell(BiomeGenBase.sky, 0.0F), var3.size() + var4.size(), var9, progressCallback);
        ...
        ISaveHandler var12 = this.getSaveLoader(filename, false);
    ...
    {
        File var2 = new File(this.savesDirectory, filename);
    ...
    private void convertChunks(File p_75811_1_, File p_75811_2_, WorldChunkManager p_75811_3_, int p_75811_4_, int p_75811_5_, IProgressUpdate progressCallback)
    {
        try
        {
            ...
            for (int var10 = 0; var10 < 32; ++var10)
            {
                ...
                if (var20 > var11)
                {
                    progressCallback.setLoadingProgress(var20);
                }
            }
    ...
    private void addRegionFilesToCollection(File worldDir, Collection collection)
    {
        ...
        if (var4 != null)
        {
            Collections.addAll(collection, var4);
        }
    }
}
