...
public class Chunk
{
    ...
    {
        int var4 = this.worldObj.getHeight(new BlockPos(x, 0, z)).getY();

        if (var4 > maxValue)
        {
            this.updateSkylightNeighborHeight(x, z, maxValue, var4 + 1);
        }
        else if (var4 < maxValue)
        {
            this.updateSkylightNeighborHeight(x, z, var4, maxValue + 1);
        }
    }
    ...
    private int getBlockMetadata(int x, int y, int z)
    {
        ...
        {
            ExtendedBlockStorage var4 = this.storageArrays[y >> 4];
    ...
    public IBlockState setBlockState(BlockPos pos, IBlockState state)
    {
        ...
        IBlockState var8 = this.getBlockState(pos);
        ...
        else
        {
            ...
            var11.set(var3, var4 & 15, var5, state);

            if (var10 != var9)
            {
                if (!this.worldObj.isRemote)
                {
                    var10.breakBlock(this.worldObj, pos, var8);
                }
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (var13 != var14 && (var13 < var14 || this.getLightFor(EnumSkyBlock.SKY, pos) > 0 || this.getLightFor(EnumSkyBlock.BLOCK, pos) > 0))
                    {
                ...
                {
                    var15 = this.getTileEntity(pos, Chunk.EnumCreateEntityType.CHECK);
                ...
                {
                    var9.onBlockAdded(this.worldObj, pos, state);
                }
                ...
                if (var9 instanceof ITileEntityProvider)
                {
                    ...
                    if (var15 == null)
                    {
                        var15 = ((ITileEntityProvider)var9).createNewTileEntity(this.worldObj, var9.getMetaFromState(state));
    ...
    public int getLightFor(EnumSkyBlock p_177413_1_, BlockPos pos)
    {
        ...
        return var6 == null ? (this.canSeeSky(pos) ? p_177413_1_.defaultLightValue : 0) : (p_177413_1_ == EnumSkyBlock.SKY ? (this.worldObj.provider.getHasNoSky() ? 0 : var6.getExtSkylightValue(var3, var4 & 15, var5)) : (p_177413_1_ == EnumSkyBlock.BLOCK ? var6.getExtBlocklightValue(var3, var4 & 15, var5) : p_177413_1_.defaultLightValue));
    }
    ...
    public void setLightFor(EnumSkyBlock p_177431_1_, BlockPos pos, int value)
    {
        ...
        if (p_177431_1_ == EnumSkyBlock.SKY)
        {
            if (!this.worldObj.provider.getHasNoSky())
            {
                var7.setExtSkylightValue(var4, var5 & 15, var6, value);
            }
        }
        else if (p_177431_1_ == EnumSkyBlock.BLOCK)
        {
            var7.setExtBlocklightValue(var4, var5 & 15, var6, value);
        }
    }
    ...
    {
        TileEntity var3 = (TileEntity)this.chunkTileEntityMap.get(pos);

        if (var3 == null)
        {
            if (p_177424_2_ == Chunk.EnumCreateEntityType.IMMEDIATE)
            {
                var3 = this.createNewTileEntity(pos);
                this.worldObj.setTileEntity(pos, var3);
            }
    ...
    {
        int var5 = MathHelper.floor_double((aabb.minY - 2.0D) / 16.0D);
        int var6 = MathHelper.floor_double((aabb.maxY + 2.0D) / 16.0D);
        ...
        for (int var7 = var5; var7 <= var6; ++var7)
        {
            ...
            while (var8.hasNext())
            {
                ...
                if (var9 != entityIn && var9.getEntityBoundingBox().intersectsWith(aabb) && (p_177414_4_ == null || p_177414_4_.apply(var9)))
                {
                    listToFill.add(var9);
    ...
    public void getEntitiesOfTypeWithinAAAB(Class entityClass, AxisAlignedBB aabb, List listToFill, Predicate p_177430_4_)
    {
        ...
        for (int var7 = var5; var7 <= var6; ++var7)
        {
            Iterator var8 = this.entityLists[var7].getByClass(entityClass).iterator();

            while (var8.hasNext())
            {
                Entity var9 = (Entity)var8.next();

                if (var9.getEntityBoundingBox().intersectsWith(aabb) && (p_177430_4_ == null || p_177430_4_.apply(var9)))
                {
                    listToFill.add(var9);
                }
            }
    ...
    public BlockPos getPrecipitationHeight(BlockPos pos)
    {
        ...
        BlockPos var5 = new BlockPos(pos.getX(), this.precipitationHeightMap[var4], pos.getZ());
        ...
        return new BlockPos(pos.getX(), this.precipitationHeightMap[var4], pos.getZ());
    }
    ...
    public boolean getAreLevelsEmpty(int startY, int endY)
    {
        ...
        for (int var3 = startY; var3 <= endY; var3 += 16)
        {
