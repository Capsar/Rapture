...
public class Explosion
{
    ...
    public void doExplosionA()
    {
        ...
        var4 = MathHelper.floor_double(this.explosionX - var30 - 1.0D);
        var5 = MathHelper.floor_double(this.explosionX + var30 + 1.0D);
        int var31 = MathHelper.floor_double(this.explosionY - var30 - 1.0D);
        int var7 = MathHelper.floor_double(this.explosionY + var30 + 1.0D);
        int var32 = MathHelper.floor_double(this.explosionZ - var30 - 1.0D);
        int var9 = MathHelper.floor_double(this.explosionZ + var30 + 1.0D);
        ...
        for (int var34 = 0; var34 < var33.size(); ++var34)
        {
            ...
            {
                double var35 = var13.getDistance(this.explosionX, this.explosionY, this.explosionZ) / var30;

                if (var35 <= 1.0D)
                {
                    double var16 = var13.posX - this.explosionX;
                    double var18 = var13.posY + var13.getEyeHeight() - this.explosionY;
                    ...
                    if (var36 != 0.0D)
                    {
                        ...
                        {
                            this.field_77288_k.put(var13, new Vec3(var16 * var26, var18 * var26, var20 * var26));
                        }
                    }
                }
            }
    ...
    public void doExplosionB(boolean spawnParticles)
    {
        ...
        if (this.isSmoking)
        {
            ...
            while (var2.hasNext())
            {
                ...
                if (spawnParticles)
                {
                    double var5 = var3.getX() + this.worldObj.rand.nextFloat();
                    double var7 = var3.getY() + this.worldObj.rand.nextFloat();
                    double var9 = var3.getZ() + this.worldObj.rand.nextFloat();
                    ...
                    var13 /= var17;
                    var15 /= var17;
                    double var19 = 0.5D / (var17 / this.explosionSize + 0.1D);
                    var19 *= this.worldObj.rand.nextFloat() * this.worldObj.rand.nextFloat() + 0.3F;
                    var11 *= var19;
                    var13 *= var19;
                    var15 *= var19;
