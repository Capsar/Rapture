...
public abstract class CommandBase implements ICommand
{
    ...
    public static BlockPos parseBlockPos(ICommandSender sender, String[] args, int startIndex, boolean centerBlock) throws NumberInvalidException
    {
        ...
        return new BlockPos(parseDouble(var4.getX(), args[startIndex], -30000000, 30000000, centerBlock), parseDouble(var4.getY(), args[startIndex + 1], 0, 256, false), parseDouble(var4.getZ(), args[startIndex + 2], -30000000, 30000000, centerBlock));
    }
    ...
    public static EntityPlayerMP getPlayer(ICommandSender sender, String username) throws PlayerNotFoundException
    {
        ...
        if (var2 == null)
        {
            try
            {
                var2 = MinecraftServer.getServer().getConfigurationManager().getPlayerByUUID(UUID.fromString(username));
            }
    ...
    public static Entity getEntity(ICommandSender commandSender, String p_175759_1_, Class p_175759_2_) throws EntityNotFoundException
    {
        Object var3 = PlayerSelector.matchOneEntity(commandSender, p_175759_1_, p_175759_2_);
        ...
        if (var3 == null)
        {
            try
            {
                ...
                if (var3 == null)
                {
                    var3 = var4.getConfigurationManager().getPlayerByUUID(var5);
                }
            }
    ...
    {
        return PlayerSelector.hasArguments(p_175763_1_) ? PlayerSelector.matchEntities(p_175763_0_, p_175763_1_, Entity.class) : Lists.newArrayList(new Entity[] {func_175768_b(p_175763_0_, p_175763_1_)});
    }
    ...
    public static IChatComponent getChatComponentFromNthArg(ICommandSender sender, String[] args, int index, boolean p_147176_3_) throws PlayerNotFoundException
    {
        ...
        for (int var5 = index; var5 < args.length; ++var5)
        {
            ...
            if (p_147176_3_)
            {
                IChatComponent var7 = PlayerSelector.matchEntitiesToChatComponent(sender, args[var5]);
    ...
    public static String buildString(String[] args, int startPos)
    {
        ...
        for (int var3 = startPos; var3 < args.length; ++var3)
        {
            if (var3 > startPos)
            {
                var2.append(" ");
    ...
    public static List getListOfStringsMatchingLastWord(String[] p_175762_0_, Collection p_175762_1_)
    {
