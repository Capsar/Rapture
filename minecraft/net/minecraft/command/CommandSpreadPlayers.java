...
public class CommandSpreadPlayers extends CommandBase
{
	...
	public void processCommand(ICommandSender sender, String[] args) throws CommandException
    {
        ...
        else
        {
            ...
            int var17 = var3 + 1;
            double var5 = parseDouble(var10000, args[var3], true);
            double var7 = parseDouble(var4.getZ(), args[var17++], true);
            ...
            while (var17 < args.length)
            {
                ...
                {
                    List var16 = PlayerSelector.matchEntities(sender, var15, Entity.class);
            ...
            sender.setCommandStat(CommandResultStats.Type.AFFECTED_ENTITIES, var14.size());
    ...
    private double func_110671_a(List p_110671_1_, World worldIn, CommandSpreadPlayers.Position[] p_110671_3_, boolean p_110671_4_)
    {
        ...
        for (int var9 = 0; var9 < p_110671_1_.size(); ++var9)
        {
            ...
            var10.setPositionAndUpdate(MathHelper.floor_double(var11.field_111101_a) + 0.5F, var11.func_111092_a(worldIn), MathHelper.floor_double(var11.field_111100_b) + 0.5D);
