	...
	public void processCommand(ICommandSender sender, String[] args) throws CommandException
    {
        ...
        else
        {
            ...
            else
            {
                ...
                double var32 = ((float)parseDouble(var31.xCoord, args[1], true));
                double var9 = ((float)parseDouble(var31.yCoord, args[2], true));
                double var11 = ((float)parseDouble(var31.zCoord, args[3], true));
