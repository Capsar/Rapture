...
public class PlayerSelector
{
    ...
    private static List func_179648_b(Map p_179648_0_)
    {
        ...
        final int var2 = parseIntWithDefault(p_179648_0_, "lm", -1);
        final int var3 = parseIntWithDefault(p_179648_0_, "l", -1);
    ...
    {
        ArrayList var1 = Lists.newArrayList();
        final int var2 = parseIntWithDefault(p_179649_0_, "m", WorldSettings.GameType.NOT_SET.getID());
    ...
    {
        ArrayList var2 = Lists.newArrayList();
        final int var3 = parseIntWithDefault(p_180698_0_, "rm", -1);
        final int var4 = parseIntWithDefault(p_180698_0_, "r", -1);
    ...
    private static List func_179662_g(Map p_179662_0_)
    {
        ...
        {
            final int var2 = func_179650_a(parseIntWithDefault(p_179662_0_, "rym", 0));
            final int var3 = func_179650_a(parseIntWithDefault(p_179662_0_, "ry", 359));
            var1.add(new Predicate()
            {
        ...
        {
            final int var2 = func_179650_a(parseIntWithDefault(p_179662_0_, "rxm", 0));
            final int var3 = func_179650_a(parseIntWithDefault(p_179662_0_, "rx", 359));
            var1.add(new Predicate()
            {
    ...
    private static List filterResults(Map params, Class entityClass, List inputList, String type, World worldIn, BlockPos position)
    {
        ...
        int var10 = parseIntWithDefault(params, "dx", 0);
        int var11 = parseIntWithDefault(params, "dy", 0);
        int var12 = parseIntWithDefault(params, "dz", 0);
        int var13 = parseIntWithDefault(params, "r", -1);
        ...
        if (position != null)
        {
            ...
            if (!params.containsKey("dx") && !params.containsKey("dy") && !params.containsKey("dz"))
            {
                if (var13 >= 0)
                {
                    var19 = new AxisAlignedBB((double)(position.getX() - var13), (double)(position.getY() - var13), (double)(position.getZ() - var13), (double)(position.getX() + var13 + 1), (double)(position.getY() + var13 + 1), (double)(position.getZ() + var13 + 1));
    ...
    {
        int var6 = parseIntWithDefault(p_179658_1_, "c", !p_179658_4_.equals("a") && !p_179658_4_.equals("e") ? 1 : 0);
    ...
    private static Map getArgumentMap(String argumentString)
    {
        ...
        else
        {
            ...
            for (Matcher var4 = intListPattern.matcher(argumentString); var4.find(); var3 = var4.end())
            {
                String var5 = null;
            ...
            if (var3 < argumentString.length())
            {
                Matcher var6 = keyValueListPattern.matcher(var3 == -1 ? argumentString : argumentString.substring(var3));
