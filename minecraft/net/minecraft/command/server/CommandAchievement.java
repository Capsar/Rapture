                ...
                if (var5 || var6)
                {
                    if (var3 == null)
                    {
                        ...
                        if (var5)
                        {
                            ...
                            notifyOperators(sender, this, "commands.achievement.give.success.all", new Object[] {var4.getCommandSenderName()});
                        }
                        else if (var6)
                        {
                            ...
                            notifyOperators(sender, this, "commands.achievement.take.success.all", new Object[] {var4.getCommandSenderName()});
                        }
                    }
                    else
                    {
                        if (var3 instanceof Achievement)
                        {
                            ...
                            if (var5)
                            {
                                ...
                                {
                                    throw new CommandException("commands.achievement.alreadyHave", new Object[] {var4.getCommandSenderName(), var3.func_150955_j()});
                                }
                            ...
                            else if (var6)
                            {
                                if (!var4.getStatFile().hasAchievementUnlocked(var7))
                                {
                                    throw new CommandException("commands.achievement.dontHave", new Object[] {var4.getCommandSenderName(), var3.func_150955_j()});
                                }
                        ...
                        if (var5)
                        {
                            ...
                            notifyOperators(sender, this, "commands.achievement.give.success.one", new Object[] {var4.getCommandSenderName(), var3.func_150955_j()});
                        }
                        else if (var6)
                        {
                            var4.func_175145_a(var3);
                            notifyOperators(sender, this, "commands.achievement.take.success.one", new Object[] {var3.func_150955_j(), var4.getCommandSenderName()});
                        }
                    }
                }
            }
