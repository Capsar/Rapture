    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException
    {
        ...
        else
        {
            ...
            if (args.length != 1 && args.length != 2)
            {
                ...
                {
                    int var14 = var3 + 1;
                    CommandBase.CoordinateArg var6 = parseCoordinate(((Entity)var4).posX, args[var3], true);
                    CommandBase.CoordinateArg var7 = parseCoordinate(((Entity)var4).posY, args[var14++], 0, 0, false);
                    CommandBase.CoordinateArg var8 = parseCoordinate(((Entity)var4).posZ, args[var14++], true);
                    CommandBase.CoordinateArg var9 = parseCoordinate((double)((Entity)var4).rotationYaw, args.length > var14 ? args[var14++] : "~", false);
                    CommandBase.CoordinateArg var10 = parseCoordinate((double)((Entity)var4).rotationPitch, args.length > var14 ? args[var14] : "~", false);
                    float var12;
                    ...
                    if (var4 instanceof EntityPlayerMP)
                    {
                        ...
                        ((EntityPlayerMP)var4).playerNetServerHandler.setPlayerLocation(var6.func_179629_b(), var7.func_179629_b(), var8.func_179629_b(), var12, var13, var11);
                    ...
                    notifyOperators(sender, this, "commands.tp.success.coordinates", new Object[] {((Entity)var4).getCommandSenderName(), Double.valueOf(var6.func_179628_a()), Double.valueOf(var7.func_179628_a()), Double.valueOf(var8.func_179628_a())});
                }
            }
            else
            {
                ...
                else
                {
                    ...
                    notifyOperators(sender, this, "commands.tp.success", new Object[] {((Entity)var4).getCommandSenderName(), var5.getCommandSenderName()});
                }
            }
        }
    }
