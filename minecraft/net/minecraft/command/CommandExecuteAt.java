...
public class CommandExecuteAt extends CommandBase
{
	...
	public void processCommand(final ICommandSender sender, String[] args) throws CommandException
    {
        ...
        else
        {
            ...
            final double var4 = parseDouble(var3.posX, args[1], false);
            final double var6 = parseDouble(var3.posY, args[2], false);
            final double var8 = parseDouble(var3.posZ, args[3], false);
            ...
            if ("detect".equals(args[4]) && args.length > 10)
            {
                ...
                double var13 = parseDouble(var4, args[5], false);
                double var15 = parseDouble(var6, args[6], false);
                double var17 = parseDouble(var8, args[7], false);
