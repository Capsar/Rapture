...
public class CommandClone extends CommandBase
{
	...
	public void processCommand(ICommandSender sender, String[] args) throws CommandException
    {
        ...
        else
        {
            ...
            BlockPos var4 = parseBlockPos(sender, args, 3, false);
            BlockPos var5 = parseBlockPos(sender, args, 6, false);
                    ...
                    if (var6.minY >= 0 && var6.maxY < 256 && var7.minY >= 0 && var7.maxY < 256)
                    {
                        ...
                        if (var12.isAreaLoaded(var6) && var12.isAreaLoaded(var7))
                        {
                            ...
                            while (var32.hasNext())
                            {
                                ...
                                if (var12.setBlockState(var34.field_179537_a, var34.blockState, 2))
                                {
                                    ++var8;
                                }
                            }

                            for (var32 = var15.iterator(); var32.hasNext(); var12.setBlockState(var34.field_179537_a, var34.blockState, 2))
                            {
                                var34 = (CommandClone.StaticCloneData)var32.next();
                                var36 = var12.getTileEntity(var34.field_179537_a);
                            ...
                            {
                                var34 = (CommandClone.StaticCloneData)var32.next();
                                var12.notifyNeighborsRespectDebug(var34.field_179537_a, var34.blockState.getBlock());
                            }
                            ...
                            if (var33 != null)
                            {
                                ...
                                while (var35.hasNext())
                                {
                                    ...
                                    {
                                        BlockPos var38 = var37.position.add(var18);
                                        var12.scheduleBlockUpdate(var38, var37.getBlock(), (int)(var37.scheduledTime - var12.getWorldInfo().getWorldTotalTime()), var37.priority);
                                    }
                                }
                            }
                            ...
                            {
                                sender.setCommandStat(CommandResultStats.Type.AFFECTED_BLOCKS, var8);
