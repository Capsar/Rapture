	...
	public void processCommand(ICommandSender sender, String[] args) throws CommandException
    {
        ...
        else
        {
            ...
            else if (args[0].equals("center"))
            {
                ...
                double var5 = parseDouble(var10.getX() + 0.5D, args[1], true);
                double var7 = parseDouble(var10.getZ() + 0.5D, args[2], true);
            ...
            {
                var4 = var3.getDiameter();
                sender.setCommandStat(CommandResultStats.Type.QUERY_RESULT, MathHelper.floor_double(var4 + 0.5D));
