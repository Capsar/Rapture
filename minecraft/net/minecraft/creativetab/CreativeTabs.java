    ...
    public void addEnchantmentBooksToList(List itemList, EnumEnchantmentType ... enchantmentType)
    {
        ...
        for (int var5 = 0; var5 < var4; ++var5)
        {
            ...
            if (var6 != null && var6.type != null)
            {
                ...
                for (int var8 = 0; var8 < enchantmentType.length && !var7; ++var8)
                {
                    if (var6.type == enchantmentType[var8])
                    {
                        var7 = true;
                    }
                }
                ...
                if (var7)
                {
                    itemList.add(Items.enchanted_book.getEnchantedItemStack(new EnchantmentData(var6, var6.getMaxLevel())));
                }
            }
        }
    }
