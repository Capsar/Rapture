...
public class ServerStatusResponse
{
    ...
    public static class MinecraftProtocolVersionIdentifier
    {
        ...
        public static class Serializer implements JsonDeserializer, JsonSerializer
        {
            ...
            {
                JsonObject var4 = JsonUtils.getJsonObject(p_deserialize_1_, "version");
            ...
            public Object deserializeNotUsed(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_)
            {
    ...
    public static class PlayerCountData
    {
        ...
        public static class Serializer implements JsonDeserializer, JsonSerializer
        {
            ...
            {
                JsonObject var4 = JsonUtils.getJsonObject(p_deserialize_1_, "players");
    ...
    public static class Serializer implements JsonDeserializer, JsonSerializer
    {
        ...
        {
            JsonObject var4 = JsonUtils.getJsonObject(p_deserialize_1_, "status");
