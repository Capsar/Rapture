...
public class Village
{
    ...
    public VillageDoorInfo getNearestDoor(BlockPos p_179865_1_)
    {
        ...
        while (var4.hasNext())
        {
            ...
            int var6 = var5.getDistanceToDoorBlockSq(p_179865_1_);
    ...
    public VillageDoorInfo func_179863_c(BlockPos p_179863_1_)
    {
        ...
        {
            VillageDoorInfo var5 = (VillageDoorInfo)var4.next();
            int var6 = var5.getDistanceToDoorBlockSq(p_179863_1_);
    ...
    public EntityPlayer getNearestTargetPlayer(EntityLivingBase villageDefender)
    {
        ...
        while (var5.hasNext())
        {
            ...
            if (this.isPlayerReputationTooLow(var6))
            {
                ...
                if (var7 != null)
                {
                    double var8 = var7.getDistanceSqToEntity(villageDefender);
    ...
    private void removeDeadAndOutOfRangeDoors()
    {
        ...
        while (var3.hasNext())
        {
            ...
            {
                this.centerHelper = this.centerHelper.add(var4.getDoorBlockPos().multiply(-1));
                var1 = true;
    ...
    private void updateVillageRadiusAndCenter()
    {
        ...
        else
        {
            ...
            for (Iterator var3 = this.villageDoorInfoList.iterator(); var3.hasNext(); var2 = Math.max(var4.getDistanceToDoorBlockSq(this.center), var2))
            {
