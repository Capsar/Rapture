...
public abstract class EntityLiving extends EntityLivingBase
{
    ...
    public void writeEntityToNBT(NBTTagCompound tagCompound)
    {
        ...
        if (this.leashedToEntity != null)
        {
            ...
            {
                BlockPos var7 = ((EntityHanging)this.leashedToEntity).getHangingPosition();
    ...
    protected void updateEquipmentIfNeeded(EntityItem itemEntity)
    {
        ...
        if (var3 > -1)
        {
            ...
            if (var5 != null)
            {
                if (var3 == 0)
                {
                    ...
                    else if (var2.getItem() instanceof ItemSword && var5.getItem() instanceof ItemSword)
                    {
                        ...
                        if (var9.getDamageVsEntity() == var10.getDamageVsEntity())
                        {
                            var4 = var2.getMetadata() > var5.getMetadata() || var2.hasTagCompound() && !var5.hasTagCompound();
                        }
                        else
                        {
                            var4 = var9.getDamageVsEntity() > var10.getDamageVsEntity();
                        }
                    }
            ...
            if (var4 && this.func_175448_a(var2))
            {
                ...
                if (var2.getItem() == Items.diamond && itemEntity.getThrower() != null)
                {
                    EntityPlayer var92 = this.worldObj.getPlayerEntityByName(itemEntity.getThrower());
    ...
    {
        double var4 = entityIn.posX - this.posX;
        double var8 = entityIn.posZ - this.posZ;
        double var6;
        ...
        {
            var6 = (entityIn.getEntityBoundingBox().minY + entityIn.getEntityBoundingBox().maxY) / 2.0D - (this.posY + (double)this.getEyeHeight());
        }
    ...
    {
        float var2 = difficulty.getClampedAdditionalDifficulty();
    ...
    public void setEquipmentDropChance(int p_96120_1_, float chance)
    {
        this.equipmentDropChances[p_96120_1_] = chance;
    }
    ...
    public boolean replaceItemInInventory(int inventorySlot, ItemStack itemStackIn)
    {
        ...
        if (itemStackIn != null && getArmorPosition(itemStackIn) != var3 && (var3 != 4 || !(itemStackIn.getItem() instanceof ItemBlock)))
        {
            return false;
        }
        else
     ...
     */
    protected void setNoAI(boolean disable)
    {
    ...
    public static enum SpawnPlacementType
    {
        ...
        private SpawnPlacementType(String p_i46433_1_, int p_i46433_2_, String p_i45893_1_, int p_i45893_2_) {}
    }
}
