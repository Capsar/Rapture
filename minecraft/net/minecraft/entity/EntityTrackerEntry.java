...
public class EntityTrackerEntry
{
    ...
    public void updatePlayerList(List p_73122_1_)
    {
        ...
        if (this.updateCounter % this.updateFrequency == 0 || this.trackedEntity.isAirBorne || this.trackedEntity.getDataWatcher().hasObjectChanged())
        {
            ...
            if (this.trackedEntity.ridingEntity == null)
            {
                ...
                {
                    if (var29 >= -128 && var29 < 128 && var30 >= -128 && var30 < 128 && var9 >= -128 && var9 < 128 && this.ticksSinceLastForcedTeleport <= 400 && !this.ridingEntity && this.onGround == this.trackedEntity.onGround)
                    {
                        if (var11 && var12)
                        {
            ...
            else
            {
                ...
                if (var26)
                {
                    this.sendPacketToTrackedPlayers(new S14PacketEntity.S16PacketEntityLook(this.trackedEntity.getEntityId(), (byte)var23, (byte)var24, this.trackedEntity.onGround));
            ...
            {
                this.sendPacketToTrackedPlayers(new S19PacketEntityHeadLook(this.trackedEntity, (byte)var23));
    ...
    public void sendPacketToTrackedPlayers(Packet packetIn)
    {
        ...
        while (var2.hasNext())
        {
            ...
            var3.playerNetServerHandler.sendPacket(packetIn);
        }
    }
    ...
    {
        double var2 = p_180233_1_.posX - this.encodedPosX / 32;
        double var4 = p_180233_1_.posZ - this.encodedPosZ / 32;
        return var2 >= (-this.trackingDistanceThreshold) && var2 <= this.trackingDistanceThreshold && var4 >= (-this.trackingDistanceThreshold) && var4 <= this.trackingDistanceThreshold && this.trackedEntity.isSpectatedByPlayer(p_180233_1_);
    }
    ...
    private Packet func_151260_c()
    {
        ...
        else
        {
            ...
            if (this.trackedEntity instanceof EntityFireball)
            {
                ...
                var2.setSpeedX((int)(var6.accelerationX * 8000.0D));
                var2.setSpeedY((int)(var6.accelerationY * 8000.0D));
                var2.setSpeedZ((int)(var6.accelerationZ * 8000.0D));
                return var2;
            }
            ...
            else
            {
                ...
                if (this.trackedEntity instanceof EntityItemFrame)
                {
                    ...
                    var2 = new S0EPacketSpawnObject(this.trackedEntity, 71, var4.facingDirection.getHorizontalIndex());
                    var3 = var4.getHangingPosition();
