...
public class EntityHorse extends EntityAnimal implements IInvBasic
{
    private static final Predicate horseBreedingSelector = new Predicate()
    {
        ...
        public boolean isEntityApplicable(Entity p_179873_1_)
        {
            return p_179873_1_ instanceof EntityHorse && ((EntityHorse)p_179873_1_).isBreeding();
        }
        public boolean apply(Object p_apply_1_)
        {
            return this.isEntityApplicable((Entity)p_apply_1_);
        }
    };
    ...
    public EntityAgeable createChild(EntityAgeable ageable)
    {
        ...
        double var13 = this.getEntityAttribute(SharedMonsterAttributes.maxHealth).getBaseValue() + ageable.getEntityAttribute(SharedMonsterAttributes.maxHealth).getBaseValue() + (double)this.getModifiedMaxHealth();
