...
public class EntityWolf extends EntityTameable
{
    ...
    {
        boolean var2 = entityIn.attackEntityFrom(DamageSource.causeMobDamage(this), ((int)this.getEntityAttribute(SharedMonsterAttributes.attackDamage).getAttributeValue()));
	...
	public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        {
            EntityWolf var2 = (EntityWolf)otherAnimal;
	...
	public boolean func_142018_a(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_)
    {
        if (!(p_142018_1_ instanceof EntityCreeper) && !(p_142018_1_ instanceof EntityGhast))
        {
            if (p_142018_1_ instanceof EntityWolf)
            {
                ...
                if (var3.isTamed() && var3.getOwnerEntity() == p_142018_2_)
                {
                    return false;
                }
            }
