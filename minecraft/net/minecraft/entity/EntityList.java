...
public class EntityList
{
     ...
     */
    private static void addMapping(Class entityClass, String entityName, int id)
    {
     ...
     */
    private static void addMapping(Class entityClass, String entityName, int entityID, int baseColor, int spotColor)
    {
    ...
    public static Entity createEntityFromNBT(NBTTagCompound nbt, World worldIn)
    {
        ...
        try
        {
            Class var3 = (Class)stringToClassMapping.get(nbt.getString("id"));
    ...
    {
        Integer var1 = (Integer)classToIDMapping.get(entityIn.getClass());
    ...
    {
        Integer var1 = (Integer)stringToIDMapping.get(entityName);
    ...
    {
        String var2 = getEntityString(entityIn);

        if (var2 == null && entityIn instanceof EntityPlayer)
        {
            var2 = "Player";
        }
        else if (var2 == null && entityIn instanceof EntityLightningBolt)
        {
            var2 = "LightningBolt";
        }

        return entityName.equals(var2);
    }
