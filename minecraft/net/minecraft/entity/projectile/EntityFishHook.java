                    ...
                    else
                    {
                        ...
                        if (this.ticksCatchableDelay > 0)
                        {
                            ...
                            if (this.ticksCatchableDelay <= 0)
                            {
                                ...
                                var36.spawnParticle(EnumParticleTypes.WATER_BUBBLE, this.posX, (double)(var16 + 1.0F), this.posZ, (int)(1.0F + this.width * 20.0F), (double)this.width, 0.0D, (double)this.width, 0.20000000298023224D, new int[0]);
                                var36.spawnParticle(EnumParticleTypes.WATER_WAKE, this.posX, (double)(var16 + 1.0F), this.posZ, (int)(1.0F + this.width * 20.0F), (double)this.width, 0.0D, (double)this.width, 0.20000000298023224D, new int[0]);
                            ...
                            else
                            {
                                ...
                                {
                                    var36.spawnParticle(EnumParticleTypes.WATER_BUBBLE, var19, var40 - 0.10000000149011612D, var23, 1, (double)var39, 0.1D, (double)var18, 0.0D, new int[0]);
                                }

                                float var25 = var39 * 0.04F;
                                float var26 = var18 * 0.04F;
                                var36.spawnParticle(EnumParticleTypes.WATER_WAKE, var19, var40, var23, 0, (double)var26, 0.01D, (double)(-var25), 1.0D, new int[0]);
                                var36.spawnParticle(EnumParticleTypes.WATER_WAKE, var19, var40, var23, 0, (double)(-var26), 0.01D, (double)var25, 1.0D, new int[0]);
                            }
                        }
