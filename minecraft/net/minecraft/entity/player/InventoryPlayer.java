...
public class InventoryPlayer implements IInventory
{
    ...
    private int getInventorySlotContainItemAndDamage(Item itemIn, int p_146024_2_)
    {
        ...
        {
            if (this.mainInventory[var3] != null && this.mainInventory[var3].getItem() == itemIn && this.mainInventory[var3].getMetadata() == p_146024_2_)
            {
                return var3;
            }
        }
    ...
    private int storeItemStack(ItemStack itemStackIn)
    {
        for (int var2 = 0; var2 < this.mainInventory.length; ++var2)
        {
            if (this.mainInventory[var2] != null && this.mainInventory[var2].getItem() == itemStackIn.getItem() && this.mainInventory[var2].isStackable() && this.mainInventory[var2].stackSize < this.mainInventory[var2].getMaxStackSize() && this.mainInventory[var2].stackSize < this.getInventoryStackLimit() && (!this.mainInventory[var2].getHasSubtypes() || this.mainInventory[var2].getMetadata() == itemStackIn.getMetadata()) && ItemStack.areItemStackTagsEqual(this.mainInventory[var2], itemStackIn))
            {
                return var2;
            }
        }
    ...
    public void setCurrentItem(Item itemIn, int p_146030_2_, boolean p_146030_3_, boolean p_146030_4_)
    {
        ...
        int var6 = p_146030_3_ ? this.getInventorySlotContainItemAndDamage(itemIn, p_146030_2_) : this.getInventorySlotContainItem(itemIn);
        ...
        else if (p_146030_4_ && itemIn != null)
        {
            ...
            {
                int var8 = this.getInventorySlotContainItemAndDamage(itemIn, p_146030_2_);
                int var9;
                ...
                this.mainInventory[this.currentItem] = new ItemStack(itemIn, var9, p_146030_2_);
            }
        }
    }
    ...
    public int func_174925_a(Item itemIn, int p_174925_2_, int p_174925_3_, NBTTagCompound p_174925_4_)
    {
        int var5 = 0;
        int var6;
        ItemStack var7;
        ...
        for (var6 = 0; var6 < this.mainInventory.length; ++var6)
        {
            ...
            if (var7 != null && (itemIn == null || var7.getItem() == itemIn) && (p_174925_2_ <= -1 || var7.getMetadata() == p_174925_2_) && (p_174925_4_ == null || CommandTestForBlock.func_175775_a(p_174925_4_, var7.getTagCompound(), true)))
            {
        ...
        for (var6 = 0; var6 < this.armorInventory.length; ++var6)
        {
            ...
            if (var7 != null && (itemIn == null || var7.getItem() == itemIn) && (p_174925_2_ <= -1 || var7.getMetadata() == p_174925_2_) && (p_174925_4_ == null || CommandTestForBlock.func_175775_a(p_174925_4_, var7.getTagCompound(), false)))
            {
                var8 = p_174925_3_ <= 0 ? var7.stackSize : Math.min(p_174925_3_ - var5, var7.stackSize);
                var5 += var8;
    ...
    private int storePartialItemStack(ItemStack itemStackIn)
    {
        ...
        int var3 = itemStackIn.stackSize;
        int var4 = this.storeItemStack(itemStackIn);
        ...
        else
        {
            ...
            {
                this.mainInventory[var4] = new ItemStack(var2, 0, itemStackIn.getMetadata());

                if (itemStackIn.hasTagCompound())
                {
                    this.mainInventory[var4].setTagCompound((NBTTagCompound)itemStackIn.getTagCompound().copy());
                }
            }
    ...
    {
        int var2 = this.getInventorySlotContainItem(itemIn);
        ...
        if (itemStackIn != null && itemStackIn.stackSize != 0 && itemStackIn.getItem() != null)
        {
            try
            {
                ...
                if (itemStackIn.isItemDamaged())
                {
                    ...
                    if (var2 >= 0)
                    {
                        this.mainInventory[var2] = ItemStack.copyItemStack(itemStackIn);
                ...
                else
                {
                    do
                    {
                        var2 = itemStackIn.stackSize;
                        itemStackIn.stackSize = this.storePartialItemStack(itemStackIn);
                    }
                    while (itemStackIn.stackSize > 0 && itemStackIn.stackSize < var2);

                    if (itemStackIn.stackSize == var2 && this.player.capabilities.isCreativeMode)
                    {
                        itemStackIn.stackSize = 0;
                        return true;
                    }
                    ...
                    {
                        return itemStackIn.stackSize < var2;
                    }
                }
            }
            catch (Throwable var5)
            {
                ...
                var4.addCrashSection("Item ID", Integer.valueOf(Item.getIdFromItem(itemStackIn.getItem())));
                var4.addCrashSection("Item data", Integer.valueOf(itemStackIn.getMetadata()));
    ...
    public float getStrVsBlock(Block blockIn)
    {
        ...
        {
            var2 *= this.mainInventory[this.currentItem].getStrVsBlock(blockIn);
        }
    ...
    public void damageArmor(float damage)
    {
        ...
        for (int var2 = 0; var2 < this.armorInventory.length; ++var2)
        {
            if (this.armorInventory[var2] != null && this.armorInventory[var2].getItem() instanceof ItemArmor)
            {
                this.armorInventory[var2].damageItem((int)damage, this.player);
    ...
    public boolean hasItemStack(ItemStack itemStackIn)
    {
        ...
        for (var2 = 0; var2 < this.armorInventory.length; ++var2)
        {
            if (this.armorInventory[var2] != null && this.armorInventory[var2].isItemEqual(itemStackIn))
            {
                return true;
            }
        }
        ...
        for (var2 = 0; var2 < this.mainInventory.length; ++var2)
        {
            if (this.mainInventory[var2] != null && this.mainInventory[var2].isItemEqual(itemStackIn))
            {
                return true;
            }
        }
    ...
    public void copyInventory(InventoryPlayer playerInventory)
    {
        ...
        for (var2 = 0; var2 < this.mainInventory.length; ++var2)
        {
            this.mainInventory[var2] = ItemStack.copyItemStack(playerInventory.mainInventory[var2]);
        }

        for (var2 = 0; var2 < this.armorInventory.length; ++var2)
        {
            this.armorInventory[var2] = ItemStack.copyItemStack(playerInventory.armorInventory[var2]);
        }
