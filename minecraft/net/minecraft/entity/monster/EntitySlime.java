...
public class EntitySlime extends EntityLiving implements IMob
{
    ...
    protected void func_175451_e(EntityLivingBase p_175451_1_)
    {
        ...
        if (this.canEntityBeSeen(p_175451_1_) && this.getDistanceSqToEntity(p_175451_1_) < 0.6D * var2 * 0.6D * var2 && p_175451_1_.attackEntityFrom(DamageSource.causeMobDamage(this), this.getAttackStrength()))
        {
	...
	public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata)
    {
        ...
        if (var3 < 2 && this.rand.nextFloat() < 0.5F * difficulty.getClampedAdditionalDifficulty())
        {
            ++var3;
        }
    ...
    {
        private EntitySlime slime = EntitySlime.this;
