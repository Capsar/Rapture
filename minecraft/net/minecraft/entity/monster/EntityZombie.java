...
public class EntityZombie extends EntityMob
{
	...
	public boolean attackEntityFrom(DamageSource source, float amount)
    {
        if (super.attackEntityFrom(source, amount))
        {
            ...
            if (var3 != null && this.worldObj.getDifficulty() == EnumDifficulty.HARD && this.rand.nextFloat() < this.getEntityAttribute(reinforcementChance).getAttributeValue())
            {
                ...
                for (int var8 = 0; var8 < 50; ++var8)
                {
                    ...
                    if (World.doesBlockHaveSolidTopSurface(this.worldObj, new BlockPos(var9, var10 - 1, var11)) && this.worldObj.getLightFromNeighbors(new BlockPos(var9, var10, var11)) < 10)
                    {
                        ...
                        if (!this.worldObj.isAnyPlayerWithinRangeAt(var9, var10, var11, 7.0D) && this.worldObj.checkNoEntityCollision(var7.getEntityBoundingBox(), var7) && this.worldObj.getCollidingBoundingBoxes(var7, var7.getEntityBoundingBox()).isEmpty() && !this.worldObj.isAnyLiquid(var7.getEntityBoundingBox()))
                        {
    ...
    {
        boolean var2 = super.attackEntityAsMob(entityIn);
	...
	public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata)
    {
        ...
        float var3 = difficulty.getClampedAdditionalDifficulty();
        this.setCanPickUpLoot(this.rand.nextFloat() < 0.55F * var3);

        if (livingdata1 == null)
        {
            livingdata1 = new EntityZombie.GroupData(this.worldObj.rand.nextFloat() < 0.05F, this.worldObj.rand.nextFloat() < 0.05F, null);
        }

        if (livingdata1 instanceof EntityZombie.GroupData)
        {
            EntityZombie.GroupData var4 = (EntityZombie.GroupData)livingdata1;
            ...
            if (var4.isChild)
            {
                ...
                {
                    List var5 = this.worldObj.getEntitiesWithinAABB(EntityChicken.class, this.getEntityBoundingBox().expand(5.0D, 3.0D, 5.0D), IEntitySelector.IS_STANDALONE);
                ...
                else if (this.worldObj.rand.nextFloat() < 0.05D)
                {
                    ...
                    var10.onInitialSpawn(difficulty, (IEntityLivingData)null);
    ...
    {
        ItemStack var2 = player.getCurrentEquippedItem();
