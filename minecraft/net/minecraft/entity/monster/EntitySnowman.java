	...
	public void onLivingUpdate()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            for (int var4 = 0; var4 < 4; ++var4)
            {
                ...
                if (this.worldObj.getBlockState(new BlockPos(var1, var2, var3)).getBlock().getMaterial() == Material.air && this.worldObj.getBiomeGenForCoords(new BlockPos(var1, 0, var3)).getFloatTemperature(new BlockPos(var1, var2, var3)) < 0.8F && Blocks.snow_layer.canPlaceBlockAt(this.worldObj, new BlockPos(var1, var2, var3)))
                {
