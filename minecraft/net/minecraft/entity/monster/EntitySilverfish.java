...
public class EntitySilverfish extends EntityMob
{
    ...
    public EntitySilverfish(World worldIn)
    {
        ...
        this.tasks.addTask(3, this.summonSilverfish = new EntitySilverfish.AISummonSilverfish());
        ...
        public boolean shouldExecute()
        {
            ...
            else
            {
                ...
                if (var1.nextInt(10) == 0)
                {
                    ...
                    BlockPos var2 = (new BlockPos(EntitySilverfish.this.posX, EntitySilverfish.this.posY + 0.5D, EntitySilverfish.this.posZ)).offset(this.facing);
    ...
    {
        private EntitySilverfish silverfish = EntitySilverfish.this;
