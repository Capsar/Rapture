...
public class EntityEnderman extends EntityMob
{
    ...
    public EntityEnderman(World worldIn)
    {
        ...
        this.targetTasks.addTask(3, new EntityAINearestAttackableTarget(this, EntityEndermite.class, 10, true, false, new Predicate()
        {
            ...
            public boolean func_179948_a(EntityEndermite endermite)
            {
    ...
    private boolean shouldAttackPlayer(EntityPlayer player)
    {
        ...
        else
        {
            ...
            Vec3 var4 = new Vec3(this.posX - player.posX, this.getEntityBoundingBox().minY + (double)(this.height / 2.0F) - (player.posY + (double)player.getEyeHeight()), this.posZ - player.posZ);
    ...
    class AIFindPlayer extends EntityAINearestAttackableTarget
    {
        ...
        private EntityEnderman enderman = EntityEnderman.this;
