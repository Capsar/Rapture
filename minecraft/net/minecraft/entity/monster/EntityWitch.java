...
public class EntityWitch extends EntityMob implements IRangedAttackMob
{
    ...
    private static final AttributeModifier MODIFIER = (new AttributeModifier(field_110184_bp, "Drinking speed penalty", -0.25D, 0)).setSaved(false);
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            else
            {
                ...
                if (var5 > -1)
                {
                    ...
                    var6.removeModifier(MODIFIER);
                    var6.applyModifier(MODIFIER);
                }
            }
