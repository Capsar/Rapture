...
public class EntityWither extends EntityMob implements IBossDisplayData, IRangedAttackMob
{
        ...
        else
        {
            ...
            for (var1 = 1; var1 < 3; ++var1)
            {
                if (this.ticksExisted >= this.field_82223_h[var1 - 1])
                {
                    ...
                    {
                        List var13 = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class, this.getEntityBoundingBox().expand(20.0D, 8.0D, 20.0D), Predicates.and(attackEntitySelector, IEntitySelector.NOT_SPECTATING));
    ...
    private double func_82214_u(int p_82214_1_)
    {
        ...
        {
            float var2 = (this.renderYawOffset + 180 * (p_82214_1_ - 1)) / 180.0F * (float)Math.PI;
    ...
    private double func_82213_w(int p_82213_1_)
    {
        ...
        {
            float var2 = (this.renderYawOffset + 180 * (p_82213_1_ - 1)) / 180.0F * (float)Math.PI;
    ...
    private void launchWitherSkullToCoords(int p_82209_1_, double x, double y, double z, boolean invulnerable)
    {
        ...
        double var15 = x - var9;
        double var17 = y - var11;
        double var19 = z - var13;
