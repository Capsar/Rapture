        ...
        this.field_179435_c = new Predicate()
        {
            ...
            public boolean func_179880_a(Entity p_179880_1_)
            {
                ...
                else
                {
                    ...
                    return p_179880_1_.getDistanceToEntity(EntityAIFindEntityNearestPlayer.this.field_179434_b) > var2 ? false : EntityAITarget.isSuitableTarget(EntityAIFindEntityNearestPlayer.this.field_179434_b, (EntityLivingBase)p_179880_1_, false, true);
                }
            }
            @Override
