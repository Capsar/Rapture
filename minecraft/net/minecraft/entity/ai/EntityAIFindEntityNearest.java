    ...
    public EntityAIFindEntityNearest(EntityLiving p_i45884_1_, Class p_i45884_2_)
    {
        ...
        this.field_179443_c = new Predicate()
        {
            ...
            public boolean func_179876_a(EntityLivingBase p_179876_1_)
            {
                ...
                return p_179876_1_.isInvisible() ? false : ((double)p_179876_1_.getDistanceToEntity(EntityAIFindEntityNearest.this.field_179442_b) > var2 ? false : EntityAITarget.isSuitableTarget(EntityAIFindEntityNearest.this.field_179442_b, p_179876_1_, false, true));
            }
