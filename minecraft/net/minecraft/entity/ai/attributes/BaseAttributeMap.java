...
public abstract class BaseAttributeMap
{
    ...
    public IAttributeInstance registerAttribute(IAttribute attribute)
    {
        ...
        {
            IAttributeInstance var2 = this.func_180376_c(attribute);
            this.attributesByName.put(attribute.getAttributeUnlocalizedName(), var2);
            this.attributes.put(attribute, var2);

            for (IAttribute var3 = attribute.func_180372_d(); var3 != null; var3 = var3.func_180372_d())
            {
                this.field_180377_c.put(var3, attribute);
            }
