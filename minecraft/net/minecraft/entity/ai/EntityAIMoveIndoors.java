...
public class EntityAIMoveIndoors extends EntityAIBase
{
	...
	public void startExecuting()
    {
        ...
        {
            Vec3 var5 = RandomPositionGenerator.findRandomTargetBlockTowards(this.entityObj, 14, 3, new Vec3(var2 + 0.5D, var3, var4 + 0.5D));
        ...
        {
            this.entityObj.getNavigator().tryMoveToXYZ(var2 + 0.5D, var3, var4 + 0.5D, 1.0D);
        }
    }
