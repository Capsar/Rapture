...
public class ScoreboardSaveData extends WorldSavedData
{
    ...
    protected void readTeams(NBTTagList p_96498_1_)
    {
        for (int var2 = 0; var2 < p_96498_1_.tagCount(); ++var2)
        {
            ...
            if (var3.hasKey("NameTagVisibility", 8))
            {
                ...
                if (var5 != null)
                {
                    var4.settNameTagVisibility(var5);
                }
            }
    ...
    protected NBTTagList func_96496_a()
    {
        ...
        while (var3.hasNext())
        {
            ...
            var5.setString("NameTagVisibility", var4.getNameTagVisibility().field_178830_e);
            var5.setString("DeathMessageVisibility", var4.getDeathMessageVisibility().field_178830_e);
