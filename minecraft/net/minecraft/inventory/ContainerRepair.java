    ...
    public ContainerRepair(InventoryPlayer playerInventory, final World worldIn, final BlockPos blockPosIn, EntityPlayer player)
    {
        ...
        this.addSlotToContainer(new Slot(this.outputSlot, 2, 134, 47)
        {
			...
			public void onPickupFromSlot(EntityPlayer playerIn, ItemStack stack)
            {
                ...
                IBlockState var5 = worldIn.getBlockState(blockPosIn);
                ...
                if (!playerIn.capabilities.isCreativeMode && !worldIn.isRemote && var5.getBlock() == Blocks.anvil && playerIn.getRNG().nextFloat() < 0.12F)
                {
                    ...
                    {
                        worldIn.setBlockState(blockPosIn, var5.withProperty(BlockAnvil.DAMAGE, Integer.valueOf(var4)), 2);
        ...
        for (var5 = 0; var5 < 3; ++var5)
        {
            ...
            {
                this.addSlotToContainer(new Slot(playerInventory, var6 + var5 * 9 + 9, 8 + var6 * 18, 84 + var5 * 18));
            }
        }
            ...
            if (var13 != null)
            {
                ...
                else
                {
                    ...
                    while (var27.hasNext())
                    {
                        ...
                        Enchantment var28 = Enchantment.getEnchantmentById(var18);
                        ...
                        if (var28 != null)
                        {
                            ...
                            while (var23.hasNext())
                            {
                                ...
                                if (var24 != var18 && !var28.canApplyTogether(Enchantment.getEnchantmentById(var24)))
                                {
                                    var22 = false;
                                    ++var9;
                                }
