package pq.rapture.module.objects.moreinventory;
...
public abstract class CustomGuiContainer extends GuiScreen {
	...
	public CustomGuiContainer(Container inventorySlotsIn) {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if (this.returningStack != null) {
			float var18 = (Minecraft.getSystemTime() - this.returningStackTime) / 100.0F;
			...
			int var13 = this.touchUpX + (int) (var11 * var18);
			int var14 = this.touchUpY + (int) (var20 * var18);
	...
	private void drawSlot(Slot slotIn) {
		...
		if (slotIn == this.clickedSlot && this.draggedStack != null && this.isRightMouseClick && var4 != null) {
			...
			if (Container.canAddItemToSlot(slotIn, var7, true) && this.inventorySlots.canDragIntoSlot(slotIn)) {
				...
				if (var4.stackSize > slotIn.getItemStackLimit(var4)) {
					var8 = EnumChatFormatting.YELLOW + "" + slotIn.getItemStackLimit(var4);
					var4.stackSize = slotIn.getItemStackLimit(var4);
				}
			} else {
		...
		if (var4 == null) {
			String var9 = slotIn.getSlotTexture();
	...
	private Slot getSlotAtPosition(int x, int y) {
		for (int var3 = 0; var3 < this.inventorySlots.inventorySlots.size(); ++var3) {
			...
			if (this.isMouseOverSlot(var4, x, y)) { return var4; }
		}
	...
	protected void mouseReleased(int mouseX, int mouseY, int state) {
		...
		if (this.doubleClick && var4 != null && state == 0 && this.inventorySlots.canMergeSlot((ItemStack) null, var4)) {
			if (isShiftKeyDown()) {
